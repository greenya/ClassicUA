...
-- Barrage
[19461] = { "Загороджувальний вогонь", "Збільшує пошкодження ваших здібностей \"Мультипостріл\" та \"Град\" на {1}%.#by {1}" }, -- Barrage (Rank 1)
...
-- Beast Training
[5149] = { "Дресирування звіра", "Дозволяє мисливцю дресирувати свого вихованцю різноманітним здібностям, які він вивчив." }, -- Beast Training
...
-- Feign Death
[5384] = { "Удавання мертвого", "Прикинутися мертвими, що може ввести в оману ворогів та змусити їх вас ігнорувати. Триває {1} хв.#Lasts up to {1} min", "Удає мертвого." }, -- Feign Death
...
-- Multi-Shot
[2643] = { "Мультипостріл", "Вистрілює декілька набоїв, вражаючи {1} цілі.#{1} targets" }, -- Multi-Shot (Rank 1)
[14288] = { "Мультипостріл", "Вистрілює декілька набоїв, вражаючи {1} цілі та завдаючи додатково {2} пошкодження.#{1} targets#{2} damage" }, -- Multi-Shot (Rank 2)
...
-- Volley
[1510] = { "Град", "Безперервно вкриває градом набоїв вибране місце, завдає {1} пошкодження арканою ворожим цілям в межах {2} м щосекунди протягом {3} с.#causing {1}#within {2} y#for {3} sec" }, -- Volley (Rank 1)
