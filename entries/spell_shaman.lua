...
-- Elemental Focus
[16164] = { "Стихійна зосередженість", "Надає вам {1}% імовірності набути ефекту \"Ясномови\" після застосування будь-якого закляття вогню, криги чи природи, що завдає шкоди. \"Ясномова\" зменшує витрати мани вашого наступного закляття пошкодження на {2}%.#{1}% chance#spell by {2}" }, -- Elemental Focus
