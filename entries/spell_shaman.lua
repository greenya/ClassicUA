...
[16177] = { "Стійкість пращурів", nil, "Збільшує броню від ваших предметів на {1}%.#by {1}" }, -- Ancestral Healing (aura)
[16236] = { ref=16177 }, -- Ancestral Healing (aura)
[16237] = { ref=16177 }, -- Ancestral Healing (aura)
...
-- Ancestral Spirit
[2008] = { "Дух пращурів", "Поновлює душу в тілі, повертаючи мертву ціль до життя з {1} здоров'я та {2} мани. Не може бути накладене в бою.#{1} health and {2} mana" }, -- Ancestral Spirit (Rank 1)
...
-- Astral Recall
[556] = { "Астральне повернення", "Повертає заклинача крізь Крутоверть Порожнечі додому. Поговоріть з корчмарем в іншому місці, щоб змінити домівку." }, -- Astral Recall

-- Call of Flame
[16038] = { "Поклик полум'я", "Збільшує пошкодження від ваших тотемів вогню на {1}%.#by {1}" }, -- Call of Flame (Rank 1)
[16160] = { ref=16038 }, -- Call of Flame (Rank 2)
[16161] = { ref=16038 }, -- Call of Flame (Rank 3)

-- Call of Thunder
[16041] = { "Поклик грому", "Підвищує ймовірність критичного удару ваших заклять \"Блискавка\" та \"Ланцюгова блискавка\" додатково на {1}%.#additional {1}" },
...
-- Chain Lightning
[421] = { "Ланцюгова блискавка", "Кидає в ціль блискавку, що завдає від {1} до {2} пошкодження природою та перестрибує на інших ворогів поруч. Кожен стрибок завдає на {3}% менше пошкодження. Вражає до {4} цілей.#dealing {1} to {2}#damage by {3}#{4} total targets." }, -- Chain Lightning (Rank 1)
[930] = { ref=421 }, -- Chain Lightning (Rank 2)
[2860] = { ref=421 }, -- Chain Lightning (Rank 3)
[10605] = { ref=421 }, -- Chain Lightning (Rank 4)

-- Concussion
[16035] = { "Струс", "Збільшує пошкодження від заклять \"Блискавка\", \"Ланцюгова блискавка\" та шокових заклять на {1}%.#by {1}" }, -- Concussion (Rank 1)
...
-- Convection
[16039] = { "Конвекція", "Зменшує витрати мани на ваші закляття \"Блискавка\", \"Ланцюгова блискавка\" та шокові закляття на {1}%.#by {1}" }, -- Convection (Rank 1)
...
[8170] = { "Тотем очищення хвороб", "Прикликає тотем очищення хвороб із {1} здоров'я біля заклинача. Тотем буде намагатися зняти {2} ефект хвороби з членів групи в радіусі {3} м кожні {4} с. Триває {5} хв.#with {1} health#remove {2}#within {3} yards every {4} sec#Lasts {5} min" }, -- Disease Cleansing Totem

-- Earth Shock
[8042] = { "Земний шок", "Миттєво шокує ціль ударною хвилею, завдає від {1} до {2} пошкодження природою. Також перериває вимову закляття та внеможливлює вимову будь-яких інших заклять з тієї ж школи магії на {3} с. Спричиняє високий рівень загрози.#causing {1} to {2}#for {3} sec" }, -- Earth Shock (Rank 1)
...
[3600] = { "Земне зв'язування", nil, "Рух сповільнено на {1}%.#by {1}" }, -- Earthbind (aura)
...
[30165] = { "Стихійне спустошення", nil, "Збільшує вашу ймовірність завдати критичного удару атакою ближнього бою на {1}%.#by {1}" }, -- Elemental Devastation (aura)
[29177] = { ref=30165 }, -- Elemental Devastation (aura)
[29178] = { ref=30165 }, -- Elemental Devastation (aura)

-- Elemental Focus
[16164] = { "Стихійна зосередженість", "Надає вам {1}% імовірності набути ефекту \"Ясномови\" після застосування будь-якого закляття вогню, криги чи природи, що завдає шкоди. \"Ясномова\" зменшує витрати мани на ваше наступне закляття пошкодження на {2}%.#{1}% chance#spell by {2}" }, -- Elemental Focus
[16246] = { "Ясномова", nil, "Ваше наступне стихійне закляття пошкодження має зменшені витрати мани на {1}%.#by {1}" }, -- Clearcasting (aura)

-- Elemental Fury
[16089] = { "Стихійна лють", "Збільшує силу критичного удару ваших тотемів обпалення, магми та вогненного спалаху, а також заклять вогню, криги та природи на {1}%.#by {1}" }, -- Elemental Fury

-- Elemental Mastery
[16166] = { "Опанування стихій", "При активації, підвищує ймовірність критичного ефекту наступного закляття пошкодження вогнем, кригою чи природою на {1}% і зменшує витрати мани на нього на {2}%.#{1}% critical#by {2}", "Ваше наступне закляття пошкодження вогнем, кригою чи природою витратить на {1}% менше мани й воно гарантовано матиме критичний ефект.#by {1}" }, -- Elemental Mastery

-- Elemental Warding
[28996] = { "Охорона від стихій", "Зменшує пошкодження від ефектів вогню, криги та природи на {1}%.#by {1}" }, -- Elemental Warding (Rank 1)
[28997] = { ref=28996 }, -- Elemental Warding (Rank 2)
[28998] = { ref=28996 }, -- Elemental Warding (Rank 3)

-- Elemental Weapons
[16266] = { "Зброя стихій", "Збільшує бонус сили атаки ближнього бою вашого закляття \"Зброя каменолома\" на {1}%, ефект вашого закляття \"Зброя буревію\" на {2}% та пошкодження вашими закляттями \"Зброя язика полум'я\" та \"Зброя крижаного тавра\" на {3}%.#Rockbiter Weapon by {1}#effect by {2}#Frostbrand Weapon by {3}" }, -- Elemental Weapons (Rank 1)
...
-- Eye of the Storm
[29062] = { "Око бурі", "Надає вам 33% імовірності набути ефекту \"Зосередженої вимови\" на 6 с після того, як ви постраждали від критичного удару ближнього або дальнього бою. \"Зосереджена вимова\" оберігає вас від втрат часу на вимову закляття при отриманні пошкодження." }, -- Eye of the Storm (Rank 1)
[29064] = { ref=29062 }, -- Eye of the Storm (Rank 2)
[29065] = { ref=29062 }, -- Eye of the Storm (Rank 3)
[29063] = { "Зосереджена вимова", nil, "Не втрачаєте час на вимову закляття при отриманні пошкодження." }, -- Focused Casting (aura)
...
-- Fire Nova Totem
[1535] = { "Тотем вогненного спалаху", "Викликає тотем вогненного спалаху з {1} здоров'я та часом існування {2} с. Якщо тотем не знищити протягом {3} с, він завдасть від {4} до {5} пошкодження вогнем усім ворогам в радіусі {6} м.#has {1} health and lasts {2} sec#within {3} sec#inflicts {4} to {5}#within {6} y" }, -- Fire Nova Totem (Rank 1)
...
-- Flame Shock
[8050] = { "Вогняний шок", "Миттєво обпалює ціль вогнем, завдає {1} пошкодження вогнем відразу та ще {2} протягом {3} с.#causing {1}#{2} Fire damage over {3} sec", "{1} пошкодження вогнем кожні {2} с.#{1} Fire damage every {2} sec" }, -- Flame Shock (Rank 1)
...
-- Flametongue Totem
[8227] = { "Тотем язика полум'я", "Викликає тотем язика полум'я з {1} здоров'я біля заклинача. Тотем підсилює вогнем зброю в основній руці всіх учасників групи в радіусі {2} м. Кожен удар завдає від {3} до {4} додаткового пошкодження вогнем залежно від швидкості зброї. Повільна зброя завдає більшого пошкодження за удар. Триває {5} хв.#with {1} health#within {2} y#causes {3} to {4}#Lasts {5} min" }, -- Flametongue Totem (Rank 1)
[8249] = { ref=8227 }, -- Flametongue Totem (Rank 2)
[10526] = { ref=8227 }, -- Flametongue Totem (Rank 3)
[16387] = { ref=8227 }, -- Flametongue Totem (Rank 4)

-- Flametongue Weapon
[8024] = { "Зброя язика полум'я", "Підсилює зброю шамана вогнем. Кожен удар завдає цілі від {1} до {2} додаткового пошкодження вогнем залежно від швидкості зброї. Повільна зброя завдає більшого пошкодження за удар. Триває {3} хв.#causes {1} to {2}#Lasts for {3} min" }, -- Flametongue Weapon (Rank 1)
...
-- Flurry
[16256] = { "Шквал", "Підвищує вашу швидкість атаки на {1}% для наступних {2} ударів після того як ви завдали критичний удар.#speed by {1}#next {2} swings" }, -- Flurry (Rank 1)
[16281] = { ref=16256 }, -- Flurry (Rank 2)
[16282] = { ref=16256 }, -- Flurry (Rank 3)
[16283] = { ref=16256 }, -- Flurry (Rank 4)
[16284] = { ref=16256 }, -- Flurry (Rank 5)
[16257] = { "Шквал", nil, "Швидкість атаки підвищено на {1}%.#by {1}" }, -- Flurry (aura)
[16277] = { ref=16257 }, -- Flurry (aura)
[16278] = { ref=16257 }, -- Flurry (aura)
[16279] = { ref=16257 }, -- Flurry (aura)
[16280] = { ref=16257 }, -- Flurry (aura)
...
-- Frost Shock
[8056] = { "Крижаний шок", "Миттєво шокує ціль кригою, завдає від {1} до {2} пошкодження кригою та сповільнює рух на {3}%. Триває {4} с.#causing {1} to {2}#speed by {3}#Lasts {4} sec", "Рух сповільнено на {1}%.#by {1}" }, -- Frost Shock (Rank 1)
[8058] = { ref=8056 }, -- Frost Shock (Rank 2)
[10472] = { ref=8056 }, -- Frost Shock (Rank 3)
[10473] = { ref=8056 }, -- Frost Shock (Rank 4)

-- Frostbrand Weapon
[8033] = { "Зброя крижаного тавра", "Підсилює зброю шамана кригою. Кожен удар може завдати цілі додатково {1} пошкодження кригою та сповільнити її рух на {2}% на {3} с. Триває {4} хв.#causing {1}#by {2}% for {3} sec#Lasts for {4} min" }, -- Frostbrand Weapon (Rank 1)
...
-- Ghost Wolf
[2645] = { "Вовк-привид", "Перетворює шамана на вовка-привида, збільшує швидкість руху на {1}%. Можна використовувати лише просто неба.#by {1}", "Збільшує швидкість руху на {1}%.#by {1}" }, -- Ghost Wolf
...
[8836] = { "Поваба вітру", nil, "Збільшує спритність на {1}.#by {1}" }, -- Grace of Air (aura)
[10626] = { ref=8836 }, -- Grace of Air (aura)
[25360] = { ref=8836 }, -- Grace of Air (aura)
...
[8178] = { "Ефект тотему заземлення", nil, "Перенаправить одне зловмисне закляття на тотем заземлення." }, -- Grounding Totem Effect (aura)

-- Guardian Totems
[16258] = { "Вартові тотеми", "Підсилює ефект зменшення пошкодження від ваших тотемів кам'яної шкіри та стіни вітру на {1}%, також зменшує час відновлення вашого тотема заземлення на {2} с.#Windwall Totem by {1}#Grounding Totem by {2}" }, -- Guardian Totems (Rank 1)
[16293] = { ref=16258 }, -- Guardian Totems (Rank 2)

-- Healing Focus
[16181] = { "Цілюща зосередженість", "Надає вам {1}% імовірності уникнути переривання вимови будь-якого цілющого закляття при отриманні пошкодження.#{1}% chance" }, -- Healing Focus (Rank 1)
...
-- Improved Ghost Wolf
[16262] = { "Покращений вовк-привид", "Зменшує час вимови закляття \"Вовк-привид\" на {1} с.#by {1}" }, -- Improved Ghost Wolf (Rank 1)
...
[16261] = { "Покращений щит блискавки", "Збільшує пошкодження від кульових блискавок вашого закляття \"Щит блискавки\" на {1}%.#by {1}" }, -- Improved Lightning Shield (Rank 1)
...
[29192] = { "Покращені тотеми зброї", "Збільшує бонус до сили атаки ближнього бою вашого тотему буревію на {1}% та пошкодження вашого тотему язика полум'я на {2}%.#Windfury Totem by {1}#Flametongue Totem by {2}" }, -- Improved Weapon Totems (Rank 1)
...
-- Lightning Bolt
[403] = { "Блискавка", "Кидає в ціль блискавку, завдаючи від {1} до {2} пошкодження природою.#for {1} to {2}" }, -- Lightning Bolt (Rank 1)
...
-- Lightning Shield
[324] = { "Щит блискавки", "Оточує заклинача {1} кульовими блискавками. Коли будь-яке закляття, атака ближнього чи дальнього бою влучає у заклинача, нападнику завдається {2} пошкодження природою. При цьому витрачається одна кульова блискавка. Лише одна кульова блискавка може активуватися кожні кілька секунд. Триває {3} хв.#by {1} balls#struck for {2}#Lasts {3} min", "Завдає {1} пошкодження природою нападникові при ударі.#Causes {1}" }, -- Lightning Shield (Rank 1)
...
-- Magma Totem
[8190] = { "Тотем магми", "Викликає тотем магми з {1} здоров'я біля заклинача на {2} с, який завдає {3} пошкодження вогнем усім істотам у радіусі {4} м кожні {5} с.#with {1} health#for {2} sec#causes {3}#within {4} yards every {5} sec" }, -- Magma Totem (Rank 1)
...
[8166] = { "Тотем очищення отрут", "Прикликає тотем очищення отрут із {1} здоров'я біля заклинача. Тотем буде намагатися зняти {2} ефект отрути з членів групи в радіусі {3} м кожні {4} с. Триває {5} хв.#with {1} health#remove {2}#within {3} yards every {4} sec#Lasts {5} min" }, -- Poison Cleansing Totem

-- Purge
[370] = { "Розвіювання", "Очищує ворожу ціль, знімаючи з неї {1} магічний ефект.#removing {1}" }, -- Purge (Rank 1)
[8012] = { "Розвіювання", "Очищує ворожу ціль, знімаючи з неї {1} сприятливі магічні ефекти.#removing {1}" }, -- Purge (Rank 2)
...
-- Reincarnation
[20608] = { "Реінкарнація", "Дозволяє вам після смерті повернути себе до життя з {1}% здоров'я та мани.#with {1}" }, -- Reincarnation
...
-- Reverberation
[16040] = { "Рокотання", "Зменшує час поновлення ваших шокових заклять на {1} с.#by {1}" }, -- Reverberation (Rank 1)
...
-- Searing Totem
[3599] = { "Тотем обпалення", "Викликає тотем обпалення з {1} здоров'я біля вас на {2} с, який періодично атакує ворога у радіусі до {3} м, завдаючи від {4} до {5} пошкодження вогнем.#with {1} health#for {2} sec#within {3} yards for {4} to {5}" }, -- Searing Totem (Rank 1)
...
[16253] = { "Спеціалізація на щитах", "Підвищує ймовірність блокувати атаки щитом на {1}% та збільшує об'єм заблокованого пошкодження на {2}%.#shield by {1}#blocked by {2}" }, -- Shield Specialization (Rank 1)
...
-- Stoneskin Totem
[8071] = { "Тотем кам'яної шкіри", "Викликає тотем кам'яної шкіри з {1} здоров'я біля заклинача. Тотем захищає учасників групи в радіусі {2} м, знижуючи отримуване пошкодження в ближньому бою на {3}. Триває {4} хв.#with {1} health#within {2} y#taken by {3}#Lasts {4} min" }, -- Stoneskin Totem (Rank 1)
...
[10404] = { ref=8072 }, -- Stoneskin (aura)
[10405] = { ref=8072 }, -- Stoneskin (aura)
...
-- Stormstrike
[17364] = { "Штормовий удар", "Дає вам додаткову атаку. Окрім цього, наступні два джерела пошкодження природою по цілі посилені на {1}%. Триває {2} с.#increased by {1}#Lasts {2} sec", "Отримане пошкодження природою збільшене на {1}%.#by {1}" }, -- Stormstrike
...
-- Totemic Focus
[16173] = { "Тотемна зосередженість", "Зменшує витрати мани на ваші тотеми на {1}%.#by {1}" }, -- Totemic Focus (Rank 1)
...
-- Tremor Totem
[8143] = { "Тотем тремтіння", "Викликає тотем тремтіння з {1} здоров'я біля заклинача, який змушує землю стрясатися навколо, знімаючи ефекти страху, причарування та сну з учасників групи в радіусі {2} м. Триває {3} хв.#with {1} health#within {2} y#Lasts {3} min" }, -- Tremor Totem
...
-- Water Walking
[546] = { "Ходіння по воді", "Дозволяє вибраному союзнику ходити по воді протягом {1} хв. Будь-яке пошкодження скасує ефект.#for {1} min", "Дозволяє ходити по воді." }, -- Water Walking

-- Weapon Mastery
[29082] = { "Опанування зброї", "Збільшує ваше пошкодження зброєю на {1}%.#by {1}" }, -- Weapon Mastery (Rank 1)
...
-- Windwall Totem
[15107] = { "Тотем стіни вітру", "Викликає тотем стіни вітру з {1} здоров'я біля заклинача. Тотем захищає учасників групи в радіусі {2} м, знижуючи отримуване пошкодження в дальньому бою на {3}. Триває {4} хв.#with {1} health#within {2} y#taken by {3}#Lasts {4} min" }, -- Windwall Totem (Rank 1)
