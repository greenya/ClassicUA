...
-- Focused Mind
[30864] = { "Зосереджений розум", "Зменшує тривалість ефектів знемовлення та переривання, що діють на вас. на {1}%. Цей ефект не складається з іншими подібними ефектами.#by {1}%" }, -- Focused Mind (Rank 1)
