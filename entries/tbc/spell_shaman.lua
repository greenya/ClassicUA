...
-- Heroism
[32182] = { "Героїзм", "Збільшує швидкість ближнього бою, дальнього бою та заклять на {1}% для всіх учасників групи та рейду. Триває {2} секунд.\n\nПісля завершення ефекту цілі не зможуть отримати ефект \"Героїзму\" повторно протягом {3} хвилин.#haste by {1}% for all#Lasts {2} sec#again for {3} min", "Швидкість ближнього бою, дальнього бою та вимови заклять збільшено на {1}%.#by {1}%", en="Heroism" },
-- Improved Chain Heal
...
[37762] = { "Зменшена вартість Штормового удару", "Зменшує витрати мани на \"Штормовий удар\" на {1}.#cost of Stormstrike by {1}", en="Reduced Stormstrike Cost" },
