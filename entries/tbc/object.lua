...
["Ancient Skull Pile"] = "купа древніх черепів",
...
["Arcane Container"] = "арканічна скринька",
["Arcano Control Unit"] = "арканічний пульт керування",
...
["Baa'ri Tablet Fragment"] = "скрижаль Баа'рі",
...
["Charred Bone Fragment"] = "уламок обвугленої кістки",
["Clopper's Equipment"] = "обладнання Клоппера",
["Coilskar Chest"] = "скриня Кільчастих Шрамів",
...
["Crystal Prison"] = "кристалічна в'язниця",
...
["Ever-burning Ash"] = "незгасний попіл",
...
["Fel Reaver Armor Plating"] = "броньована пластина сквернобота",
["Fel Reaver Control Console"] = "панель керування скверноботом",
["Fel Reaver Part"] = "деталь сквернобота",
["Fel Reaver Power Core"] = "енергетичне ядро сквернобота",
...
["Hazzik's Package"] = "пакунок Хаззіка",
["Heavy Iron Portcullis"] = "масивні залізні грати",
...
["Legion Communication Device"] = "комунікаційний пристрій Легіону",
["Legion Communicator"] = "комунікатор Легіону",
["Lianthe's Strongbox"] = "скринька Ліанте",
...
["Monstrous Kaliri Egg"] = "яйце жахливого калірі",
...
["Nethercite Deposit"] = "поклади пустоциту",
["Netherdust Bush"] = "кущ пустоцвіту",
["Nethermine Cargo"] = "вантаж шахти Підсвітніх Крил",
["Nethervine Crystal"] = "кристал Підсвітньої лози",
["Netherwing Egg"] = "яйце Підсвітніх Крил",
...
["The Codex of Blood"] = "Кодекс Крові",
["The Doctor's Strongbox"] = "скринька доктора",
...
["Zuluhed's Chains"] = "ланцюги Зулугеда",
}
