...
-- Curse of Tongues
[1714] = { "Прокляття мови", "Примушує ціль говорити мовою демонів, сповільнюючи час вимови всіх заклять на {1}%. Одночасно лише одне прокляття кожного чорнокнижника може бути задіяне на цілі. Триває {2} с.#by {1}%#Lasts {2} sec", "Говорить мовою демонів, що збільшує час вимови на {1}%.#by {1}%" }, -- Curse of Tongues (Rank 1)
-- Demonic Knowledge
