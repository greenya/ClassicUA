...
-- Rend
[772] = { "Розрив", "Ранить ціль, спричиняючи {1} шкоди від кровотечі і додатково {2} (в залежності від шкоди зброї) протягом {3} с.#for {1} damage#additional {2}#over {3} sec", "Кровотеча завдає {1} шкоди та відсоток від шкоди зброї кожні {2} с.#for {1} plus#every {2} sec" }, -- Rend (Rank 1)
