...
[700] = { "Сон", "Змушує ворожу ціль спати протягом {1} с. Будь-яка шкода розбудить ціль. Одночасно можна змусити спати лише одну ціль. Може не подіяти на ціль вище {2} рівня.#up to {1} sec#above level {2}", "Сон." }, -- Sleep (Rank 1)
...
[17619] = { "Камінь алхіміка", "Збільшує ефективність зіллів лікування та мани на {1}%. Цей ефект не поєднується з аналогічними ефектами.#wearer by {1}%", "Збільшує ефективність зіллів лікування та мани на {1}%.#by {1}%" }, -- Alchemist's Stone
...
-- Racial
[28875] = { "Різьба по каменю", "Навичку ювелірної справи збільшено на {1}.#by {1}" }, -- Gemcutting (Racial Passive)
[28878] = { "Наснажлива присутність", "Збільшує ймовірність завдання удару закляттями на {1}% вам та всім учасникам групи в межах {2} м.#spells by {1}% for#within {2} y", "Ймовірність завдання удару закляттями збільшено на {1}%.#by {1}%" }, -- Inspiring Presence (Racial Passive)
[28880] = { "Дар Наару", "Зцілює {1} здоров'я цілі протягом {2} с.#of {1} damage over {2} sec", "Зцілює {1} здоров'я кожні {2} с.#{1} damage every {2} sec" }, -- Gift of the Naaru (Racial)
