...
-- Charge
[7371] = { "Штурм", "Штурмує ворога, знерухомлює його на {1} с і додає {2} сили атаки ближнього бою до наступної атаки кнура." }, -- Charge (Rank 1)
...
[25999] = { "Штурм кнура", nil, "Знерухомлений." }, -- Boar Charge (aura)

-- Claw
[16827] = { "Дряпання", "Дряпає ворога, завдає від {1} до {2} пошкодження.#causing {1} to {2}" }, -- Claw (Rank 1)
...
-- Cobra Reflexes
[25076] = { "Рефлекси кобри", "Швидкість атаки збільшено на {1}%, але зменшено пошкодженння.#by {1}" }, -- Cobra Reflexes (Rank 1)

-- Consume Shadows
[17767] = { "Поглинання тіней", "Пустотник поглинає тіні поблизу, щоб покращити свій стан, і відновлює {1} здоров'я протягом {2} с. Не можна використовувати в бою.#{1} health over {2} sec", "Зцілює {1} пошкодження кожні {2} с.#{1} damage every {2} sec" }, -- Consume Shadows (Rank 1)
...
-- Cower
[1742] = { "Зіщулювання", "Зіщулитися, не завдаючи пошкодження, але зменшуючи вашу загрозу та знижуючи вірогідність того, що ворог атакуватиме саме вас." }, -- Cower (Rank 1)
...
-- Devour Magic
[19505] = { "Пожирання магії", "Очищує дружню ціль від {1} шкідливого магічного ефекту або ворожу ціль від {2} сприятливого магічного ефекту. Пожирання ефекту зцілює скверногончу на {3}.#{1} harmful#{2} benefical#healed for {3}" }, -- Devour Magic (Rank 1)
...
-- Firebolt
[3110] = { "Вогняна стріла", "Завдає цілі від {1} до {2} пошкодження.#Deals {1} to {2}" }, -- Firebolt (Rank 1)
...
-- Flamethrower
[25027] = { "Вогнемет", "{1} мани щосекунди.\nЗавдає від {2} до {3} пошкодження щосекунди всім танкам перед вами в межах {4} м. Також уповільнює рух на {5}% і завдає {6} пошкодження щосекунди протягом {7} с.#{1} mana#Deals {2} to {3}#within {4} y#movement to {5}% and deals {6}#for {7} sec" }, -- Flamethrower
[25029] = { "Вогнемет", nil, "Завдає {1} пошкодження щосекунди. Рух сповільнено на {2}%.#Deals {1}#slowed by {2}" }, -- Flamethrower (aura)
...
-- Lesser Invisibility
[7870] = { "Мала невидимість", "Надає вашому прикликаному демонові малу невидимості на {1} хв. Закляття можна застосувати лише поза боєм.#for up to {1} min", "Невидимий." }, -- Lesser Invisibility

-- Lightning Breath
[24844] = { "Подих блискавки", "Дихає блискавкою, миттєво завдає від {1} до {2} пошкодження природою одній цілі.#dealing {1} to {2}" }, -- Lightning Breath (Rank 1)
...
-- Phase Shift
[4511] = { "Фазування", "Переносить бісеня в іншу фазу від світу, що унеможливлює атаки проти нього, доки він не почне атакувати сам." }, -- Phase Shift
[8611] = { "Фазування", nil, "Невидимий, але не може атакувати. Невразливий до всіх атак і заклять." }, -- Phase Shift (aura)

-- Prowl
[24450] = { "Зачаїтися", "Ваш вихованець стає непомітним, але його рух уповільнюється на {1}%. Перебуваючи непомітним, пошкодження першої атаки буде збільшене на {2}%. Триває до скасування.#speed by {1}#{2}% bonus", "Непомітний. Рух сповільнено на {1}%.#slowed by {1}" }, -- Prowl (Rank 1)
[24452] = { ref=24450 }, -- Prowl (Rank 2)
[24453] = { ref=24450 }, -- Prowl (Rank 3)

-- Sacrifice
[7812] = { "Жертва", "Приносить в жертву пустотника, при цьому його володар отримує щит, який поглинає {1} пошкодження протягом {2} с. Поки щит тримається, вимову заклять не буде перервано пошкодженням.#absorb {1} damage for {2} sec", "Поглинає все пошкодження." }, -- Sacrifice (Rank 1)
...
-- Scorpid Poison
[24640] = { "Отрута скорпіда", "Завдає {1} пошкодження природою протягом {2} с. Ефект накладається до {3} разів на одній цілі.#{1} Nature damage over {2} sec#{3} times", "{1} пошкодження природою кожні {2} с.#{1} Nature damage every {2} sec" }, -- Scorpid Poison (Rank 1)
[24583] = { ref=24640 }, -- Scorpid Poison (Rank 2)
[24586] = { ref=24640 }, -- Scorpid Poison (Rank 3)
[24587] = { ref=24640 }, -- Scorpid Poison (Rank 4)

-- Screech
[24423] = { "Вереск", "Нівечить одну ціль, завдає від {1} до {2} пошкодження та зменшує силу атаки ближнього бою всіх ворогів у межах ближнього бою на {3}. Ефект триває {4} с.#for {1} to {2}#range by {3}#lasts {4} sec", "Силу атаки ближнього бою зменшено на {1}.#by {1}" }, -- Screech (Rank 1)
[24577] = { ref=24423 }, -- Screech (Rank 2)
[24578] = { ref=24423 }, -- Screech (Rank 3)
[24579] = { ref=24423 }, -- Screech (Rank 4)

-- Seduction
[6358] = { "Зваблення", "Зваблює ціль, перешкоджаючи всім її діям протягом {1} с. Будь-яке пошкодження скасує ефект. Діє лише на гуманоїдів.#for up to {1} sec", "Причарований." }, -- Seduction
...
-- Shell Shield
[26064] = { "Панцирний щит", "Зменьшує пошкодження отримуване вашим вихованцем на {1}%, але збільшує час між його атаками на {2}%. Триває {3} с.#takes by {1}#attacks by {2}#Lasts {3} sec", "Пошкодження зменшено на {1}% та час між атаками збільшено на {2}%.#reduced by {1}#increased by {2}" }, -- Shell Shield
...
[24259] = { "Заборона чар", nil, "Знемовлений." }, -- Spell Lock (aura)

-- Suffering
[17735] = { "Страждання", "Підбурює всіх ворогів у радіусі {1} м, збільшуючи ймовірність, що вони атакуватимуть пустотника.#within {1} y" }, -- Suffering (Rank 1)
[17750] = { "Страждання", "Підбурює всіх ворогів у радіусі {1} м, збільшуючи ймовірність, що вони атакуватимуть пустотника. Дієвіше за \"Страждання\" (Ранг {2}).#within {1} y#(Rank {2})" }, -- Suffering (Rank 2)
...
[19479] = { "Ефект зараженої крові", nil, "Силу атаки ближнього бою зменшено на {1}.#by {1}" }, -- Tainted Blood Effect (aura)
[19652] = { ref=19479 }, -- Tainted Blood Effect (aura)
[19653] = { ref=19479 }, -- Tainted Blood Effect (aura)
[19654] = { ref=19479 }, -- Tainted Blood Effect (aura)

-- Thunderstomp
[26090] = { "Громовий тупіт", "Здригає землю громовою силою, завдає від {1} до {2} пошкодження природою всім ворогам у межах {3} м.#doing {1} to {2}#within {3} y" }, -- Thunderstomp (Rank 1)
[26187] = { ref=26090 }, -- Thunderstomp (Rank 2)
[26188] = { ref=26090 }, -- Thunderstomp (Rank 3)

-- Torment
[3716] = { "Мука", "Підбурює істоту, збільшуючи ймовірність того, що вона зосередить свої атаки на пустотнику." }, -- Torment (Rank 1)
[7809] = { "Мука", "Підбурює істоту, збільшуючи ймовірність того, що вона зосередить свої атаки на пустотнику. Дієвіше за \"Муку\" (Ранг {1}).#(Rank {1})" }, -- Torment (Rank 2)
