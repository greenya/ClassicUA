...
[11213] = { "Арканічна сконцентрованість", "Надає вам {1}% ймовірності набути стану \"Ясномови\". Такий стан зменшує витрати мани на ваше наступне закляття пошкодження на {2}%.#you a {1}% chance#spell by {2}%" }, -- Arcane Concentration (Rank 1)
...
-- Combustion
[11129] = { "Палання", "При використанні підвищує ймовірність критичного удару ваших заклять вогню на {1}% за кожне влучання закляттями вогню. Цей ефект триває, доки ви тричі не завдасте критичного удару закляттями вогню.#spells by {1}" }, -- Combustion
...
-- Mage Armor
[6117] = { "Магівський обладунок", "Збільшує ваш супротив усій магії на {1} і дозволяє {2}% вашого відновлення мани продовжуватися під час вимови заклять. Одночасно лише один тип закляття \"обладунок\" може бути активним на магу. Триває {3} хв.#magic by {1} and allows {2}%#Lasts {3} min", "Супротив усім школам магії збільшено на {1} і дозволяє {2}% вашого відновлення мани продовжуватися під час вимови заклять.#magic by {1} and allows {2}%" }, -- Mage Armor (Rank 1)
[22782] = { ref=6117 }, -- Mage Armor (Rank 2)
[22783] = { ref=6117 }, -- Mage Armor (Rank 3)

-- Magic Absorption
[29441] = { "Магічне поглинання", "Збільшує всі ваші супротиви на {1} та спричиняє всі закляття, яким ви повністю протистояли, відновлювати {2}% від усієї вашої мани.#resistances by {1}#restore {2}" }, -- Magic Absorption (Rank 1)
