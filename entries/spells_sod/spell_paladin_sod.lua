...
-- Aegis
[425589] = { "Егіда", "Збільшує ваш показник блокування на 30%, а атаки ближнього і дальнього бою, що завдають вам шкоди, мають 10% шанс збільшити ваш шанс блокування на 30%. Триває 10 сек або до 5 блоків. Не сумується з ефектом \"Твердині\".", nil }, -- Aegis
[425615] = { "Егіда", "Отримати здібність \"Егіда\":", nil, rune=425589 }, -- Aegis

-- Avenger's Shield
[407669] = { "Щит месника", "Кидає у ворога священний щит, який завдає від {1} до {2} шкоди священністю, викликає запаморочення, а потім летить в інших ворогів, що стоять поруч. Вражає до 3 цілей. Триває 10 сек.", "Запаморочення." }, -- Avenger's Shield
...
[415069] = { "Екзорцизм", "Завдає від {1} до {2] шкоди священністю ворожій цілі і має 100% шанс критичного удару проти демонів і невмерлих.#Causes {1} to {2} Holy", nil }, -- Exorcism
[415070] = { "Екзорцизм", "Завдає від {1} до {2] шкоди священністю ворожій цілі і має 100% шанс критичного удару проти демонів і невмерлих.#Causes {1} to {2} Holy", nil }, -- Exorcism
[415071] = { "Екзорцизм", "Завдає від {1} до {2] шкоди священністю ворожій цілі і має 100% шанс критичного удару проти демонів і невмерлих.#Causes {1} to {2} Holy", nil }, -- Exorcism
[415072] = { "Екзорцизм", "Завдає від {1} до {2] шкоди священністю ворожій цілі і має 100% шанс критичного удару проти демонів і невмерлих.#Causes {1} to {2} Holy", nil }, -- Exorcism
[415073] = { "Екзорцизм", "Завдає від {1} до {2] шкоди священністю ворожій цілі і має 100% шанс критичного удару проти демонів і невмерлих.#Causes {1} to {2} Holy", nil }, -- Exorcism
...
-- Flash of Light
[412020] = { "Спалах Світла", "Зцілення з часом.", "Зцілення протягом 12 сек." }, -- Flash of Light

-- Hand of Reckoning
[407631] = { "Десниця відплати", "Підбурює ціль атакувати вас, але не діє, якщо ціль вже атакує вас.Поки ви володієте цією здібністю, бонус загрози від \"Праведної люті\" збільшується на 80%, крім того \"Праведна лють\" відновлюватиме вам ману, коли вас зцілюють, в обсязі 25% від ефекту зцілення. Крім того, поки \"Праведна лють\" активна, шкода, яка знижує ваш рівень здоров'я нижче 35%, зменшується на 20%. \"Праведна лють\" залишатиметься активною, доки її не буде скасовано.", "Підбурено." }, -- Hand of Reckoning
...
-- Seal of Martyrdom
[407798] = { "Печатка мучеництва", "Наповнює вас священним духом на 30 секунд, в результаті чого кожна ваша атака в ближньому бою завдає 30% шкоди від зброї по цілі, але ви втрачаєте здоров'я в об'ємі 10% від нанесеної шкоди. Поки ця печатка активна, члени вашої групи в радіусі 40 м відновлюють ману в об'ємі 10% від шкоди, нанесеної цією печаткою.Вивільнення енергії цієї печатки засудить ворога, миттєво завдаючи йому 70% шкоди від зброї ціною здоров'я в об'ємі 10% від завданої шкоди.", "Атаки ближнього бою завдають додаткової шкоди вашій цілі, а також завдають шкоди вам і відновлюють ману членам вашої групи." }, -- Seal of Martyrdom
[407799] = { "Печатка мучеництва", nil, nil }, -- Seal of Martyrdom
[407800] = { "Печатка мучеництва", "Печатка мучеництва також завдає шкоди паладину.", nil }, -- Seal of Martyrdom
