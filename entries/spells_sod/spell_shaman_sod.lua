...
-- Ancestral Guidance
[409324] = { "Настанови пращурів", "Протягом наступних {1} сек {2}% вашої шкоди перетворюється на зцілення {3} найближчих членів групи, а {4}% вашого зцілення перетворюється на шкоду останньої цілі вашого \"Вогняного шоку\".#next {1} sec, {2}% of#up to {3} nearby#and {4}% of", "Шкода перетворюється на зцілення найближчих членів групи, а зцілення - на шкоду останньої цілі \"Вогняного шоку\"." }, -- Ancestral Guidance
...
[408496] = { "Спеціалізація на бою з двох рук", "Коли ви тримаєте зброю в кожній руці ваша ймовірність влучити заклинаннями і атаками ближнього бою збільшується на 5%, а ваша здібність \"Штормовий удар\" тепер завдає шкоди з обох рук .", nil }, -- Dual Wield Specialization
...
-- Earthliving
[415292] = { "Земне живоття", "Зцілює {1} здоров'я протягом {2} сек.#{1} over {2} sec", "Зцілює {1} здоров'я кожні {2} сек.#{1} every {2} sec" }, -- Earthliving

-- Ghost Wolf
[415233] = { "Вовк-привид", "Перетворює шамана на вовка-привида, збільшує швидкість руху на {1}% та зменшує отриману шкоду на {2}%.#speed by {1}%#taken by {2}%", "Збільшує швидкість руху на {1}%.#by {1}" }, -- Ghost Wolf
...
[415242] = { "Цілющий дощ", "Зцілює 5 членам групи чи рейду в радіусі {1} м навколо цілі {2} здоров'я.#area {1} yards#target for {2}", nil }, -- Healing Rain
...
-- Molten Blast
[425339] = { "Вибух лави", "Завдати {1} ворогам перед собою від {2} до {3} шкоди від вогню. Ця здібність спричиняє велику кількість загрози. Періодична шкода від \"Вогняного шоку\" має 10% шанс скинути час відновлення \"Вибуху лави\".", nil }, -- Molten Blast
...
-- Water Shield
[408510] = { "Щит води", "Заклинача оточують 3 кулі води, які відновлюють 1% від максимального запасу мани кожні 5 сек. Коли заклинання, атака ближнього або дальнього бою потрапляє в заклинача, одна куля води знищується відновлює 4% від максимального запасу мани. Куля води може бути знищена лише раз на кілька секунд. Триває 10 хв. Одночасно на шамані може бути активний лише один щит стихій.", "Відновлює 1% від максимального запасу мани кожні 5 сек. Атаки та заклинання, використані проти вас, відновлюють 4% вашого максимального запасу мани. Зарядів: {1}.#{1} charge" }, -- Water Shield
