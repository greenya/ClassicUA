...
-- Between the Eyes
[400009] = { "Поміж очей", "Дистанційний завершальний рух, що завдає шкоди в залежності від довжини комбінації та сили атаки, а також приголомшує ціль:\n  1 прийом:   {1}-{2} шкоди, 1 сек приголомшення\n  2 прийоми: {3}-{4} шкоди, 2 сек приголомшення\n  3 прийоми: {5}-{6} шкоди, 3 сек приголомшення\n  4 прийоми: {7}-{8} шкоди, 4 сек приголомшення\n  5 прийомів: {9}-{10} шкоди, 5 сек приголомшення\nМає спільний час відновлення з \"Ударом по нирках\".#1 point:   {1} to {2} damage#2 points: {3} to {4} damage#3 points: {5} to {6} damage#4 points: {7} to {8} damage#5 points: {9} to {10} damage", "Приголомшено." }, -- Between the Eyes
[400033] = { "Поміж очей", "Отримати здібність \"Поміж очей\":", nil, rune=400009 }, -- Between the Eyes

-- Blade Dance
[400012] = { "Танок клинків", "Завершальний рух, що збільшує ймовірність парирування. Тривалість та сила ефекту залежить від довжини комбінації:\n  1 прийом:   {1} сек, {2}% парирування\n  2 прийоми: {3} сек, {4}% парирування\n  3 прийоми: {5} сек, {6}% парирування\n  4 прийоми: {7} сек, {8}% парирування\n  5 прийомів: {9} сек, {10}% парирування#1 point  : {1} seconds, {2}% Parry#2 points: {3} seconds, {4}% Parry#3 points: {5} seconds, {6}% Parry#4 points: {7} seconds, {8}% Parry#5 points: {9} seconds, {10}% Parry", "Ймовірність парирування збільшено на {1}%.#by {1}%" }, -- Blade Dance
...
-- Deadly Brew
[399965] = { "Смертельне вариво", "Коли ви отруюєте ціль будь-якою іншою отрутою, ви також отруюєте її смертельною отрутою.", nil }, -- Deadly Brew
...
-- Envenom
[399963] = { "Отруєння", "Завершальний рух, що завдає шкоди від отрути в залежності від кількості ефектів смертельної отрути на цілі. Після використання \"Отруєння\" ви маєте на 75% збільшений шанс спрацювання миттєвої отрути протягом 1 сек і додатково ще протягом 1 сек за кожен прийом в комбінації. Кожен прийом комбінації дорівнює одній дозі отрути:\n  1 доза:  {1} шкоди\n  2 дози: {2} шкоди\n  3 дози: {3} шкоди\n  4 дози: {4} шкоди\n  5 доз: {5} шкоди#1 dose:  {1} damage#2 doses: {2} damage#3 doses: {3} damage#4 doses: {4} damage#5 doses: {5} damage", "Ймовірність спрацювання миттєвої отрути збільшено на 75%." }, -- Envenom
...
-- Main Gauche
[424919] = { "Удар лівицею", "Миттєвий удар зброєю в лівій руці, що завдає шкоди від зброї і збільшує ймовірність парирування на 10% протягом 10 сек.  Збільшує довжину комбінації на 1 прийом.\n\"Удар лівицею\" взаємодіє з усіма талантами та ефектами, що й \"Зловісний удар\".", "Ймовірність парирування атак збільшено на {1}%.#by {1}%" }, -- Main Gauche
...
-- Quick Draw
[398196] = { "Швидкий постріл", "Витягти зброю дальнього бою та зробити швидкий постріл у ворога, завдаючи йому шкоди від зброї і зменшуючи швидкість руху цілі на 50% протягом 6 секунд. Збільшує довжину комбінації на 1 прийом.\n\"Швидкий постріл\" взаємодіє з усіма талантами та ефектами, що й \"Зловісний удар\".", "Швидкість руху зменшено на 50%." }, -- Quick Draw
[398197] = { "Швидкий постріл", "Отримати здібність \"Швидкий постріл\":", nil, rune=398196 }, -- Quick Draw

-- Saber Slash
[424785] = { "Удар шаблею", "Ви жорстоко рубаєте ворога, завдаючи 130% шкоди від зброї, і викликаєте в нього кровотечу, що завдає {1} шкоди кожні 2 секунди протягом 12 секунд, і ефект якої накопичується до 3 разів. Збільшує довжину комбінації на 1 прийом.\n\"Удар шаблею\" взаємодіє з усіма талантами та ефектами, що й \"Зловісний удар\".#bleed for {1} damage", "Кровотеча завдає {1} шкоди кожні 2 сек,#for {1} damage" }, -- Saber Slash
...
[424799] = { "Укол", "Миттєва атака зброєю в лівій руці, що завдає шкоди від зброї та гарантовано отруює ціль нанесеною на зброю отрутою. Повільна зброя вимагає більше витрат енергії. Ані \"Укол\", ані отрута, якою він отруює ціль, не можуть нанести критичний удар. Збільшує довжину комбінації на 1 прийом.\n\"Укол\" взаємодіє з усіма талантами та ефектами, що й \"Зловісний удар\".", nil }, -- Shiv
...
-- Storm of Swords
[398198] = { "Буря мечів", "Завершальний рух, що збільшує ймовірність парирування. Тривалість та сила ефекту залежить від довжини комбінації:\n  1 прийом:   {1} сек, {2}% парирування\n  2 прийоми: {3} сек, {4}% парирування\n  3 прийоми: {5} сек, {6}% парирування\n  4 прийоми: {7} сек, {8}% парирування\n  5 прийомів: {9} сек, {10}% парирування#1 point  : {1} seconds, {2}% Parry#2 points: {3} seconds, {4}% Parry#3 points: {5} seconds, {6}% Parry#4 points: {7} seconds, {8}% Parry#5 points: {9} seconds, {10}% Parry", "Швидкість атаки збільшено на 10%." }, -- Storm of Swords
...
[401488] = { "Гравіювання штанів - Руна Різзака", "Вигравіювати на штанях руну \"Тіньовий удар\":", nil, rune=399985 }, -- Engrave Pants - Cutty's Rune
