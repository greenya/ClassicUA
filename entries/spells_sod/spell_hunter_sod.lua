...
-- Chimera Shot
[409433] = { "Постріл химери", "Ви завдаєте 125% шкоди від зброї, оновлюючи поточне Жало на вашій цілі та викликаючи спрацювання ефекту:Жало змії - миттєво завдає 40% від шкоди, завданої вашим \"Жалом змії\".Жало гадюки - миттєво відновлює вам 60% мани від кількості, висмоктаної вашим \"Жалом гадюки\".Жало скорпіда - Спроба роззброїти ціль на 10 сек. Цей ефект не може спрацьовувати частіше, ніж раз на хвилину.", nil }, -- Chimera Shot
[409976] = { "Постріл химери", "Отримати здібність \"Постріл химери\":", nil, rune=409433 }, -- Chimera Shot

-- Chimera Shot - Scorpid
[409495] = { "Постріл химери - скорпід", ref=409433 }, -- Chimera Shot - Scorpid
...
-- Explosive Shot
[409552] = { "Вибуховий постріл", "Ви стріляєте вибуховим зарядом у ворожу ціль, завдаючи {1}-{2} шкоди від вогню. Заряд буде підривати ціль щосекунди протягом додаткових 2 сек. Має спільний час відновлення з \"Арканічним пострілом\".#dealing {1}-{2} Fire", "Щосекунди отримує від {1} до {2} шкоди від вогню." }, -- Explosive Shot
[409554] = { "Вибуховий постріл", "Ви стріляєте вибуховим зарядом у ворожу ціль, завдаючи {1}-{2} шкоди від вогню. Заряд буде підривати ціль щосекунди протягом додаткових 2 сек. Має спільний час відновлення з \"Арканічним пострілом\".#dealing {1}-{2} Fire", "Щосекунди отримує шкоду від вогню." }, -- Explosive Shot
...
-- Flanking Strike
[415320] = { "Фланговий удар", "Ви і ваш вихованець одночасно наносите {1}% шкоди в ближньому бою. Після цього ваші здібності \"Укус мангусти\" та \"Удар раптора\" завдають на {2}% більше шкоди протягом {3} секунд, ефект накопичується до {4} разів. \"Удар раптора\" має {5}% шанс скинути відновлення \"Флангового удару\".#instant {1}% damage#deal {2}% increased damage for {3} sec#up to {4} times#a {5]% chance", "Шкода від \"Укусу мангусти\" та \"Удару раптора\" збільшена на {1}%.#by {1}%" }, -- Flanking Strike
[415326] = { "Фланговий удар", "Ви і ваш вихованець одночасно наносите {1}% шкоди в ближньому бою. Після цього ваші здібності \"Укус мангусти\" та \"Удар раптора\" завдають на {2}% більше шкоди, ефект накопичується до {3} разів. \"Удар раптора\" має {4}% шанс скинути відновлення \"Флангового удару\".#instant {1}% damage#deal {2}% increased damage#up to {3} times#a {4]% chance", nil }, -- Flanking Strike
...
-- Kill Command
[409379] = { "Команда \"Вбити\"", "Віддати вихованцю команду \"вбити\", що збільшить шкоду від його особливих атак на {1}% протягом {2} сек.  Кожна особлива атака вихованця зменшує бонус до шкоди на {3}%.#attacks by {1}% for {2} sec#damage bonus by {3}%", nil }, -- Kill Command
[409396] = { "Команда \"Вбити\"", "Віддати вихованцю команду \"вбити\", що збільшить шкоду від його особливих атак на {1}% протягом {2} сек.  Кожна особлива атака вихованця зменшує бонус до шкоди на {3}%.#attacks by {1}% for {2} sec#damage bonus by {3}%", "Шкода від особливих здібностей вихованця збільшена на {1}%#increased by {1}%" }, -- Kill Command
...
-- Serpent Spread
[425738] = { "Зміїний розмах", "Цілі, уражені вашим \"Багатозарядним пострілом\", також отримують ефект вашого \"Жала змії\" на 6 сек.#for {1} sec", nil }, -- Serpent Spread
[425756] = { "Зміїний розмах", "Отримати здібність \"Зміїний розмах\":", nil, rune=425738 }, -- Serpent Spread

-- Serpent Sting
[425728] = { "Жало змії", "Жалить ціль, завдаючи їй {1} шкоди від природи протягом {2} сек. Лише один ефект жала від кожного мисливця може бути активним на одній цілі.#causing {1} Nature damage over {2} sec", "Завдає {1} шкоди кожні {2} сек.#Causes {1} Nature damage every {2} sec" }, -- Serpent Sting
