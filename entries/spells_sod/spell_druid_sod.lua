...
-- Skull Bash
[410176] = { "Лобова атака", "Кинутись на ціль в радіусі {1} м і вдарити по черепу, перериваючи вимову заклинань і унеможливлюючи вимову заклять тієї ж школи протягом 2 сек. Має спільне перезаряджання з \"Диким ривком\".", nil }, -- Skull Bash
