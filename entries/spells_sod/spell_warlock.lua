...
-- Curse of Tongues
[402794] = { "Прокляття мов", "Примушує ціль говорити мовою демонів, сповільнюючи час вимови всіх заклять на {1}%. Одночасно лише одне прокляття кожного чорнокнижника може бути задіяне на цілі. Триває {2} хв.#by {1}#Lasts {2} min", "Говорить мовою демонів, що збільшує час вимови на {1}%.#by {1}" }, -- Curse of Tongues
...
-- Demonic Pact
[425464] = { "Угода з демоном", "Критичні удари вашого прислужника накладають ефект \"Угода з демоном\" на членів вашої групи на 45 с. \"Угода з демоном\" збільшує шкоду і зцілення від заклинань на 10% від вашої шкоди від заклинань або {2}, залежно від того, яке значення більше. Не діє на поневолених демонів.", nil }, -- Demonic Pact
...
-- Disrupt
[412787] = { "Придушення", "Придушити ворога сплеском тіньової енергії, який завдає {1} шкоди, перериває вимову закляття та унеможливлює вимову заклять тієї ж школи протягом 5 секунд.", nil }, -- Disrupt
...
-- Incinerate
[412758] = { "Спалення", "Підпалити ворога, завдавши від {1} до {2} шкоди і збільшити всю вашу шкоду від вогню по цілі на {3}% протягом наступних {4} с.#for {1} to {2}#by {3}% for the next {4} sec", "Завдану вами шкоду від вогню збільшено на {1}%.#by {1}%." }, -- Incinerate
...
[403666] = { "Вогняне озеро", "Вогняний дощ також залишає на землі вогняне озеро, яке збільшує всю шкоду від вогню, яку завдаєте ви та ваш прислужник-демон ураженим ворогам, на {1}% протягом {2} с.#by {1}% for {2} sec", nil }, -- Lake of Fire
