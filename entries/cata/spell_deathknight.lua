...
-- Butchery
[48979] = { "М'ясар", "Після вбивства цілі, що приносить досвід або честь, ви отримуєте {1} сили рун. Окрім того, ви отримуєте {2} сили рун кожні {3} с, поки перебуваєте в бою.#up to {1} Runic#generate {2} Runic Power per {3} sec" }, -- Butchery (Rank 1)
[49483] = { ref=48979 }, -- Butchery (Rank 2)
-- Chains of Ice
[45524] = { "Льодяні окови", "Заковує ворога крижаними оковами,[ завдаючи {1} шкоди від криги та#dealing {1} Frost damage] зменшуючи швидкість руху на {1}% протягом {2} с. Також вражає ворога \"Морозною лихоманкою\".#by {1}% for {2} sec", "Сповільнено крижаними оковами." }, -- Chains of Ice
-- Chilblains
...
-- Chill of the Grave
[49149] = { "Могильний холод", "Здібності \"Льодяні окови\", \"Виючий вітер\", \"Льодяний дотик\" та \"Знищення\" додають ще {1} сили рун.#generate {1} additional" }, -- Chill of the Grave (Rank 1)
...
-- Death Coil
[47541] = { "Спіраль смерті", "Заряд нечестивої енергії, що завдає {1} шкоди від тіні ворожій цілі або відновлює {2} здоров'я дружній невмерлій цілі.[ Повертає {1} сили рун при зціленні.#Refunds {1} Runic Power]#causing {1} Shadow#healing {2} damage" }, -- Death Coil
-- Death Strike
...
-- Empower Rune Weapon
[47568] = { "Підсилення рунічної зброї", "Підсилює вашу рунічну зброю, миттєво завершуючи відновлення всіх рун та додаючи {1} сили рун .#generating {1} Runic" }, -- Empower Rune Weapon
-- Endless Winter
[49137] = { "Нескінченна зима", "\"Замороження мозку\" витрачає {1} сили рун.#to {1} Runic" }, -- Endless Winter (Rank 1)
...
-- Horn of Winter
[57330] = { "Горн зими", "Лицар cмерті дме в горн зими, що додає {1} сили рун і збільшує силу та спритність всіх учасників групи чи рейду в межах {2} м на {3}. Триває {4} хв.#generates {1} Runic#within {2} yards by {3}#Lasts {4} min", "Силу та спритність збільшено на {1}.#by {1}" }, -- Horn of Winter
-- Howling Blast
[49184] = { "Виючий вітер", "Вражає ціль крижаним вітром, завдаючи {1} шкоди від криги їй та {2} шкоди від криги всім ворогам в межах {3} м від цілі[ та вражаючи всі цілі \"Морозною лихоманкою\"#infecting all targets with Frost Fever].#dealing {1} Frost#and {2} Frost#within {3} y" }, -- Howling Blast
-- Hungering Cold
...
-- Magic Suppression
[49224] = { "Придушення магії", "Збільшує обсяг поглинання магічної шкоди \"Антимагічним панцирем\" додатково на {1}%, а шкода, поглинена \"Антимагічним панцирем\", відновлює силу рун.#additional {1}%" }, -- Magic Suppression (Rank 1)
[49610] = { nil, "Збільшує обсяг поглинання магічної шкоди \"Антимагічним панцирем\" додатково на {1}% та збільшує відновлення сили рун від шкоди, поглиненої \"Антимагічним панцирем\".#additional {1}%", ref=49224 }, -- Magic Suppression (Rank 2)
[49611] = { ref=49610 }, -- Magic Suppression (Rank 3)
-- Might of the Frozen Wastes
[81330] = { "Міць крижаної пустки", "Коли ви тримаєте дворучну зброю, ваші атаки ближнього бою завдають додатково {1}% шкоди, а ваші автоатаки з ймовірністю {2}% додають {3} сили рун.#additional {1}%#a {2}% chance#generate {3} Runic" }, -- Might of the Frozen Wastes
...
-- Runic Corruption
[51459] = { "Рунічна пошесть", "Зменшує витрати сили рун \"Спіраллю смерті\" на {1}, а \"Рунічне підсилення\"  більше не відновлює витрачену руну, а натомість прискорює відновлення рун на {2}% протягом {3} с.#Coil by {1}#by {2}% for {3} sec" }, -- Runic Corruption (Rank 1)
...
-- Scent of Blood
[49004] = { "Запах крові", "З ймовірністю {1}% після ухилення, парирування чи отримання прямої шкоди ви отримуєте ефект \"Запах крові\" і відновлюєте {2} сили рун при завданні удару в ближньому бою.#a {1}% chance#generate {2} Runic" }, -- Scent of Blood (Rank 1)
[49508] = { nil, "З ймовірністю {1}% після ухилення, парирування чи отримання прямої шкоди ви отримуєте ефект \"Запах крові\" і відновлюєте {2} сили рун при завданні {3} наступних ударів у ближньому бою.#a {1}% chance#generate {2} Runic#next {3} melee", ref=49004 }, -- Scent of Blood (Rank 2)
