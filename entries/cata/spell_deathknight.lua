...
-- Death Coil
[47541] = { "Спіраль смерті", "Заряд нечестивої енергії, що завдає {1} шкоди від тіні ворожій цілі та відновлює {2} здоров'я дружній невмерлій цілі.#causing {1} Shadow#healing {2} damage" }, -- Death Coil
-- Death Strike
...
[49529] = { nil, "Ваші атаки ближнього бою мають шанс (більший за ранг {1}) дозволити вам застосувати наступну \"Спіраль смерті\" без витрат сили рун.#rank {1}", ref=49018 }, -- Sudden Doom (Rank 2)
