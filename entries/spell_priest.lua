...
-- Blackout
[15268] = { "Затьмарення", "Надає вашим закляттям з пошкодженням тінню {1}% ймовірності приголомшити ціль на {2} с.#{1}% chance#for {2} sec" }, -- Blackout (Rank 1)
...
-- Darkness
[15259] = { "Пітьма", "Збільшує пошкодження вашими закляттями тіні на {1}%.#by {1}" }, -- Darkness (Rank 1)
...
-- Devouring Plague
[2944] = { "Пожираюча чума", "Вражає ціль хворобою, завдає {1} пошкодження тінню протягом {2} с. Пошкодження від \"Пожираючої чуми\" зцілює заклинача.#causes {1}#over {2} sec", "Завдає {1} пошкодження кожні {2} с та лікує заклинача.#{1} damage every {2} sec" }, -- Devouring Plague (Rank 1)
...
-- Dispel Magic
[527] = { "Розсіювання магії", "Розсіює магію на цілі, знімаючи 1 шкідливий чарівний ефект з союзника або 1 сприятливий чарівний ефект з противника." }, -- Dispel Magic (Rank 1)
[988] = { "Розсіювання магії", "Розсіює магію на цілі, знімаючи 2 шкідливі чарівні ефекти з союзника або 2 сприятливі чарівні ефекти з противника." }, -- Dispel Magic (Rank 2)
...
[16875] = { ref=14752 }, -- Divine Spirit (Rank 3), yes "rank 3"; needs checking if this spell in game

-- Elune's Grace
[2651] = { "Милість Елуни", "Зменшує отримуване пошкодження від атак дального бою на {1} і збільшує ймовірність ухилитися на {2}% на {3} с.#taken by {1}#dodge by {2}% for {3} sec", "Отримуване пошкодження від атак дального бою зменшено на {1} і ймовірність ухилитися збільшено на {2}%.#reduced by {1}#increased by {2}" }, -- Elune's Grace (Rank 1)
...
-- Fade
[586] = { "Розтанення", "Розтаньте у повітрі, знеохочуючи ворогів атакувати вас на {1} с.#for {1} sec", "Рівень загрози знижено." }, -- Fade (Rank 1)
[9578] = { "Розтанення", "Розтаньте у повітрі, знеохочуючи ворогів атакувати вас на {1} с. Дієвіше за \"Розтанення\" (Ранг {2}).#for {1} sec#rank {2}", "Рівень загрози знижено." }, -- Fade (Rank 2)
...
-- Fear Ward
[6346] = { "Охоронець від страху", "Охороняє дружню ціль від страху. Наступний ефект страху проти цілі буде нейтралізований, витративши охоронця. Триває {1} хв.#Lasts {1} min", "Під охороною від страху." }, -- Fear Ward

-- Feedback
[13896] = { "Відгомін", "Жерця оточує антимагічна енергія. Будь-яке успішне закляття проти нього спалить {1} мани нападника та завдасть {2} пошкодження тінню за кожну знищену одиницю мани. Триває {3} с.#burn {1}#causing {2}#Lasts {3} sec", "Антимагічна енергія спалить {1} мани нападника та завдасть {2} пошкодження тінню за кожну одиницю спаленої мани.#burn {1}#causing {2}" }, -- Feedback (Rank 1)
...
-- Flash Heal
[2061] = { "Блискавичне зцілення", "Лікує дружню ціль на значення від {1} до {2} здоров'я.#for {1} to {2}" }, -- Flash Heal (Rank 1)
...
-- Greater Heal
[2060] = { "Велике зцілення", "Закляття повільної вимови, що лікує одну ціль на значення від {1} до {2} здоров'я.#for {1} to {2}" }, -- Greater Heal (Rank 1)
...
-- Healing Focus
[14913] = { "Цілюща зосередженість", "Надає вам {1}% імовірності уникнути переривання, спричиненого пошкодженням, під час вимови будь-якого цілющого закляття.#{1}% chance" }, -- Healing Focus (Rank 1)
[15012] = { ref=14913 }, -- Healing Focus (Rank 2)

-- Hex of Weakness
[9035] = { "Пристріт слабкості", "Послаблює вибраного ворога, зменшуючи його пошкодження на {1} та знижуючи дію будь-якого лікування на {2}%. Триває {3} хв.#caused by {1}#healing by {2}#Lasts {3} min", "Фізичне пошкодження зменшене на {1} й ефективність лікування знижена на {2}%.#damage done reduced by {1} and healing effectiveness reduced by {2}" }, -- Hex of Weakness (Rank 1)
...
-- Holy Fire
[14914] = { "Священний вогонь", "Поглинає ворога священним полум'ям, завдає від {1} до {2} пошкодження священністю та додаткові {3} пошкодження священністю протягом {4} с.#cause {1} to {2}#additional {3}#over {4} sec", "{1} пошкодження священністю кожні {2} с.#{1} Holy damage every {2} sec" }, -- Holy Fire (Rank 1)
...
-- Holy Nova
[15237] = { "Священний спалах", "Створює вибух священного світла навколо заклинача, завдає від {1} до {2} пошкодження священністю всім ворожим цілям і лікує всіх членів групи на значення від {3} до {4} здоров'я у радіусі {5} м. Ці ефекти не спричиняють загрози.#causing {1} to {2}#for {3} to {4}#within {5} y" }, -- Holy Nova (Rank 1)
...
-- Holy Reach
[27789] = { "Досяжність священності", "Збільшує дальність дії ваших заклять \"Кара\" та \"Священний вогонь\", також радіус дії ваших заклять \"Молитва зцілення\" та \"Священний спалах\" на {1}%.#by {1}" }, -- Holy Reach (Rank 1)
[27790] = { ref=27789 }, -- Holy Reach (Rank 2)

-- Holy Specialization
[14889] = { "Спеціалізація на священності", "Збільшує ймовірність критичного ефекту ваших заклять священності на {1}%.#by {1}" }, -- Holy Specialization (Rank 1)
...
-- Improved Mind Blast
[15273] = { "Покращений вибух розуму", "Зменшує час поновлення вашого закляття \"Вибух розуму\" на {1} с.#by {1} sec" }, -- Improved Mind Blast (Rank 1)
...
[15392] = { "Покращений психічний крик", "Зменшує час поновлення вашого закляття \"Психічний крик\" на {1} с.#by {1}" }, -- Improved Psychic Scream (Rank 1)
[15448] = { ref=15392 }, -- Improved Psychic Scream (Rank 2)

-- Improved Renew
[14908] = { "Покращене відновлення", "Збільшує обсяг зцілення вашим закляттям \"Відновлення\" на {1}%.#by {1}" }, -- Improved Renew (Rank 1)
...
-- Inner Focus
[14751] = { "Внутрішня зосередженість", "При використанні зменшує витрати мани на ваше наступне закляття на {1}% та збільшує його ймовірність критичного ефекту на {2}%, якщо такий можливий.#spell by {1}#chance by {2}", "Витрати мани на ваше наступне закляття зменшено на {1}%.#reduced by {1}" }, -- Inner Focus

-- Inspiration
[14892] = { "Натхнення", "Збільшує броню вашої цілі на {1}% на {2} с після критичного ефекту ваших заклять \"Миттєве зцілення\", \"Зцілення\", \"Велике зцілення\" або \"Молитва зцілення\".#armor by {1}% for {2} sec" }, -- Inspiration (Rank 1)
[15362] = { ref=14892 }, -- Inspiration (Rank 2)
[15363] = { ref=14892 }, -- Inspiration (Rank 3)
[14893] = { "Натхнення", nil, "Збільшує броню на {1}%.#by {1}" }, -- Inspiration (aura)
[15357] = { ref=14893 }, -- Inspiration (aura)
[15359] = { ref=14893 }, -- Inspiration (aura)
...
-- Levitate
[1706] = { "Левітація", "Дозволяє заклиначу левітувати, плинучи невисоко над землею. Під час левітації ви падатимете зі зниженою швидкістю та подорожуватимете поверх рідких поверхонь. Будь-яке пошкодження скасує цей ефект. Триває {1} хв.#Lasts {1} min", "Левітує." }, -- Levitate

-- Lightwell
[724] = { "Колодязь світла", "Створює священний колодязь світла біля жерця. Члени вашого рейду або групи можуть випити з нього для відновлення {1} здоров'я протягом {2} с. Будь-яке отримане пошкодження знімає цей ефект. Колодязь існує {3} хв або {4} застосувань.#restore {1} health over {2} sec#lasts for {3} min or {4} charges" }, -- Lightwell (Rank 1)
[27870] = { ref=724 }, -- Lightwell (Rank 2)
[27871] = { ref=724 }, -- Lightwell (Rank 3)
[7001] = { "Відновлення колодязя світла", nil, "Відновлює {1} здоров'я кожні {2} с.#{1} health every {2} sec" }, -- Lightwell Renew (aura)
[27873] = { ref=7001 }, -- Lightwell Renew (aura)
[27874] = { ref=7001 }, -- Lightwell Renew (aura)

-- Mana Burn
[8129] = { "Спалювання мани", "Висмоктує з цілі від {1} до {2} мани. Кожна одиниця висмоктаної таким чином мани завдає цілі {3} пошкодження тінню.#{1} to {2} mana#takes {3}" }, -- Mana Burn (Rank 1)
...
-- Martyrdom
[14531] = { "Мучеництво", "Надає вам {1}% імовірності набути ефекту \"Зосередженої вимови\" на {2} с після того, як ви постраждали від критичного удару ближнього або дальнього бою. \"Зосереджена вимова\" оберігає вас від втрат часу вимови заклять, коли вам завдають пошкодження, та збільшує супротив ефектам переривання на {3}%.#{1}% chance#for {2} sec#by {3}%" }, -- Martyrdom (Rank 1)
[14774] = { ref=14531 }, -- Martyrdom (Rank 2)
[14743] = { "Зосереджена вимова", nil, "Не може втратити час на вимову заклять від отримання пошкодження та має збільшену ймовірність протистояти ефектам переривання на {1}%.#by {1}" }, -- Focused Casting (aura)
[27828] = { ref=14743 }, -- Focused Casting (aura)
...
-- Mind Blast
[8092] = { "Вибух розуму", "Підриває ціль, завдає від {1} до {2} пошкодження тінню та спричиняє високий рівень загрози.#for {1} to {2}" }, -- Mind Blast (Rank 1)
...
-- Mind Control
[605] = { "Контроль розуму", "Контролює та керує гуманоїдом до рівня {1}, але збільшує час між його атаками на {2}%. Триває до {3} хв.#up to level {1}#attacks by {2}%#Lasts up to {3} min", "Причарований. Час між атаками збільшено на {1}%.#by {1}" }, -- Mind Control (Rank 1)
[10911] = { ref=605 }, -- Mind Control (Rank 2)
[10912] = { ref=605 }, -- Mind Control (Rank 3)

-- Mind Flay
[15407] = { "Бичування розуму", "Вражає розум цілі енергією тіні, завдає {1} пошкодження тінню протягом {2} с та сповільнює її рух на {3}%.#causing {1}#over {2} sec#speed by {3}", "Швидкість руху зменшена на {1}%.#by {1}" }, -- Mind Flay (Rank 1)
...
-- Mind Vision
[2096] = { "Зір розуму", "Дозволяє заклиначу бачити очима цілі протягом {1} хв.#for {1} min", "Здатність бачити очима цілі." }, -- Mind Vision (Rank 1)
[10909] = { "Зір розуму", "Дозволяє заклиначу бачити очима цілі протягом {1} хв. Не працює, якщо ціль перебуває в іншому ігровимірі або на іншому континенті.#for {1} min", "Здатність бачити очима цілі." }, -- Mind Vision (Rank 2)

-- Power Infusion
[10060] = { "Приплив сил", "Наповнює ціль силою, збільшує її пошкодження чарами та лікування на {1}%. Триває {2} с.#by {1}#Lasts {2} sec", "Пошкодження чарами та лікування збільшено на {1}%.#by {1}" }, -- Power Infusion

-- Power Word: Fortitude
[1243] = { "Слово сили: Стійкість", "Сила наповнює ціль, збільшує витривалість на {1} на {2} хв.#by {1} for {2} min", "Збільшує витривалість на {1}.#by {1}" }, -- Power Word: Fortitude (Rank 1)
...
-- Prayer of Healing
[596] = { "Молитва зцілення", "Потужна молитва зцілює всіх членів групи в межах {1} м на значення від {2} до {3} здоров'я.#within {1}#for {2} to {3}" }, -- Prayer of Healing (Rank 1)
...
[27683] = { "Молитва захисту від тіні", "Сила наповнює членів групи цілі, збільшуючи їхній супротив тіні на {1} на {2} хв.#by {1} for {2} min", "Збільшує супротив тіні на {1}.#by {1}" }, -- Prayer of Shadow Protection

-- Prayer of Spirit
[27681] = { "Молитва духу", "Сила наповнює членів групи цілі, збільшуючи їхній дух на {1} на {2} год.#by {1} for {2} h", "Збільшує дух на {1}.#by {1}" }, -- Prayer of Spirit

-- Psychic Scream
[8122] = { "Психічний крик", "Заклинач вивільнює психічний крик, що змушує {1} ворогів у межах {2} м тікати геть протягом {3} с. Пошкодження може перервати цей ефект.#{1} enemies within {2} y#for {3} sec", "Тікає зі страху." }, -- Psychic Scream (Rank 1)
[8124] = { ref=8122 }, -- Psychic Scream (Rank 2)
[10888] = { ref=8122 }, -- Psychic Scream (Rank 3)
[10890] = { ref=8122 }, -- Psychic Scream (Rank 4)

-- Renew
[139] = { "Відновлення", "Лікує {1} пошкодження цілі протягом {2} с.#{1} damage over {2} sec", "Лікує {1} пошкодження кожні {2} с.#{1} damage every {2} sec" }, -- Renew (Rank 1)
...
-- Searing Light
[14909] = { "Обпалююче світло", "Збільшує пошкодження від ваших заклять \"Кара\" та \"Священний вогонь\" на {1}%.#by {1}" }, -- Searing Light (Rank 1)
[15017] = { ref=14909 }, -- Searing Light (Rank 2)

-- Shackle Undead
[9484] = { "Сковування невмерлих", "Сковує обраного невмерлого противника на {1} с. Ціль стає нездатною пересуватися, атакувати та вимовляти закляття. Будь-яке пошкодження по цілі знімає цей ефект. Одночасно може бути скута тільки одна ціль.#for up to {1} sec", "Сковано." }, -- Shackle Undead (Rank 1)
...
-- Shadow Weaving
[15257] = { "Сплітання тіні", "Ваші закляття ураження тінню мають {1}% імовірності зробити вашу ціль вразливою до пошкодження тінню. Ця вразливість збільшує завдане по цілі пошкодження тінню на {2}% та триває {3} с. Накладається до {4} разів.#{1}% chance#by {2}% and lasts {3} sec#up to {4} times" }, -- Shadow Weaving (Rank 1)
...
-- Shadowform
[15473] = { "Тінеобраз", "Прийняти тінеобраз, збільшуючи ваше пошкодження тінню на {1}% і зменшуючи отримуване фізичне пошкодження на {2}%. Однак, у цьому образі ви не можете вимовляти закляття священності.#damage by {1}#done to you by {2}", "Ваше пошкодження тінню збільшене на {1}%. Отримуване фізичне пошкодження зменшене на {2}%. Ви не можете вимовляти закляття священності.#increased by {1}#reduced by {2}" }, -- Shadowform

-- Shadowguard
[18137] = { "Тінестраж", "Жерця оточують тіні. Коли закляття або атака ближнього чи дальнього бою влучає у заклинача, нападнику буде завдано {1} пошкодження тінню. Це пошкодження не спричиняє загрози та може бути завданим нападникам лише раз на кілька секунд. Ефект має {2} заряди та триває {3} хв.#struck for {1}#{2} charges#Lasts {3} min", "Завдає {1} пошкодження тінню нападникові при ударі та не спричиняє загрози. {2} заряди.#Causes {1}#{2} charges" }, -- Shadowguard (Rank 1)
...
-- Silence
[15487] = { "Мовчання", "Примушує противника замовкнути, що не дає йому вимовляти закляття протягом {1} с.#for {1} sec", "Безмовний." }, -- Silence
...
-- Smite
[585] = { "Кара", "Покарати ворога, завдавши йому від {1} до {2} пошкодження священністю.#for {1} to {2}" }, -- Smite (Rank 1)
...
[27827] = { "Дух спокути", nil, "Ви стали могутнішим, ніж будь-хто міг уявити." }, -- Spirit of Redemption (aura)
...
[15271] = { "Витік душі", nil, "Дух збільшено на {1}% та мана відновлюється з {2}% швидкості відновлення протягом вимови заклять.#{1}% and allows {2}%" }, -- Spirit Tap (aura)

-- Spiritual Guidance
[14901] = { "Духовне покровительство", "Збільшує пошкодження та зцілення чарами на {1}% від вашого духу.#by up to {1}" }, -- Spiritual Guidance (Rank 1)
...
-- Starshards
[10797] = { "Зорескалки", "Сипле зорескалками на голову вибраного ворога, завдаючи {1} пошкодження арканою протягом {2} с.#causing {1}#over {2} sec", "{1} пошкодження арканою протягом {2} с.#{1} Arcane damage over {2} sec" }, -- Starshards (Rank 1)
...
-- Touch of Weakness
[2652] = { "Дотик слабкості", "Наступна атака ближнього бою проти заклинача завдасть {1} пошкодження тінню та зменшить пошкодження нападника на {2} на {3} хв.#cause {1}#by {2} for {3} min", "Наступна ворожа атака ближнього бою завдасть цілі пошкодження та послабить її." }, -- Touch of Weakness (Rank 1)
...
[2943] = { "Дотик слабкості", nil, "Фізичне пошкодження зменшене на {1}.#by {1}" }, -- Touch of Weakness (aura)
[19249] = { ref=2943 }, -- Touch of Weakness (aura)
[19251] = { ref=2943 }, -- Touch of Weakness (aura)
[19252] = { ref=2943 }, -- Touch of Weakness (aura)
[19253] = { ref=2943 }, -- Touch of Weakness (aura)
[19254] = { ref=2943 }, -- Touch of Weakness (aura)
...
-- Vampiric Embrace
[15286] = { "Вампірські обійми", "Вражає вашу ціль енергією тіні, яка зцілює усіх членів групи на {1}% від заподіяного вами пошкодження закляттями тіні протягом {2} хв.#healed for {1}#deal for {2} min", "Зцілює групу жерця на {1}% від його пошкодження закляттями тіні.#{1}% of Shadow" }, -- Vampiric Embrace

-- Wand Specialization
[14524] = { "Спеціалізація на жезлах", "Збільшує ваше пошкодження за допомогою жезлів на {1}%.#by {1}" }, -- Wand Specialization (Rank 1)
