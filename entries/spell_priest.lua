...
-- Fear Ward
[6346] = { "Оберіг від страху", "Оберігає дружню ціль від страху. Наступний ефект страху проти цілі буде нейтралізований ціною оберегу. Триває {1} хв.#Lasts {1} min", "Захищений від страху." }, -- Fear Ward
