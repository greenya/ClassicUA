...
-- Anticipation
[12297] = { "Передчуття", "Збільшує вашу захисну здібність на {1}.#by {1}" }, -- Anticipation (Rank 1)
...
[14201] = { ref=12880 }, -- Enrage (aura)
[14202] = { ref=12880 }, -- Enrage (aura)
[14203] = { ref=12880 }, -- Enrage (aura)
[14204] = { ref=12880 }, -- Enrage (aura)
...
-- Mace Specialization
[12284] = { "Спеціалізація на булавах", "Надає вам {1}% імовірністі приголомшити ціль на {2} с при використанні булави.#{1}% chance#for {2} sec" }, -- Mace Specialization (Rank 1)
...
[16538] = { "Спеціалізація на одноручній зброї", "Збільшує пошкодження, заподіяне одноручною зброєю ближнього бою, на {1}%.#weapons by {1}" }, -- One-Handed Weapon Specialization (Rank 1)
...
-- Recklessness
[1719] = { "Навіженість", "Воїн буде завдавати критичних ударів більшістю своїх атак та буде невразливим до ефектів страху наступні {1} с, але отримуване ним пошкодження збільшиться на {2}%.#next {1} sec#increased by {2}", "Невразливий до ефектів Страху, більшість атак завдають критичних ударів, але отримуване пошкодження збільшене на {1}%.#increased by {1}" }, -- Recklessness

-- Rend
[772] = { "Розрив", "Ранить ціль, змушуючи її стікати кров'ю на {1} пошкодження протягом {2} с.#for {1} damage over {2} sec", "Стікає кров'ю на {1} пошкодження кожні {2} с.#for {1} damage every {2} seconds" }, -- Rend (Rank 1)
...
-- Shield Slam
[23922] = { "Трощення щитом", "Трощить ціль щитом, завдає від {1} до {2} пошкодження залежно від показника вашого блоку щитом, та має 50% імовірності розсіяти 1 магічний ефект на цілі. Також спричиняє великий рівень загрози.#causing {1} to {2} damage" }, -- Shield Slam (Rank 1)
...
[12281] = { "Спеціалізація на мечах", "Надає {1}% імовірності провести додаткову атаку по тій самій цілі після нанесення пошкодження мечем.#{1}% chance" }, -- Sword Specialization (Rank 1)
...
-- Unbridled Wrath
[12322] = { "Нестримний гнів", "Надає {1}% імовірності отримати додаткову одиницю люті, завдаючи пошкодження зброєю ближнього бою.#{1}% chance" }, -- Unbridled Wrath (Rank 1)
