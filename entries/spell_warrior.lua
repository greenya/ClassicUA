...
-- Intercept
[20252] = { "Перехоплення", "Штурмує ворога, завдаючи {1} пошкодження та приголомшуючи його на {2} с.#causing {1} damage#for {2} sec" }, -- Intercept (Rank 1)
...
-- Last Stand
[12975] = { "Останній бій", "При активації ця здібність тимчасово надає вам {1}% вашого максимального здоров'я на {2} с. Після закінчення ефекту додане здоров'я втрачається.#grants you {1}#for {2} sec" }, -- Last Stand
