...
-- Berserker Rage
[18499] = { "Лють берсерка", "Лютуючи, воїн стає невразливим до ефектів страху та приголомшення і набуває додаткової люті при отриманні пошкодження. Триває {1} с.#Lasts {1} sec", "Невразливість до страху та приголомшення. Набуває додаткової люті при отриманні пошкодження." }, -- Berserker Rage
...
[16488] = { "Манія крові", nil, "Відновлює {1}% загального здоров'я протягом {2} с.#Regenerates {1}#over {2} sec" }, -- Blood Craze (aura)
...
-- Death Wish
[12328] = { "Бажання смерті", "При активації збільшує фізичне пошкождення на {1}% і робить вас невразливим до ефектів страху, але знижує броню та всі види супротиву на {2}%. Триває {3} с.#damage by {1}#resistances by {2}#Lasts {3} sec", "Збільшує фізичне пошкодження на {1}%. Знижує броню та всі види супротиву на {2}%. Невразливий до ефектів страху.#damage by {1}#resistances by {2}" }, -- Death Wish
...
-- Impale
[16493] = { "Пронизування", "Збільшує додаткове пошкодження критичними ударами ваших здібностей на {1}% у бойовій, оборонній та стійці берсерка.#stance by {1}" }, -- Impale (Rank 1)
...
[12976] = { "Останній бій", nil, "Здоров'я збільшено на {1}% від максимального значення.#increased by {1}" }, -- Last Stand (aura)
...
-- Mocking Blow
[694] = { "Глумливий удар", "Глумлива атака, завдає {1} пошкодження, спричиняє помірний рівень загрози та змушує ціль атакувати вас впродовж {2} с.#causes {1} damage#for {2} sec", "Підбурений." }, -- Mocking Blow (Rank 1)
...
-- Mortal Strike
[12294] = { "Смертоносний удар", "Жорстокий удар, що завдає пошкодження зброєю плюс {1} і ранить ціль, знижуючи ефективність будь-якого зцілення на {2}% на {3} с.#damage plus {1}#healing by {2}% for {3} sec", "Ефекти зцілення знижено на {1}%.#reduced by {1}" }, -- Mortal Strike (Rank 1)
...
-- -- Pummel
[6552] = { "Луснути", "Лупить ціль, завдає {1} пошкодження. Перериває вимову закляття противником та унеможливлює вимову заклять тієї ж школи протягом {2} с.#for {1} damage#for {2} sec" }, -- Pummel (Rank 1)
...
-- Shield Bash
[72] = { "Удар щитом", "Удар цілі щитом, що наносить {1} пошкодження. Перериває вимову закляття противником у мить удару та унеможливлює вимову заклять тієї ж школи протягом {2} с.#for {1} damage#for {2} sec" }, -- Shield Bash (Rank 1)
