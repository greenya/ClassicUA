...
-- Enrage
[5229] = { "Несамовитість", "Надає {1} люті протягом {2} сек, але знижує базову броню на {3}% у ведмежій подобі та на {4}% у подобі жахливого ведмедя. Поки діє ефект, вважається, що друїд перебуває в бою.#{1} rage over {2} sec#{3}% in Bear Form and {4}% in Dire Bear Form", "Отримує {1} люті щосекунди. Базову броню зменшено.#{1} rage" }, -- Enrage
...
-- Faerie Fire
[770] = { "Чарівний вогонь", "Зменшує броню цілі на {1} протягом {2} с. Під час дії ефекту ціль не може стати непомітною або невидимою.#by {1} for {2} sec", "Зменшує броню цілі на {1}. Неможливо стати непомітним або невидимим.#armor by {1}" }, -- Faerie Fire (Rank 1)
...
-- Feline Grace
[20719] = { "Котяча грація", "Зменшує шкоду від падіння." }, -- Feline Grace

-- Feline Swiftness
[17002] = { "Котяча стрімкість", "Збільшує швидкість руху на {1}%, перебуваючи просто неба у котячій подобі, і збільшує шанс ухилитися у котячій подобі на {2}%.#speed by {1}#Form by {2}" }, -- Feline Swiftness (Rank 1)
...
-- Feral Charge
[16979] = { "Дикий ривок", "Ривок у ворога, що знерухомлює його та перериває вимову будь-якого закляття на {1} с.#for {1} sec", "Знерухомлений." }, -- Feral Charge
[19675] = { "Ефект дикого ривка", nil, "Знерухомлено." }, -- Feral Charge Effect (aura)
...
-- Ferocity
[16934] = { "Лютість", "Зменшує витрати люті або енергії для здібностей \"Терзання\", \"Розмах\", \"Дряпання\" та \"Полосування\" на {1} .#by {1}" }, -- Ferocity (Rank 1)
...
[24907] = { "Аура місячного совуха", nil, "Збільшує ймовірність критичного удару заклять на {1}%.#by {1}" }, -- Moonkin Aura (aura)
...
-- Healing Touch
[5185] = { "Цілющий дотик", "Лікує дружню ціль на {1}-{2} здоров'я.#for {1} to {2}" }, -- Healing Touch (Rank 1)
...
[17111] = { "Покращене відживлення", "Збільшує ефект вашого закляття \"Відживлення\" на {1}%.#by {1}" }, -- Improved Rejuvenation (Rank 1)
...
-- Innervate
[29166] = { "Осяяння", "Прискорює відновлення мани цілі на {1}% і дозволяє відновлення мани під час вимови заклять зі швидкістю {2}% від звичайної. Триває {3} с.#by {1}% and allows {2}%#Lasts {3} sec", "Відновлення мани прискорено на {1}% та продовжується під час вимови заклять зі швидкістю {2}% від звичайної.#increased by {1}#{2}% Mana" }, -- Innervate

-- Insect Swarm
[5570] = { "Рій комах", "Ворожу ціль оточують комахи, що зменшує її ймовірність поцілити на {1}% і завдає {2} шкоди від природи протягом {3} с.#hit by {1}#causing {2}#over {3} sec", "Імовірність поцілити зменшено на {1}% та отримання {2} шкоди від природи кожні {3} с.#by {1}% and {2}#every {3} sec" }, -- Insect Swarm (Rank 1)
...
-- Moonfire
[8921] = { "Місячний вогонь", "Обпалює ворога на {1}-{2} шкоди від аркани та ще на {3} шкоди від аркани протягом {4} с.#for {1} to {2}#additional {3}#over {4} sec", "{1} шкоди від аркани кожні {2} с.#{1} Arcane damage every {2} sec" }, -- Moonfire (Rank 1)
...
-- Pounce
[9005] = { "Стрибок", "Враз стрибнути, приголомшити ціль на {1} с та завдати {2} шкоди протягом {3} с. Потрібно зачаїтися та перебувати позаду цілі. Збільшує довжину комбінації на {4} прийом.#for {1} sec#causing {2} damage over {3} sec#{4} combo", "Приголомшено." }, -- Pounce (Rank 1)
...
-- Rake
[1822] = { "Полосування", "Дере ціль, завдаючи {1} шкоди та додатково {2} шкоди протягом {3} с. Збільшує довжину комбінації на {4} прийом.#for {1} damage and an additional {2} damage over {3} sec#{4} combo", "{1} шкоди від кровотечі кожні {2} с.#for {1} damage every {2} sec" }, -- Rake (Rank 1)
[1823] = { ref=1822 }, -- Rake (Rank 2)
[1824] = { ref=1822 }, -- Rake (Rank 3)
[9904] = { ref=1822 }, -- Rake (Rank 4)

-- Ravage
[6785] = { "Знищення", "Нищить ціль, завдаючи {1}% шкоди плюс {2}. Друїд має зачаїтися і перебувати позаду цілі. Збільшує довжину комбінації на {3} прийом.#causing {1}#plus {2}#{3} combo" }, -- Ravage (Rank 1)
...
-- Regrowth
[8936] = { "Розростання", "Зцілює дружню ціль на {1}-{2} здоров'я і ще на {3} здоров'я протягом {4} cек.#for {1} to {2}#{3} over {4} sec", "Зцілює на {1} здоров'я кожні {2} с.#{1} every {2} sec" }, -- Regrowth (Rank 1)
...
-- Rejuvenation
[774] = { "Відживлення", "Лікує ціль на {1} здоров'я протягом {2} с.#for {1} over {2} sec", "Лікує {1} шкоди кожні {2} с.#{1} damage every {2} sec" }, -- Rejuvenation (Rank 1)
...
-- Rip
[1079] = { "Розірвання", "Завершальний рух, що завдає шкоди з часом. Шкода збільшується залежно від довжини комбінації та сили атаки:\n  1 прийом: {1} шкоди за {2} cек\n  2 прийоми: {3} шкоди за {4} cек\n  3 прийоми: {5} шкоди за {6} cек\n  4 прийоми: {7} шкоди за {8} cек\n  5 прийомів: {9} шкоди за {10} cек#1 point  : {1} damage over {2}#2 points: {3} damage over {4}#3 points: {5} damage over {6}#4 points: {7} damage over {8}#5 points: {9} damage over {10}", "Шкода від кровотечі кожні {1} с.#every {1} sec" }, -- Rip (Rank 1)
...
-- Savage Fury
[16998] = { "Дика лють", "Збільшує шкоду від ваших здібностей \"Дряпання\", \"Полосування\", \"Терзання\" та \"Розмах\" на {1}%.#by {1}" }, -- Savage Fury (Rank 1)
...
-- Starfire
[2912] = { "Зоряний вогонь", "Завдає цілі від {1} до {2} шкоди від аркани.#Causes {1} to {2}" }, -- Starfire (Rank 1)
