...
— Робота з талантами класів:
    ...
    - В Classic більшість талантів мають переклад і мають відображатися вірно
    - В Wrath більшість талантів відрізняються від Classic нажаль тобто або додані, або змінені; додано ID для талантів воїнів (без Wrath-перекладу)
    - числові значення в підказках заклять поки що можуть не співпадати з оригіналом (в основному це стосується магічних значень пошкоджень); у магів було багато виправлень в цьому напрямку, інші класи на черзі
