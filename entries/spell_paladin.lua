...
-- Guardian's Favor
[20174] = { "Прихильність хранителя", "Зменшує час поновлення вашого \"Благословення захисту\" на {1} с і збільшує тривалість вашого \"Благословення сводоби\" на {2} с.#Protection by {1}#Freedom by {2}" }, -- Guardian's Favor (Rank 1)
[20175] = { ref=20174 }, -- Guardian's Favor (Rank 2)

-- Hammer of Justice
[853] = { "Молот справедливості", "Приголомшує ціль на {1} с.#for {1} sec", "Приголомшено." }, -- Hammer of Justice (Rank 1)
...
[20487] = { "Покращений молот справедливості", "Зменшує час поновлення вашого закляття \"Молот справедливості\" на {1} с.#by {1}" }, -- Improved Hammer of Justice (Rank 1)
...
-- Lay on Hands
[633] = { "Покладання рук", "Лікує дружню ціль на значення, яке не перевищує масимального здоров'я паладина. Витрачає весь залишок мани паладина при використанні." }, -- Lay on Hands (Rank 1)
[2800] = { "Покладання рук", "Лікує дружню ціль на значення, яке не перевищує масимального здоров'я паладина, та відновлює їй {1} мани. Витрачає весь залишок мани паладина при використанні.#restores {1}" }, -- Lay on Hands (Rank 2)
...
-- Pursuit of Justice
[26022] = { "Гонитва за справедливістю", "Підвищує швидкість руху та швидкість верхової їзди на {1}%. Не складається з іншими ефектами підвищення швидкості руху.#by {1}" }, -- Pursuit of Justice (Rank 1)
...
-- Redemption
[7328] = { "Порятунок", "Повертає мертвого гравця до життя з {1} здоров'я та {2} мани. Не можна застосувати в бою.#{1} health and {2} mana" }, -- Redemption (Rank 1)
