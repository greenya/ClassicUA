...
-- Commanding Shout
[403215] = { "Командирський крик", "Воїн кричить, збільшуючи витривалість всіх учасників групи в межах {1} м на {2}. Триває {3} хв.#within {1} yards by {2}#Lasts {3} min", "Збільшує вашу витривалість на {1}.#by {1}", en="Commanding Shout" },
...
[402913] = { "Несамовите відновлення", "Зцілює вам {1}% максимального запасу здоров'я протягом {2} секунд. Можна використати лише поки діє \"Несамовитість\", \"Лють берсерка\" або \"Кривава лють\". Можна застосовувати під час приголомшення.#for {1}% of#over {2} sec", "Зцілення {1}% максимального запасу здоров'я щосекунди.#Healing {1}% of", en="Enraged Regeneration" },
...
[431046] = { "Несамовитий натиск", "Під час використання дворучної зброї, ваша швидкість атаки збільшується на {1}%.#increased by {1}%", en="Frenzied Assault" },
-- Fresh Meat
...
-- Intervene
[403338] = { "Втручання", "Воїн здійснює стрімкий ривок до учасника групи, перехоплюючи наступну атаку ближнього або дальнього бою та зменшуючи загрозу цілі на {1}%.#by {1}%", "Наступна атака ближнього або дальнього бою, спрямована проти вас, натомість вразить воїна.", en="Intervene" },
...
[426969] = { "Смак крові", nil, "Дозволяє застосувати \"Здолання\".", en="Taste for Blood" },
...
-- Set bonus enchants
[1214159] = { "Сезон 3 - Предмет - Комплект храму Ан'Кіражу - Воїн - Бонус 2 предметів бійця", "Зменшує час відновлення \"Жаги смерті\" на {1}%.#Death Wish by {1}%", en="S03 - Item - TAQ - Warrior - Damage 2P Bonus" },
...
-- Set bonuses
[1214165] = { "Сезон 3 - Предмет - Комплект руїн Ан'Кіражу - Воїн - Бонус 3 предметів танка", "Зменшує час відновлення \"Ударної хвилі\" на {1}%.#Shockwave by {1}%", en="S03 - Item - RAQ - Warrior - Tank 3P Bonus" },
[457652] = { "Сезон 3 - Предмет - Комплект 1 - Воїн - Бонус 2 предметів бійця", "Після зміни стійки витрати люті на вашу наступну бойову здібність зменшуються на {1}.#is reduced by {1}", en="S03 - Item - T1 - Warrior - Damage 2P Bonus" },
[457697] = { "Сезон 3 - Предмет - Комплект 1 - Воїн - Бонус 4 предметів бійця", "Протягом {1} с після покидання стійки ви можете використовувати здібності, що вимагають цієї стійки.#For {1} sec after", en="S03 - Item - T1 - Warrior - Damage 4P Bonus" },
[457820] = { "Сезон 3 - Предмет - Комплект 1 - Воїн - Бонус 6 предметів бійця", "Протягом {1} с після покидання стійки ви отримуєте позитивний ефект:\n\nБойова стіка/Стійка гладіатора: Ви завдаєте на {2}% більше шкоди.\n\nСтійка берсерка: Ймовірність завдання критичого удару збільшується на {3}%.\n\nЗахисна стійка: Ви отримуєте на {4}% менше шкоди.#first {1} sec after#{2}% increased damage done#{3}% increased critical strike chance#{4}% reduced Physical damage taken", en="S03 - Item - T1 - Warrior - Damage 6P Bonus" },
[457645] = { "Сезон 3 - Предмет - Комплект 1 - Воїн - Бонус 2 предметів танка", "Збільшує показник блокування щитом на {1}.#block value of your shield by {1}", en="S03 - Item - T1 - Warrior - Tank 2P Bonus" },
[457646] = { "Сезон 3 - Предмет - Комплект 1 - Воїн - Бонус 4 предметів танка", "Ви отримуєте додатково {1} люті щоразу, коли отримуєте будь-яку шкоду чи завдаєте удару автоматичною атакою.#gain {1} extra Rage every", en="S03 - Item - T1 - Warrior - Tank 4P Bonus" },
[457651] = { "Сезон 3 - Предмет - Комплект 1 - Воїн - Бонус 6 предметів танка", "Збільшує вашу загрозу в захисній стійці додатково на {1}% та збільшує вашу шкоду в стійці гладіатора на {2}%.#Stance by an additional {1}%#Gladiator Stance by {2}%", en="S03 - Item - T1 - Warrior - Tank 6P Bonus" },
[468072] = { "Сезон 3 - Предмет - Комплект 2 - Воїн - Бонус 2 предметів бійця", "Критичні удари \"Здолання\" поновлюють тривалість ефекту \"Розриву\" на цілі до максимальної тривалості.", en="S03 - Item - T2 - Warrior - Damage 2P Bonus" },
[468235] = { "Сезон 3 - Предмет - Комплект 2 - Воїн - Бонус 4 предметів бійця", "Здібності \"Героїчний удар\", \"Розтрощення\" та \"Здолання\" завдають на {1}% більше шкоди.#abilities deal {1}% more", en="S03 - Item - T2 - Warrior - Damage 4P Bonus" },
[468236] = { "Сезон 3 - Предмет - Комплект 2 - Воїн - Бонус 6 предметів бійця", "Удари \"Розтрощення\" завершують відновлення здібностей \"Смертельний удар\", \"Кровожерливість\" та \"Трощення щитом\".", en="S03 - Item - T2 - Warrior - Damage 6P Bonus" },
[468065] = { "Сезон 3 - Предмет - Комплект 2 - Воїн - Бонус 2 предметів танка", "Ви отримуєте {1} люті щоразу коли парируєте атаку чи вашу атаку парирують.#gain {1} Rage every", en="S03 - Item - T2 - Warrior - Protection 2P Bonus" },
[468067] = { "Сезон 3 - Предмет - Комплект 2 - Воїн - Бонус 4 предметів танка", "\"Помста\" також надає вам ефект \"Шквалу\", збільшуючи вашу швидкість атаки на {1}% для наступних {2} замахів.#speed by {1}% for the next {2} swings", en="S03 - Item - T2 - Warrior - Protection 4P Bonus" },
[468069] = { "Сезон 3 - Предмет - Комплект 2 - Воїн - Бонус 6 предметів танка", "Коли ваша ціль парирує атаку, ви миттєво виконуєте удар у відповідь, завдаючи {1}% шкоди від зброї. Цей удар не можна блокувати, ухилитися від нього або парирувати, але його можна виконати лише раз на {2} секунд проти однієї цілі.#for {1}% weapon#once every {2} sec", en="S03 - Item - T2 - Warrior - Protection 6P Bonus" },
[1214163] = { "Сезон 3 - Предмет - Комплект храму Ан'Кіражу - Воїн - Бонус 4 предметів бійця", "Ви завдаєте на {1}% більше шкоди, поки на когось з ворогів неподалік діють обидва ваші ефекти \"Розрив\" та \"Глибокі рани\".#You deal {1}% increased", en="S03 - Item - TAQ - Warrior - Damage 4P Bonus" },
[1214160] = { "Сезон 3 - Предмет - Комплект храму Ан'Кіражу - Воїн - Бонус 2 предметів танка", "Зменшує час відновлення \"Громового удару\" на {1}%.#Clap by {1}%", en="S03 - Item - TAQ - Warrior - Tank 2P Bonus" },
[1214162] = { "Сезон 3 - Предмет - Комплект храму Ан'Кіражу - Воїн - Бонус 4 предметів танка", "\"Трощення щитом\" спричиняє на {1}% більше загрози, а його відновлення миттєво завершується, якщо його блокували, ухилилися або парирували.#deals {1}% increased threat", en="S03 - Item - TAQ - Warrior - Tank 4P Bonus" },
[468452] = { "Сезон 3 - Предмет - Комплект Зул'Ґуруба - Воїн - Бонус 3 предметів Гладіатора", "Зменшує час відновлення здібності \"Трощення щитом\" на {1} с.#Slam ability by {1} sec", en="S03 - Item - ZG - Warrior - Gladiator 3P Bonus" },
[468453] = { "Сезон 3 - Предмет - Комплект Зул'Ґуруба - Воїн - Бонус 5 предметів Гладіатора", "Зменшує час відновлення здібності \"Кривава лють\" на {1} с, поки ви перебуваєте в стійці гладіатора.#Bloodrage ability by {1} sec", en="S03 - Item - ZG - Warrior - Gladiator 5P Bonus" },
