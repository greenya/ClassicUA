...
-- Loyal Beta
[443320] = { "Вірний бета", nil, "Силу атаки збільшено на {1}%.#by {1}%" }, -- Loyal Beta
...
-- Shamanistic Rage
[425336] = { "Шаманська лють", "Зменшує всю отримувану вами шкоду на {1}%, і ви відновлюєте ману щосекунди протягом {2} секунд. Кількість мани, що відновлюється за секунду, дорівнює {3}% від вашої сили атаки, {4}% від сили заклинань або {5}% від сили зцілення, залежно від того, яке значення є більшим. Члени вашої групи та рейду в радіусі {6} м також відновлять {7}% від отриманої таким чином мани.#take by {1}%#for {2} sec#to {3}% of your Attack#{4}% of your spe#or {5}% of your healing#within {6} yards#receive {7}% of the mana", "Отримана шкода зменшена на {1}%.\nВідновлення {2} мани щосекунди.#by {1}%#{2} mana" }, -- Shamanistic Rage
...
-- Spirit of the Alpha
[408696] = { "Дух альфа-вовка", "Наділяє ціль духом альфа-вовка, збільшуючи всю її загрозу на {1}% протягом {2} хв. Одночасно може бути активним лише на одній цілі.#by {1}% for {2} min", "Загрозу збільшено на {1}%,#generated by {1}%" }, -- Spirit of the Alpha
