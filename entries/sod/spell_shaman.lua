...
-- Burn
[415231] = { "Горіння", "Ваш \"Вогняний шок\" тепер вражає до {1} цілей, діє на {2} с довше та завдає на {3}% більше шкоди.#up to {1} targets#gains {2} sec#deals {3}% increased", nil }, -- Burn
...
-- Mental Dexterity
[415140] = { "Гнучкість розуму", "Завдаючи шкоди \"Ударом лавою\" чи \"Штормовим ударом\" ви збільшуєте силу атаки на {1}% від вашого інтелекту, а шкода від заклинань і зцілення - на {2}% від вашої сили атаки протягом {3} c.#Power by {1}% of#healing by {2}%#for {3} sec", nil }, -- Mental Dexterity
