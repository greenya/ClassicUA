...
[408496] = { "Спеціалізація на бою з двох рук", "Коли ви тримаєте зброю в кожній руці ваша ймовірність влучити заклинаннями і атаками ближнього бою збільшується на {1}%, а ваша здібність \"Штормовий удар\" тепер завдає шкоду з обох рук.#by {1}% while", nil }, -- Dual Wield Specialization
