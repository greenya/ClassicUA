...
[469145] = { "Аспект сокола", "Мисливець переймає аспекти сокола, збільшуючи силу атаки ближнього та дальнього бою в тому ж обсязі, що й \"Аспект яструба\" найвищого вивченого рангу.\n\nПоки діє аспект сокола, талант \"Покращений аспект яструба\" може спрацьовувати від атак ближнього бою. Одночасно може бути активним лише один аспект.", "Збільшує силу атаки на {1}.#by {1}" }, -- Aspect of the Falcon
-- Aspect of the Viper
...
-- Beast Mastery
[409368] = { "Влада над звірами", "Шкода і здоров'я вашого вихованця збільшуються на {1}%, а відновлення концентрації - на {2}%. Крім того, \"Рик\" вашого вихованця тепер також провокує ціль, змушуючи її атакувати його протягом 3 секунд.#increased by {1}%#regeneration by {2}%" }, -- Beast Mastery
...
-- Clever Strikes
[467331] = { "Розумні удари", nil, "Збільшує шкоду наступної здібності ближнього бою, окрім \"Удару раптора\" та \"Підрізання крил\", на {1}%.#by {1}%" }, -- Clever Strikes
-- Cobra Slayer
...
-- Growl
[409372] = { "Рик", "Провокує ціль атакувати вас, але не діє, якщо ціль вже атакує вас.", "Спровоковано." }, -- Growl
-- Heart of the Lion
...
-- Hit and Run
[440533] = { "Бий-біжи", "Ваша швидкість руху збільшується на {1}% протягом {2} секунд після застосування \"Удару раптора\".\n\nБойові здібності ваших викликають у цілей \"Шалений сказ\", що збільшує їхню силу атаки ближнього бою на {3}, але зменшує броню на {4} протягом {5} хв. Скажені вороги не втікають та ігнорують ефекти страху та жаху.#gain {1}% movement speed for {2} sec#power by {3} but reducing armor by {4} for {5} min" }, -- Hit and Run
[440564] = { "Бий-біжи", "Отримати здібність \"Бий-біжи\":", rune=440533 }, -- Hit and Run
[440531] = { "Бий-біжи", nil, "Швидкість руху збільшено на {1}%.#by {1}%" }, -- Hit and Run
-- Hunter's Mark
[1213268] = { ref=1130 }, -- Hunter's Mark (Rank 4)
-- Immolation Trap
...
-- Lock and Load
[415413] = { "Захоплення цілі", "Щоразу, коли ви ставите пастку, ваша наступна здібність \"Постріл\" (окрім \"Дезорієнтуючого пострілу\") протягом 20 секунд не витрачає ману і не вимагає часу на відновлення." }, -- Lock and Load
...
-- Melee Specialist
[415352] = { "Фахівець з ближнього бою", "\"Удар раптора\" тепер застосовується миттєво, а \"Укус мангусти\" та \"Удар раптора\" з ймовірністю {1}% завершують відновлення \"Укусу мангусти\" та \"Удару раптора\".#a {1}% chance" }, -- Melee Specialist
[415723] = { "Фахівець з ближнього бою", "Отримати здібність \"Фахівець з ближнього бою\":", rune=415352 }, -- Melee Specialist
-- Precision
[456382] = { "Точність", nil, "Ваша наступна здібність-постріл завдасть на {1}% більше шкоди.#deals {1}%" }, -- Precision
-- Rabid Frenzy
[1218358] = { "Шалений сказ", "Викликає у цілі шалений сказ, що збільшує силу атаки ближнього бою на {1}, але зменшує броню на {2} протягом {3} хв. Скажені вороги не втікають та ігнорують ефекти страху та жаху.#power by {1} but#armor by {2} for {3} min", "Силу атаки ближнього бою збільшено на {1}, а броню зменшено на {2}. Ціль не втікатиме та ігноруватиме ефекти страху та жаху.#power by {1} and#armor by {2}" }, -- Rabid Frenzy
-- Rapid Killing
