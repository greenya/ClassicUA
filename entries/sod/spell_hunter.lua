...
-- Rapid Killing
[415405] = { "Швидке вбивство", "Зменшує час відновлення \"Швидкої стрілянини\" на {1}%, а ваша наступна здібність \"Постріл\" протягом {2} секунд після вбивства цілі, що приносить досвід або честь, завдає на {3}% більше шкоди.#by {1}%#within {2} sec#deals {3}% increased", nil }, -- Rapid Killing
