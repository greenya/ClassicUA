...
-- Melee Specialist
[415352] = { "Фахівець з ближнього бою", "\"Удар раптора\" тепер відновлюється {1} с і застосовується миттєво. \"Укус мангусти\" не вимагає часу на відновлення, а \"Удар раптора\" з ймовірністю {2}% відновлюється одразу після застосування.#reduced to {1} sec#has a {2}% chance" }, -- Melee Specialist
