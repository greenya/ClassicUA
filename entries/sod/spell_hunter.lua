...
-- Catlike Reflexes
[415428] = { "Котячі рефлекси", "Збільшує ваш шанс ухилення на {1}% і шанс ухилення вашого вихованця на {2}%. Крім того, зменшує час відновлення здібностей \"Команда \"Вбити\"\" та \"Фланговий удар\" на {3}%.#dodge by {1}% and#to dodge by {2}%.#abilities by {3}%", nil }, -- Catlike Reflexes
[415717] = { "Котячі рефлекси", "Отримати здібність \"Котячі рефлекси\":", nil, rune=415428 }, -- Catlike Reflexes
...
[436393] = { "Постріл химери - змія", ref=409493 }, -- Chimera Shot - Serpent
[436394] = { "Постріл химери - змія", ref=409493 }, -- Chimera Shot - Serpent
[436395] = { "Постріл химери - змія", ref=409493 }, -- Chimera Shot - Serpent
...
[415327] = { "Фланговий удар", nil, nil }, -- Flanking Strike
...
[431600] = { "Сконцентрований вогонь", "Отримати здібність \"Сконцентрований вогонь\":", nil, rune=428726 }, -- Focus Fire
...
-- Lock and Load
[415413] = { "Захоплення цілі", "Щоразу, коли спрацьовує одна з ваших пасток, ваша наступна здібність \"Постріл\" протягом 20 секунд не витрачає ману і не вимагає часу на відновлення.", nil }, -- Lock and Load
[415414] = { "Захоплення цілі", nil, "Наступна здібність \"Постріл\" не витрачає ману і не вимагає часу на відновлення." }, -- Lock and Load
[415719] = { "Захоплення цілі", "Отримати здібність \"Захоплення цілі\":", nil, rune=415413 }, -- Lock and Load
...
[415372] = { "Самотній вовк", nil, nil }, -- Lone Wolf
[438640] = { "Самотній вовк", nil, nil }, -- Lone Wolf
...
-- Rapid Killing
[415405] = { "Швидке вбивство", "Зменшує час відновлення \"Швидкої стрілянини\" на 2 хв, а ваша наступна здібність \"Постріл\" протягом 20 секунд після вбивства цілі, яка приносить досвід або честь, завдає на 20% більше шкоди.", nil }, -- Rapid Killing
[415407] = { "Швидке вбивство", nil, "Наступна здібність \"Постріл\" завдає на 20% більше шкоди." }, -- Rapid Killing
[415817] = { "Швидке вбивство", "Отримати здібність \"Швидке вбивство\":", nil, rune=415405 }, -- Rapid Killing

-- Raptor Fury
[415358] = { "Лють раптора", "\"Удар раптора\" збільшує шкоду від \"Удару раптора\" і \"Укусу мангусти\" на {1}% протягом {2} с. Ефект накопичується до {3} разів, а подальші отримання ефекту не поновлюють його тривалість.#by {1}% for {2} sec#up to {3} times", nil }, -- Raptor Fury
[415362] = { "Лють раптора", nil, "\"Удар раптора\" і \"Укус мангусти\" завдають на {1}% більше шкоди.#by {1}%" }, -- Raptor Fury
[415822] = { "Лють раптора", "Отримати здібність \"Лють раптора\":", nil, rune=415358 }, -- Raptor Fury
...
-- T.N.T.
[428717] = { "Тротил", "\"Вибуховий постріл\" та пастки завдають на {1}% більше шкоди.#by {1}%", nil }, -- T.N.T.
[431610] = { "Тротил", "Отримати здібність \"Тротил\":", nil, rune=428717 }, -- T.N.T.
...
[431601] = { "Гравіювання браслетів - Сконцентрований вогонь", "Вигравіювати на браслетах руну \"Сконцентрований вогонь\":", nil, rune=428726 }, -- Engrave Bracers - Focus Fire
[416093] = { "Гравіювання браслетів - Лють раптора", "Вигравіювати на браслетах руну \"Лють раптора\":", nil, rune=415358 }, -- Engrave Bracers - Raptor Fury
[431611] = { "Гравіювання браслетів - Тротил", "Вигравіювати на браслетах руну \"Тротил\":", nil, rune=428717 }, -- Engrave Bracers - T.N.T.
...
[416083] = { "Гравіювання шолома - Котячі рефлекси", "Вигравіювати на шоломі руну \"Котячі рефлекси\":", nil, rune=415428 }, -- Engrave Helm - Catlike Reflexes
[416085] = { "Гравіювання шолома - Захоплення цілі", "Вигравіювати на шоломі руну \"Захоплення цілі\":", nil, rune=415413 }, -- Engrave Helm - Lock and Load
[416090] = { "Гравіювання шолома - Швидке вбивство", "Вигравіювати на шоломі руну \"Швидке вбивство\":", nil, rune=415405 }, -- Engrave Helm - Rapid Killing
