...
-- Beast Mastery
[409368] = { "Влада над звірами", "Шкода і здоров'я вашого вихованця збільшуються на {1}%, а регенерація фокусу - на {2}%. Крім того, \"Рик\" вашого вихованця тепер також підбурює ціль, змушуючи її атакувати його протягом 3 секунд.#increased by {1}%#regeneration by {2}%", nil }, -- Beast Mastery
...
[409687] = { "Спеціалізація на бою з двох рук", "Збільшує шкоду від зброї в лівій руці на {1}%, \"Удар раптора\" тепер б'є зброєю з обох рук і завдає на {2}% більше шкоди, якщо ви тримаєте в обох руках зброю одного і того ж типу.#weapon by {1}%#deals {2}% increased", nil }, -- Dual Wield Specialization
