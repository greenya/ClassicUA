...
[412325] = { "Просвітлення", "{1}% відновлення мани продовжується під час вимови заклять.#Allows {1}% of", "{1}% відновлення мани продовжується під час вимови заклять.#Allows {1}% of" }, -- Enlightenment
[412326] = { "Просвітлення", "Збільшує всю шкоду заклять на {1}%.#by {1}%", "Збільшує всю шкоду заклять на {1}%.#by {1}%" }, -- Enlightenment
-- Expanded Intellect
...
-- Fool
[456401] = { "Дурість", ref=456399 }, -- Fool
-- Frost Ward
...
[440809] = { "Крижана куля", nil, "Швидкість руху зменшено на {1}%.#by {1}%" }, -- Frozen Orb
[460651] = { ref=440809 }, -- Frozen Orb
[440859] = { "Крижана куля", "Отримати здібність \"Крижана куля\":", rune=440802 }, -- Frozen Orb
-- Glaciate
[1218345] = { "Зледеніння", nil, "Ціль отримає на {1}% більше шкоди від наступного \"Крижаного списа\".#takes {1}%" }, -- Glaciate
-- Hot Streak
...
-- Ice Lance
[400640] = { "Крижаний спис", "Завдає від {1} до {2} шкоди від криги ворожій цілі. Завдає на {3}% більше шкоди замороженим цілям.\n\nКоли ваші інші крижані закляття завдають шкоди непідконтрольній гравцю цілі, шкода цілі від наступного \"Крижаного спису\" збільшується на {4}%. Цей ефект накопичується до {5} разів та вимагає активного таланту \"Зимова холоднеча\".#{1} to {2} Frost#Causes {3}% damage against#Lance by {4}%#up to {5} times" }, -- Ice Lance
...
-- Living Bomb
[400613] = { "Жива бомба", "Ціль стає живою бомбою і отримує {1} шкоди від вогню протягом {2} с. Через {3} с або коли заклинання розвіється, ціль вибухає, завдаючи {4} шкоди від вогню всім ворогам в радіусі {5} м.\n\n\"Жива бомба\" взаємодіє з усіма талантами та ефектами, що й \"Опік\".#taking {1}#over {2} sec#After {3} sec#dealing {4}#within {5} y", "{1} шкоди від вогню кожні {2} с. Через {3} с або коли заклинання буде розвіяно, ціль вибухає, завдаючи {4} шкоди від вогню всім ворогам в радіусі {5} м.#Causes {1}#every {2} sec#After {3} sec#causing {4}#within {5} y" }, -- Living Bomb
...
-- Noble
[456400] = { "Благородство", ref=456399 }, -- Noble
-- Overheat
...
-- Selfless
[456399] = { "Самовідданість", nil, "Збільшує завдану магічну шкоду на {1}%.#by {1}%" }, -- Selfless
-- Spell Power
...
-- Temporal Anomaly
[428885] = { "Темпоральна аномалія", "Запускає сферу темпоральної енергії, що повільно рухається вперед і кожні {1} c захищає членів групи, що знаходяться поблизу, щитом, який поглинає {2} шкоди протягом {3} секунд. Щит отримує додатковий обсяг поглинання, поки учасники групи знаходяться поруч зі сферою.#every {1} sec#absorbing {2} damage for {3} sec" }, -- Temporal Anomaly
...
[467141] = { "Прискорення думок", "Прискорює думки, збільшуючи швидкість вимови заклять на {1}% протягом {2} с.#spells by {1}% for {2} sec", "Швидкість вимови заклять збільшено на {1}%.#by {1}%" }, -- Mind Quickening
