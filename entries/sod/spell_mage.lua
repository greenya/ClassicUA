...
[401726] = { "Посилені обереги", "Отримати здібність \"Посилені обереги\":", rune=428738 }, -- Advanced Warding
...
-- Brain Freeze
[400731] = { "Замороження мозку", "Ваші заклинання, що охолоджують ціль, з ймовірністю {1}% дозволять вимовити наступне заклинання \"Вогняна куля\", \"Чарокрижана стріла\" або \"Стріла крижаного полум'я\" миттєво і без витрат мани.#have a {1}% chance" }, -- Brain Freeze
...
-- Fingers of Frost
[400647] = { "Крижані пальці", "Ваші ефекти охолодження з шансом {1}% активують ефект \"Крижані пальці\", який дозволяє вашим {2} наступним закляттям спрацьовувати так, ніби ціль заморожена. Триває {3} с.#a {1}% chance#next {2} spells#Lasts {3} sec" }, -- Fingers of Frost
...
[440804] = { "Заморожена куля" }, -- Frozen Orb
[440813] = { "Заморожена куля" }, -- Frozen Orb
-- Hot Streak
...
[400624] = { "Полум'яна вдача", "Коли заклинання \"Вогняна куля\", \"Вогняний підрив\", \"Опік\" або \"Жива бомба\" завдає критичної шкоди 2 рази поспіль, наступне заклинання \"Пірозрив\" можна буде вимовити миттєво протягом {1} секунд.#within {1} sec" }, -- Hot Streak
...
-- Spell Power
[412322] = { "Сила заклинань", "Збільшує бонус шкоди від критичного удару для всіх заклинань на {1}%.#spells by {1}%" }, -- Spell Power
...
-- Temporal Anomaly
[428885] = { "Темпоральна аномалія", "Запускає кулю темпоральної енергії, що повільно рухається вперед і кожні {1} c захищає членів групи, що знаходяться поблизу, щитом, який поглинає {2} шкоди протягом {3} секунд.#every {1} sec#absorbing {2} damage for {3} sec" }, -- Temporal Anomaly
...
[401749] = { "Гравіювання пояса - Полум'яна вдача", "Вигравіювати на поясі руну \"Полум'яна вдача\":", rune=400624 }, -- Engrave Belt - Hot Streak
...
[401761] = { "Гравіювання рукавиць - Повернення у часі", "Вигравіювати на рукавицях руну \"Повернення у часі\":", rune=401462 }, -- Engrave Gloves - Rewind Time
[401754] = { "Гравіювання шолома - Посилені обереги", "Вигравіювати на шоломі руну \"Посилені обереги\":", rune=428738 }, -- Engrave Helm - Advanced Warding
