...
-- Skull Bash
[410176] = { "Лобова атака", "Кинутись на ціль в радіусі {1} м і вдарити по черепу, перериваючи вимову заклинань і унеможливлюючи вимову заклять тієї ж школи протягом 2 с. Має спільне перезаряджання з \"Диким ривком\".", nil }, -- Skull Bash
...
-- Starfall
[429820] = { "Зорепад", "Завдає від {1} до {2} шкоди арканою ворогам у вибраній області кожні 2 с протягом 10 с.#{1} to {2}", nil }, -- Starfall
...
-- Wild Growth
[408120] = { "Дикий ріст", "Зцілює всіх членів групи цілі в радіусі 40 м від неї на {1} протягом {2} секунд. Зцілення спочатку відбувається швидко, а ближче до кінця дії ефекту сповільнюється.", "Зцілює {1} здоров'я кожні {2} с.#{1} damage every {2}" }, -- Wild Growth
