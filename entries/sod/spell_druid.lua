...
[417149] = { "Цвітіння", "Ваше \"Негайне відновлення\" також викликає ефект \"Цвітіння\", зцілюючи {1} найбільш ушкодженим членам групи в радіусі {2} від цілі {3} здоров'я кожні 5 с протягом 30 с.#the {1} most#within {2} yards#for {3} every", nil }, -- Efflorescence
...
-- Starsurge
[417157] = { "Зоряний сплеск", "Сплеск зоряної енергії, що завдає від {1} до {2} шкоди арканою.\n\n\"Зоряний сплеск\" взаємодіє з усіма ефектами, що й \"Гнів\" та \"Зоряний вогонь\".#{1} to {2}", nil }, -- Starsurge
