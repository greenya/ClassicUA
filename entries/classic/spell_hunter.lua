...
-- Bestial Wrath
[19574] = { "Звіриний гнів", "Роздратовує вашого вихованця, що збільшує завдане ним пошкодження на {1}% на {2} с. Розлючений звір не відчуває ні жалю, ні страху, і зупинити його може лише смерть.#causing {1}#for {2} sec", "Розлючений." }, -- Bestial Wrath
-- Call Pet
...
[13812] = { "Ефект вибухової пастки", nil, "{1} пошкодження вогнем кожні {2} c.#{1} Fire damage every {2} sec" }, -- Explosive Trap Effect (Rank 1)
...
-- Frost Trap Aura
[13810] = { "Аура крижаної пастки", nil, "Швидкість руху сповільнено на {1}%.#by {1}" }, -- Frost Trap Aura
-- Hawk Eye
...
[13797] = { "Ефект обпалюючої пастки", nil, "{1} пошкодження вогнем кожні {2} c.#{1} Fire damage every {2} sec" }, -- Immolation Trap Effect (Rank 1)
