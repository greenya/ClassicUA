...
-- Trueshot Aura
[19506] = { "Аура влучного пострілу", "Збільшує силу атаки учасників групи в межах {1} м на {2}. Триває {3} хв.#within {1} yards by {2}#Lasts {3} min", "Силу атаки збільшено на {1}.#by {1}" }, -- Trueshot Aura (Rank 1)
