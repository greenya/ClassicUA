...
-- Bestial Wrath
[19574] = { "Звіриний гнів", "Роздратовує вашого вихованця, що збільшує завдану ним шкоду на {1}% на {2} с. Розлючений звір не відчуває ні жалю, ні страху, і зупинити його може лише смерть.#causing {1}#for {2} sec", "Розлючений." }, -- Bestial Wrath
-- Call Pet
