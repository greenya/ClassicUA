...
-- Arcane Shot
[3044] = { "Арканічний постріл", "Миттєвий постріл, що завдає {1} шкоди арканою.#causes {1} Arcane", en="Arcane Shot" },
...
-- Aspect of the Beast
[13161] = { "Аспект звіра", "Мисливець переймає аспекти звіра, внаслідок чого його стає неможливо відстежити. Одночасно може бути активним лише один аспект.", "Неможливо відстежити.", en="Aspect of the Beast" },
...
-- Aspect of the Pack
[13159] = { "Аспект зграї", "Мисливець і учасники групи в межах {1} м переймають аспекти зграї гепардів, збільшуючи швидкість руху на {2}%. Отримана шкода викличе в учасника зграї запаморочення на {3} с. Одночасно може бути активним лише один аспект.#within {1} y#speed by {2}%#for {3} sec", "Швидкість руху збільшено на {1}%. Запаморочення при отриманні шкоди.#{1}% increased", en="Aspect of the Pack" },
-- Aspect of the Wild
...
-- Barrage
[19461] = { "Шквал", "Збільшує шкоду ваших здібностей \"Багатозарядний постріл\" та \"Обстріл\" на {1}%.#by {1}%", en="Barrage" },
...
-- Bestial Swiftness
[19596] = { "Звіряча стрімкість", "Перебуваючи просто неба ваші вихованці рухаються на {1}% швидше.#by {1}%", en="Bestial Swiftness" },
-- Bestial Wrath
...
-- Black Arrow
[3674] = { "Чорна стріла", "Випускає в ціль чорну стрілу, що зменшує швидкість руху на {1}%, завдає {2} шкоди від тіні та висмоктує {3} мани протягом {4} с.#speed by {1}%#causing {2} Shadow damage#draining {3} mana over {4} sec", "Швидкість руху зменшено на {1}%. Завдає {2} шкоди від тіні кожні {3} с. Висмоктує {4} мани кожні {5} с.#reduced by {1}%#Causes {2} Shadow damage every {3} sec#Drains {4} mana every {5} sec", en="Black Arrow" },
-- Call Pet
...
-- Entrapment
[19184] = { "Схоплення", "Надає вашим здібностям \"Обпалююча пастка\", \"Крижана пастка\" та \"Вибухова пастка\" {1}% ймовірності схопити ціль, унеможливлюючи її рух протягом {2} с.#a {1}% chance#for {2} sec", en="Entrapment" },
[19185] = { "Схоплення", nil, "Знерухомлено.", en="Entrapment" },
[19387] = { ref=19184 }, -- Entrapment
[19388] = { ref=19184 }, -- Entrapment
[19389] = { ref=19184 }, -- Entrapment
[19390] = { ref=19184 }, -- Entrapment
-- Explosive Trap
[13813] = { "Вибухова пастка", "Встановити вогняну пастку, яка вибухне при наближенні ворога, завдаючи від {1} до {2} шкоди вогнем і додатково {3} шкоди вогнем протягом {4} с усім ворогам у радіусі {5} м. Пастка існуватиме {6} хв. Пастки можна встановлювати лише поза боєм. Одночасно може бути активною лише одна пастка.#causing {1} to {2}#{3} additional Fire damage over {4} sec#within {5} y#exist for {6} min", en="Explosive Trap" },
...
[19454] = { "Покращений арканічний постріл", "Зменшує час відновлення \"Арканічного пострілу\" на {1} с.#Shot by {1} sec", en="Improved Arcane Shot" },
...
[19552] = { "Покращений аспект яструба", "Поки діє аспект яструба, всі звичайні атаки дальнього бою з ймовірністю {1}% збільшать швидкість атаки дального бою на {2}% протягом {3} с.#a {1}% chance#by {2}% for {3} sec", en="Improved Aspect of the Hawk" },
...
[19549] = { "Покращений аспект мавпи", "Збільшує бонус до ймовірності ухилення від аспекту мавпи на {1}%.#by {1}%", en="Improved Aspect of the Monkey" },
...
[19286] = { "Покращене вдавання мертвого", "Зменшує ймовірність опору вашій здібності \"Удавання мертвого\" на {1}%.#by {1}%", en="Improved Feign Death" },
...
-- Improved Mend Pet
[19572] = { "Покращене зцілення вихованця", "\"Зцілення вихованця\" з ймовірністю {1}% знімає {2} ефект прокляття, хвороби, магії або отрути на кожному такті зцілення.#a {1}% chance#cleansing {2}", en="Improved Mend Pet" },
...
-- Intimidation
[19577] = { "Залякування", "Наказати вашому вихованцю залякати ціль із наступною успішною атакою ближнього бою, спричиняючи високий рівень загрози та приголомшуючи її на {1} с.#for {1} sec", "Лячний.", en="Intimidation" },
...
-- Lethal Shots
[19426] = { "Летальні постріли", "Збільшує ймовірність критичного удару зброєю дальнього бою на {1}%.#by {1}%", en="Lethal Shots" },
...
-- Mend Pet
[136] = { "Зцілення вихованця", "Відновлює вашому вихованцю {1} здоров'я щосекунди поки ви зосереджуєтеся на зціленні. Триває {2} с.#pet {1} health#Lasts {2} sec", "Відновлює {1} здоров'я щосекунди.#Heals {1}", en="Mend Pet" },
...
[24294] = { ref=24293 }, -- Monster Slaying
[24295] = { ref=24293 }, -- Monster Slaying
-- Mortal Shots
[19485] = { "Смертельні постріли", "Збільшує додаткову шкоду від критичних ударів зброєю дальнього бою[ та здібностями ближнього бою#and melee ability] на {1}%.#damage bonus by {1}%", en="Mortal Shots" },
...
-- Spirit Bond
[19578] = { "Духовний зв'язок", "Поки ваш вихованець активний, ви обоє відновлюєте {1}% здоров'я кожні {2} с.#{1}% of total health every {2} sec", en="Spirit Bond" },
[19579] = { "Духовний зв'язок", nil, "Відновлення {1}% здоров'я кожні {2} с.#{1}% of total health every {2} sec", en="Spirit Bond" },
...
-- Viper Sting
[3034] = { "Жало гадюки", "Жалить ціль, випалюючи {1} мани протягом {2} с. Лише один ефект жала від кожного мисливця може бути активним на одній цілі.#{1} mana over {2} sec", "Випалює {1} мани кожні {2} с.#{1} mana every {2} sec", en="Viper Sting" },
...
[24335] = { "Жало виверни", "Постріл, що жалить ціль та занурює її в сон на {1} с. Будь-яка шкода пробудить ціль. Коли ціль прокинеться, жало завдасть від {2} до {3} шкоди від природи протягом {4} с.#sleep for {1} sec#causes {2} to {3} Nature#over {4} sec", "Спить.", en="Wyvern Sting" },
[24336] = { "Жало виверни", nil, "Від {1} до {2} шкоди від природи кожні {3} с.#{1} to {2} Nature#every {3} sec", en="Wyvern Sting" },
[26180] = { "Жало виверни", "Постріл, що жалить ціль та занурює її в сон на {1} с. Будь-яка шкода пробудить ціль.#for {1} sec", "Спить.", en="Wyvern Sting" },

-- Item effects
[23721] = { "Вливання аркани", "Наповнює вас енергією аркани, внаслідок чого наступне застосування \"Арканічного пострілу\" протягом {1} с підриває ціль. Акранічний вибух завдає [{1}#deal {1} damage][від {1} до {2}#deal {1} to {2} damage] шкоди ворогам поруч з ціллю.#within {1} sec", "Наступний \"Арканічний постріл\" спричинить акранічний вибух.", en="Arcane Infused" },
...
[27205] = { "Збільшення шкоди вихованця +{1}%#Pet Damage +{1}%", "Збільшує шкоду вашого вихованця на {1}%.#pet's damage by {1}%", "Збільшує шкоду вашого вихованця на {1}%.#damage by {1}%", en="Increased Pet Damage +3%" },
[27206] = { "Збільшення шкоди вихованця +{1}%#Pet Damage +{1}%", "Збільшує шкоду вашого вихованця на {1}%.#by your pet by {1}%", en="Increased Pet Damage +3%" },
...
-- Set bonuses
[26176] = { "Бонус шкоди вихованця Незримого Шляху", "Збільшує шкоду вашого вихованця на {1}%.#pet's damage by {1}%", en="Unseen Path Pet Bonus" },
