...
-- Bestial Wrath
[19574] = { "Звіряча лють", "Роздратовує вашого вихованця, що збільшує завдане ним пошкодження на {1}% на {2} с. Розлючений звір не відчуває ні жалю, ні страху, і зупинити його може лише смерть.#causing {1}#for {2} sec", "Розлючений." }, -- Bestial Wrath
-- Call Pet
...
[19410] = { "Покращений шоковий постріл", nil, "Приголомшений." }, -- Improved Concussive Shot
