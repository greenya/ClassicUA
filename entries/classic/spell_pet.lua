...
-- Boar Charge
[25999] = { "Ривок кнура", nil, "Знерухомлений." }, -- Boar Charge
-- Charge
...
[25029] = { "Вогнемет", nil, "Завдає {1} пошкодження щосекунди. Рух сповільнено на {2}%.#Deals {1}#slowed by {2}" }, -- Flamethrower
-- Frost Resistance
...
-- Shell Shield
[26064] = { "Панцирний щит", "Зменшує пошкодження отримуване вашим вихованцем на {1}%, але збільшує час між його атаками на {2}%. Триває {3} с.#takes by {1}#attacks by {2}#Lasts {3} sec", "Пошкодження зменшено на {1}% та час між атаками збільшено на {2}%.#reduced by {1}#increased by {2}" }, -- Shell Shield (Rank 1)
-- Soothing Kiss
...
[24259] = { "Заборона чар", nil, "Знемовлений." }, -- Spell Lock
-- Suffering
