...
[2649] = { "Рик", "Підбурює ціль, збільшуючи ймовірність того, що вона зосередить свої атаки на вас." }, -- Growl (Rank 1)
...
-- Prowl
[24450] = { "Зачаїтися", "Ваш вихованець стає непомітним, але його рух уповільнюється на {1}%. Шкоду першої атаки з непомітності буде збільшено на {2}%. Триває до скасування.#speed by {1}#{2}% bonus", "Непомітність. Рух сповільнено на {1}%.#slowed by {1}" }, -- Prowl (Rank 1)
...
-- Suffering
[17735] = { "Страждання", "Підбурює всіх ворогів у межах {1} м, збільшуючи ймовірність того, що вони атакуватимуть пустотника.#within {1} y" }, -- Suffering (Rank 1)
[17750] = { "Страждання", "Підбурює всіх ворогів у межах {1} м, збільшуючи ймовірність того, що вони атакуватимуть пустотника. Дієвіше за \"Страждання\" (Ранг {2}).#within {1} y#(Rank {2})" }, -- Suffering (Rank 2)
...
[7809] = { "Муки", "Підбурює істоту, збільшуючи ймовірність того, що вона зосередить свої атаки на пустотнику. Дієвіше за \"Муки\" (Ранг {1}).#(Rank {1})" }, -- Torment (Rank 2)
