...
-- Blood Pact
[6307] = { "Кривава угода", "Збільшує витривалість учасників групи на {1}.#by {1}", "Збільшує витривалість на {1}.#by {1}", en="Blood Pact" },
...
-- Consume Shadows
[17767] = { "Поглинання тіней", "Пустотник поглинає тіні поблизу, щоб укріпити своє втілення, і відновлює {1} здоров'я протягом {2} с. Не можна використовувати в бою.#{1} health over {2} sec", "Зцілює {1} здоров'я кожні {2} с.#{1} damage every {2} sec", en="Consume Shadows" },
...
-- Devour Magic
[19505] = { "Пожирання магії", "Очищує дружню ціль від {1} шкідливого магічного ефекту або ворожу ціль від {2} сприятливого магічного ефекту. Пожирання ефекту зцілює скверногончій {3} здоров'я.#{1} harmful#{2} beneficial#healed for {3}", en="Devour Magic" },
...
[24441] = { ref=23992 }, -- Fire Resistance
[24444] = { ref=23992 }, -- Fire Resistance
[24445] = { ref=23992 }, -- Fire Resistance
[24463] = { ref=23992 }, -- Fire Resistance
[24464] = { ref=23992 }, -- Fire Resistance
-- Fire Shield
[2947] = { "Вогняний щит", "Оточує ціль щитом з вогню. Кожен удар по цілі завдає {1} шкоди вогнем нападнику. Триває {2} хв. Заклинач не може накласти \"Вогняний щит\" на себе.#causes {1}#Lasts {2} min", "Завдає {1} шкоди вогнем нападникові при отриманні удару.#Does {1}", en="Fire Shield" },
[8316] = { ref=2947 }, -- Fire Shield
[8317] = { ref=2947 }, -- Fire Shield
[11770] = { ref=2947 }, -- Fire Shield
[11771] = { ref=2947 }, -- Fire Shield
-- Firebolt
[3110] = { "Вогняна стріла", "Завдає цілі від {1} до {2} шкоди.#Deals {1} to {2}", en="Firebolt" },
...
-- Furious Howl
[24597] = { ref=24604 }, -- Furious Howl
[24603] = { ref=24604 }, -- Furious Howl
[24604] = { "Скажене виття", "Учасники групи в межах {1} м отримують додатково від {2} до {3} шкоди до їхньої наступної фізичної атаки. Триває {4} с.#within {1}#{2} to {3} damage#Lasts {4} sec", "Ваша наступна фізична атака завдасть додатково від {1} до {2} шкоди.#{1} to {2} damage", en="Furious Howl" },
[24605] = { ref=24604 }, -- Furious Howl
-- Great Stamina
[4187] = { "Міцна витривалість", "Витривалість збільшено на {1}.#by {1}", en="Great Stamina" },
...
-- Lesser Invisibility
[7870] = { "Мала невидимість", "Надає вашому викликаному демонові малу невидимість на {1} хв. Закляття можна застосувати лише поза боєм.#for up to {1} min", "Невидимий.", en="Lesser Invisibility" },
-- Lightning Breath
...
-- Paranoia
[19480] = { "Параноя", "Підсилює здатність виявлення непомітності всіх учасників групи в межах {1} м від скверногончої.#within {1} y", "Здатність виявлення непомітності підсилена.", en="Paranoia" },
-- Phase Shift
...
-- Sacrifice
[7812] = { "Жертва", "Приносить в жертву пустотника, при цьому його володар отримує щит, який поглинає {1} шкоди протягом {2} с. Поки щит тримається, отримання шкоди не спричиняє затримки вимови заклять.#absorb {1} damage for {2} sec", "Поглинає всю шкоду.", en="Sacrifice" },
...
-- Scorpid Poison
[24583] = { ref=24640 }, -- Scorpid Poison
[24586] = { ref=24640 }, -- Scorpid Poison
[24587] = { ref=24640 }, -- Scorpid Poison
[24640] = { "Отрута скорпіда", "Завдає {1} шкоди від природи протягом {2} с. Ефект накопичується до {3} разів на одній цілі.#{1} Nature damage over {2} sec#{3} times", "{1} шкоди від природи кожні {2} с.#{1} Nature damage every {2} sec", en="Scorpid Poison" },
-- Screech
