...
-- Charge
[7371] = { "Ривок", "Ривок у ворога, що знерухомлює його на {1} с і додає {2} сили атаки ближнього бою до наступної атаки кнура." }, -- Charge (Rank 1)
...
[25999] = { "Ривок кнура", nil, "Знерухомлений." }, -- Boar Charge (aura)
...
-- Cobra Reflexes
[25076] = { "Рефлекси кобри", "Швидкість атаки збільшено на {1}%, але зменшено пошкодження.#by {1}" }, -- Cobra Reflexes (Rank 1)
