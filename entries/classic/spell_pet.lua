...
-- Tainted Blood
[19478] = { "Заражена кров", "Заражає кров скверногончої на {1} хв. Коли скверногончу вдаряють атакою ближнього бою, нападник втратить {2} сили атаки ближнього бою на {3} с. Накопичується до {4} разів на одній цілі.#blood for {1} min#{2} melee attack power for {3} sec#{4} times", "Відбирає {1} сили атаки ближнього бою при ударі. Накопичується до {2} разів.#Drains {1}#{2} times" }, -- Tainted Blood (Rank 1)
