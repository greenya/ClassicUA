...
-- Devour Magic Effect
[19658] = { "Ефект пожирання магії", en="Devour Magic Effect" },
-- Dive
...
-- Soothing Kiss
[6360] = { "Заспокійливий поцілунок", "Заспокоює ціль, збільшуючи ймовірність того, що вона атакуватиме когось іншого.", en="Soothing Kiss" },
[7813] = { "Заспокійливий поцілунок", "Заспокоює ціль, збільшуючи ймовірність того, що вона атакуватиме когось іншого. Дієвіше за \"Заспокійливий поцілунок\" (Ранг {1}).#(Rank {1})", en="Soothing Kiss" },
