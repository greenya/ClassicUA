...
-- Arcane Resistance
[24493] = { "Опір аркані", "Збільшує опір аркані на {1}.#by {1}", "Збільшує опір аркані на {1}.#by {1}" }, -- Arcane Resistance (Rank 1)
...
-- Consume Shadows
[17767] = { "Поглинання тіней", "Пустотник поглинає тіні поблизу, щоб укріпити своє втілення, і відновлює {1} здоров'я протягом {2} с. Не можна використовувати в бою.#{1} health over {2} sec", "Зцілює {1} здоров'я кожні {2} с.#{1} damage every {2} sec" }, -- Consume Shadows (Rank 1)
...
-- Dash
[23099] = { "Порив", "Збільшує швидкість руху на {1}% протягом {2} с.#by {1}% for {2} sec", "Збільшує швидкість руху на {1}%.#by {1}" }, -- Dash (Rank 1)
[23109] = { ref=23099 }, -- Dash (Rank 2)
[23110] = { ref=23099 }, -- Dash (Rank 3)
-- Devour Magic
[19505] = { "Пожирання магії", "Очищує дружню ціль від {1} шкідливого магічного ефекту або ворожу ціль від {2} сприятливого магічного ефекту. Пожирання ефекту зцілює скверногончій {3} здоров'я.#{1} harmful#{2} beneficial#healed for {3}" }, -- Devour Magic (Rank 1)
[19731] = { ref=19505 }, -- Devour Magic (Rank 2)
[19734] = { ref=19505 }, -- Devour Magic (Rank 3)
[19736] = { ref=19505 }, -- Devour Magic (Rank 4)
-- Dive
[23145] = { "Пікірування", "Збільшує швидкість руху на {1}% протягом {2} с.#by {1}% for {2} sec", "Збільшує швидкість руху на {1}%.#by {1}" }, -- Dive (Rank 1)
[23147] = { ref=23145 }, -- Dive (Rank 2)
[23148] = { ref=23145 }, -- Dive (Rank 3)
-- Fire Resistance
[23992] = { "Опір вогню", "Збільшує опір вогню на {1}.#by {1}", "Збільшує опір вогню на {1}.#by {1}" }, -- Fire Resistance (Rank 1)
...
-- Fire Shield
[2947] = { "Вогняний щит", "Оточує ціль щитом з вогню. Кожен удар по цілі завдає {1} шкоди вогнем нападнику. Триває {2} хв. Заклинач не може накласти \"Вогняний щит\" на себе.#causes {1}#Lasts {2} min", "Завдає {1} шкоди вогнем нападникові при отриманні удару.#Does {1}" }, -- Fire Shield (Rank 1)
...
[25029] = { "Вогнемет", nil, "Завдає {1} шкоди щосекунди. Швидкість руху зменшено на {2}%.#Deals {1}#slowed by {2}" }, -- Flamethrower
-- Frost Resistance
[24446] = { "Опір кризі", "Збільшує опір кризі на {1}.#by {1}", "Збільшує опір кризі на {1}.#by {1}" }, -- Frost Resistance (Rank 1)
...
[24604] = { "Скажене виття", "Учасники групи в межах {1} м отримують додатково від {2} до {3} шкоди до їхньої наступної фізичної атаки. Триває {4} с.#within {1}#{2} to {3} damage#Lasts {4} sec", "Ваша наступна фізична атака завдасть додатково від {1} до {2} шкоди.#{1} to {2} damage" }, -- Furious Howl (Rank 1)
...
[2649] = { "Рик", "Провокує ціль, збільшуючи ймовірність того, що вона зосередить свої атаки на вас." }, -- Growl (Rank 1)
...
-- Nature Resistance
[24492] = { "Опір природі", "Збільшує опір природі на {1}.#by {1}", "Збільшує опір природі на {1}.#by {1}" }, -- Nature Resistance (Rank 1)
...
[8611] = { "Фазування", nil, "Невидимість, але не може атакувати. Невразливість до всіх атак і заклять." }, -- Phase Shift
-- Prowl
[24450] = { "Зачаїтися", "Ваш вихованець стає непомітним, але його рух уповільнюється на {1}%. Шкоду першої атаки з непомітності буде збільшено на {2}%. Триває до скасування.#speed by {1}#{2}% bonus", "Непомітність. Швидкість руху зменшено на {1}%.#slowed by {1}%" }, -- Prowl (Rank 1)
[24452] = { ref=24450 }, -- Prowl (Rank 2)
[24453] = { ref=24450 }, -- Prowl (Rank 3)
-- Sacrifice
[7812] = { "Жертва", "Приносить в жертву пустотника, при цьому його володар отримує щит, який поглинає {1} шкоди протягом {2} с. Поки щит тримається, отримання шкоди не спричиняє затримки вимови заклять.#absorb {1} damage for {2} sec", "Поглинає всю шкоду." }, -- Sacrifice (Rank 1)
...
-- Screech
[24423] = { "Вереск", "Вражає одну ціль, завдаючи від {1} до {2} шкоди та зменшує силу атаки ближнього бою всіх ворогів у межах ближнього бою на {3}. Ефект триває {4} с.#for {1} to {2}#range by {3}#lasts {4} sec", "Силу атаки ближнього бою зменшено на {1}.#by {1}" }, -- Screech (Rank 1)
[24577] = { ref=24423 }, -- Screech (Rank 2)
[24578] = { ref=24423 }, -- Screech (Rank 3)
[24579] = { ref=24423 }, -- Screech (Rank 4)
-- Seduction
[6358] = { "Зваблення", "Зваблює ціль, перешкоджаючи всім її діям протягом {1} с. Будь-яка шкода скасує ефект. Діє лише на гуманоїдів.#for up to {1} sec", "Причаровано." }, -- Seduction
-- Shadow Resistance
[24488] = { "Опір тіні", "Збільшує опір тіні на {1}.#by {1}", "Збільшує опір тіні на {1}.#by {1}" }, -- Shadow Resistance (Rank 1)
...
-- Shell Shield
[26064] = { "Панцирний щит", "Зменшує шкоду отриману вашим вихованцем на {1}%, але збільшує інтервал між його атаками на {2}%. Триває {3} с.#takes by {1}#attacks by {2}#Lasts {3} sec", "Отриману шкоду зменшено на {1}%, а інтервал між атаками збільшено на {2}%.#reduced by {1}#increased by {2}" }, -- Shell Shield (Rank 1)
-- Soothing Kiss
...
-- Suffering
[17735] = { "Страждання", "Провокує всіх ворогів у межах {1} м, збільшуючи ймовірність того, що вони атакуватимуть пустотника.#within {1} y" }, -- Suffering (Rank 1)
[17750] = { "Страждання", "Провокує всіх ворогів у межах {1} м, збільшуючи ймовірність того, що вони атакуватимуть пустотника. Дієвіше за \"Страждання\" (Ранг {2}).#within {1} y#(Rank {2})" }, -- Suffering (Rank 2)
[17751] = { ref=17750 }, -- Suffering (Rank 3)
[17752] = { ref=17750 }, -- Suffering (Rank 4)
-- Tainted Blood
[19478] = { "Заражена кров", "Заражає кров скверногончої на {1} хв. Коли скверногончу вдаряють атакою ближнього бою, нападник втратить {2} сили атаки ближнього бою на {3} с. Накопичується до {4} разів на одній цілі.#blood for {1} min#{2} melee attack power for {3} sec#{4} times", "Відбирає {1} сили атаки ближнього бою при отриманні удару. Накопичується до {2} разів.#Drains {1}#{2} times" }, -- Tainted Blood (Rank 1)
...
-- Torment
[3716] = { "Муки", "Провокує істоту, збільшуючи ймовірність того, що вона зосередить свої атаки на пустотнику." }, -- Torment (Rank 1)
[7809] = { "Муки", "Провокує істоту, збільшуючи ймовірність того, що вона зосередить свої атаки на пустотнику. Дієвіше за \"Муки\" (Ранг {1}).#(Rank {1})" }, -- Torment (Rank 2)
