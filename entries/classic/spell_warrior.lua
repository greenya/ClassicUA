...
-- Death Wish
[12328] = { "Бажання смерті", "При активації збільшує фізичну шкоду на {1}% і надає невразливість до ефектів страху, але знижує броню та всі види опору на {2}%. Триває {3} с.#damage by {1}#resistances by {2}#Lasts {3} sec", "Збільшує фізичну шкоду на {1}%. Знижує броню та всі види опору на {2}%. Невразливість до ефектів страху.#damage by {1}#resistances by {2}" }, -- Death Wish
-- Deep Wounds
...
-- Enrage
[12317] = { "Сказ", "Збільшує шкоду в ближньому бою на {1}% протяго {2} с, але не білше, ніж на {3} ударів, після отримання критичного удару.#{1}% melee damage#for {2} sec#{3} swings" }, -- Enrage (Rank 1)
[12880] = { "Сказ", nil, "Шкоду в ближньому бою збільшено на {1}%.#increased by {1}" }, -- Enrage (Rank 1)
...
-- Mocking Blow
[694] = { "Глумливий удар", "Глумлива атака, що завдає {1} шкоди, спричиняє помірний рівень загрози та змушує ціль атакувати вас впродовж {2} с.#causes {1} damage#for {2} sec", "Підбурений." }, -- Mocking Blow (Rank 1)
...
-- Mortal Strike
[12294] = { "Смертоносний удар", "Жорстокий удар, що завдає шкоди зброєю плюс {1} і ранить ціль, знижуючи ефективність будь-якого зцілення на {2}% протягом {3} с.#damage plus {1}#healing by {2}% for {3} sec", "Ефекти зцілення знижено на {1}%.#reduced by {1}" }, -- Mortal Strike (Rank 1)
...
-- Overpower
[7384] = { "Здолання", "Миттєво долає противника, завдаючи шкоди зброєю плюс {1}. Можна використати лише після того як ціль ухилилась. Здолання не можна блокувати, ухилитися від нього або парирувати.#damage plus {1}" }, -- Overpower (Rank 1)
...
-- Revenge
[6572] = { "Помста", "Миттєво контратакує ворога, завдаючи від {1} до {2} шкоди та сильно підвищує рівень загрози. Помста повинна слідувати за блоком, ухиленням або парируванням.#for {1} to {2} damage" }, -- Revenge (Rank 1)
...
-- Shield Slam
[23922] = { "Трощення щитом", "Трощить ціль щитом, завдаючи від {1} до {2} шкоди залежно від вашого показника блоку щитом, та має 50% ймовірності розвіяти 1 магічний ефект на цілі. Також спричиняє великий рівень загрози.#causing {1} to {2} damage" }, -- Shield Slam (Rank 1)
...
-- Thunder Clap
[6343] = { "Гуркіт грому", "Вражає ворогів поруч, збільшуючи час між їхніми атаками на {1}% на {2} с та завдаючи їм {3} шкоди. Подіє не більше ніж на {4} цілі.#attacks by {1}% for {2} sec and doing {3} damage#up to {4} targets", "Час між атаками збільшено на {1}%.#increased by {1}" }, -- Thunder Clap (Rank 1)
...
-- Whirlwind
[1680] = { "Вихор", "У сталевому вихорі ви атакуєте до {1} ворогів у радіусі {2} м, завдаючи шкоди зброєю кожному ворогу.#up to {1} enemies within {2} yards" }, -- Whirlwind
...
[71] = { "Оборонна стійка", "Захисна стійка. Зменшує отриману шкоду на {1}% та заподіяну на {2}%. Підвищує рівень загрози.#taken by {1}#caused by {2}" }, -- Defensive Stance
