...
-- Anger Management
[12296] = { "Контроль гніву", "Збільшує час, необхідний для згасання люті поза боєм, на {1}%.#combat by {1}%" }, -- Anger Management
-- Anticipation
...
-- Axe Specialization
[12700] = { "Спеціалізація на сокирах", "Збільшує ймовірність завдання критичного удару сокирами на {1}%.#Axes by {1}%" }, -- Axe Specialization (Rank 1)
...
[6673] = { "Бойовий клич", "Воїн кричить, збільшуючи силу атаки ближнього бою всіх учасників групи в межах {1} м на {2}. Триває {3} хв.#within {1} yards by {2}#Lasts {3} min", "Збільшує силу атаки ближнього бою на {1}.#power by {1}" }, -- Battle Shout (Rank 1)
...
-- Berserk
[23397] = { "Берсерк", nil, "Змушує вас прийняти стійку берсерка.\nЗбільшує отриману шкоду на {1}%.#by {1}" }, -- Berserk
-- Berserker Rage
[18499] = { "Лють берсерка", "Впадаючи в лють берсерка, воїн стає невразливим до ефектів страху та недієздатності і отримує додаткову лють при отриманні шкоди. Триває {1} с.#Lasts {1} sec", "Невразливість до ефектів страху та недієздатності. Отримує додаткову лють при отриманні шкоди." }, -- Berserker Rage
-- Blood Craze
[16487] = { "Криваве божевілля", "Відновлює {1}% здоров'я протягом {2} с після отримання критичного удару.#Regenerates {1}#over {2} sec" }, -- Blood Craze (Rank 1)
[16488] = { "Криваве божевілля", nil, "Відновлює {1}% здоров'я протягом {2} с.#Regenerates {1}#over {2} sec" }, -- Blood Craze
...
-- Bloodrage
[2687] = { "Кривава лють", "Надає {1} люті ціною здоров'я та ще додатково {2} люті протягом {3} с. Поки діє ефект, вважається, що воїн перебуває в бою.#Generates {1} rage#additional {2} rage over {3} sec" }, -- Bloodrage
[29131] = { "Кривава лють", nil, "Додає {1} люті щосекунди.#Generating {1}" }, -- Bloodrage
-- Bloodthirst
...
-- Challenging Shout
[1161] = { "Провокуючий клич", "Змушує всіх ворогів навколо атакувати вас протягом {1} с.#for {1} sec", "Спровоковано." }, -- Challenging Shout
-- Charge
...
[22911] = { "Ривок", "Ривок у ворога, що завдає звичайної шкоди плюс {1} та приголомшує ціль на {2} с.#plus {1} and#for {2} sec" }, -- Charge
...
-- Concussion Blow
[12809] = { "Приголомшливий удар", "Приголомшує ворога на {1} с.#for {1} sec", "Приголомшено." }, -- Concussion Blow
-- Cruelty
[12320] = { "Жорстокість", "Збільшує ймовірність завдати критичного удару зброєю ближнього бою на {1}%.#weapons by {1}" }, -- Cruelty (Rank 1)
...
-- Deep Wound
[12721] = { "Глибока рана", nil, "Стікає кров'ю." }, -- Deep Wound
-- Deep Wounds
...
-- Demoralizing Roar
[10968] = { "Деморалізуючий рев", "Зменшує силу атаки ближнього бою ворогів поблизу на {1} протягом {2} с.#enemies by {1} for {2} sec", "Силу атаки ближнього бою зменшено на {1}.#by {1}" }, -- Demoralizing Roar
...
-- Demoralizing Shout
[1160] = { "Деморалізуючий клич", "Зменшує силу атаки ближнього бою всіх ворогів в межах {1} м на {2} протягом {3} с.#within {1} yards by {2} for {3} sec", "Зменшує силу атаки ближнього бою на {1}.#power by {1}" }, -- Demoralizing Shout (Rank 1)
...
[19778] = { "Деморалізуючий клич", "Зменшує силу атаки ближнього та дальнього бою ворогів поблизу на {1} протягом {2} с.#enemies by {1} for {2} sec", "Силу атаки ближнього та дальнього бою зменшено на {1}.#by {1}" }, -- Demoralizing Shout
-- Devastate
...
[23584] = { "Спеціалізація на бою з двох рук", "Збільшує шкоду зброї в лівій руці на {1}%.#weapon by {1}%" }, -- Dual Wield Specialization (Rank 1)
...
-- Enrage
[12317] = { "Несамовитість", "Збільшує шкоду в ближньому бою на {1}% протягом {2} с, але не більше, ніж на {3} ударів, після отримання критичного удару.#{1}% melee damage#for {2} sec#{3} swings" }, -- Enrage (Rank 1)
...
-- Execute
[5308] = { "Страта", "Спроба добити пораненого ворога, заподіявши {1} шкоди і перетворивши кожну додаткову одиницю люті на {2} додаткової шкоди. Можна використати лише проти ворогів, що мають не більше {3}% здоров'я.#causing {1} damage#into {2} additional#have {3}% or less" }, -- Execute (Rank 1)
[20658] = { ref=5308 }, -- Execute (Rank 2)
[20660] = { ref=5308 }, -- Execute (Rank 3)
[20661] = { ref=5308 }, -- Execute (Rank 4)
[20662] = { ref=5308 }, -- Execute (Rank 5)
-- Flurry
[12319] = { "Шквал", "Збільшує вашу швидкість атаки на {1}% для наступних {2} ударів після того, як ви завдали критичного удару в ближньому бою.#speed by {1}#next {2} swings" }, -- Flurry (Rank 1)
[12966] = { "Шквал", nil, "Швидкість атаки збільшено на {1}%.#increased by {1}%" }, -- Flurry (Rank 1)
...
-- Hamstring
[1715] = { "Нівечення", "Калічить ворога, завдаючи {1} шкоди та сповільнюючи його рух на {2}% протягом {3} с.#causing {1} damage#movement by {2}% for {3} sec", "Рух сповільнено на {1}%.#slowed by {1}%" }, -- Hamstring (Rank 1)
[7372] = { ref=1715 }, -- Hamstring (Rank 2)
[7373] = { ref=1715 }, -- Hamstring (Rank 3)
[27584] = { ref=1715 }, -- Hamstring (Rank 3)
-- Heroic Strike
...
[20500] = { "Покращена лють берсерка", "При активації здібність \"Лють берсерка\" додає {1} люті.#generate {1} rage" }, -- Improved Berserker Rage (Rank 1)
[20501] = { ref=20500 }, -- Improved Berserker Rage (Rank 2)
-- Improved Bloodrage
[12301] = { "Покращена кривава лють", "Збільшує обсяг люті, що надається при активаці здібності \"Кривава лють\", на {1}.#ability by {1}" }, -- Improved Bloodrage (Rank 1)
[12818] = { ref=12301 }, -- Improved Bloodrage (Rank 2)
-- Improved Charge
[12285] = { "Покращений ривок", "Збільшує кількість отриманої люті від здібності \"Ривок\" на {1}.#ability by {1}" }, -- Improved Charge (Rank 1)
...
[12324] = { "Покращений деморалізуючий клич", "Посилює зниження сили атаки ближнього бою від вашої здібності \"Деморалізуючий клич\" на {1}%.#Shout by {1}%" }, -- Improved Demoralizing Shout (Rank 1)
...
-- Improved Hamstring
[12289] = { "Покращене нівечення", "Ваша здібність \"Нівечення\" з ймовірністю {1}% знерухомлює ціль на {2} с.#a {1}% chance#for {2} sec" }, -- Improved Hamstring (Rank 1)
[12668] = { ref=12289 }, -- Improved Hamstring (Rank 2)
[23694] = { "Покращене нівечення", nil, "Знерухомлено." }, -- Improved Hamstring
[23695] = { ref=12289 }, -- Improved Hamstring (Rank 3)
-- Improved Heroic Strike
[12282] = { "Покращений героїчний удар", "Зменшує витрати люті здібності \"Героїчний удар\" на {1}.#by {1} rage" }, -- Improved Heroic Strike (Rank 1)
[12663] = { ref=12282 }, -- Improved Heroic Strike (Rank 2)
[12664] = { ref=12282 }, -- Improved Heroic Strike (Rank 3)
-- Improved Intercept
[20504] = { "Покращене перехоплення", "Зменшує час відновлення здібності \"Перехоплення\" на {1} с.#ability by {1} sec" }, -- Improved Intercept (Rank 1)
[20505] = { ref=20504 }, -- Improved Intercept (Rank 2)
-- Improved Overpower
[12290] = { "Покращене здолання", "Збільшує ймовірність завдання критичного удару здібнісю \"Здолання\" на {1}%.#ability by {1}%" }, -- Improved Overpower (Rank 1)
[12963] = { ref=12290 }, -- Improved Overpower (Rank 2)
-- Improved Rend
[12286] = { "Покращений розрив", "Збільшує шкоду від кровотечі, заподіяної здібністю \"Розрив\", на {1}%.#ability by {1}%" }, -- Improved Rend (Rank 1)
[12658] = { ref=12286 }, -- Improved Rend (Rank 2)
[12659] = { ref=12286 }, -- Improved Rend (Rank 3)
-- Improved Revenge
[12797] = { "Покращена помста", "Здібність \"Помста\" з ймовірністю {1}% приголомшить ціль на {2} с.#{1}% chance#for {2} sec" }, -- Improved Revenge (Rank 1)
...
[12945] = { "Покращений блок щитом", "Дозволяє здібності \"Блок щитом\" блокувати ще одну атаку та збільшує тривалість на {1} с.#by {1} sec" }, -- Improved Shield Block (Rank 1)
...
[12862] = { "Покращене розтрощення", "Зменшує час застосування здібності \"Розтрощення\" на {1} с.#by {1} sec" }, -- Improved Slam (Rank 1)
...
[12308] = { "Покращений розкол броні", "Зменшує витрати люті здібності \"Розкол броні\" на {1}.#by {1} rage" }, -- Improved Sunder Armor (Rank 1)
[12810] = { ref=12308 }, -- Improved Sunder Armor (Rank 2)
[12811] = { ref=12308 }, -- Improved Sunder Armor (Rank 3)
-- Improved Taunt
[12302] = { "Покращена провокація", "Зменшує час відновлення здібності \"Провокація\" на {1} с.#ability by {1} sec" }, -- Improved Taunt (Rank 1)
[12765] = { ref=12302 }, -- Improved Taunt (Rank 2)
-- Improved Thunder Clap
[12287] = { "Покращений громовий удар", "Зменшує витрати люті здібності \"Громовий удар\" на {1}.#by {1} rage" }, -- Improved Thunder Clap (Rank 1)
[12665] = { ref=12287 }, -- Improved Thunder Clap (Rank 2)
[12666] = { ref=12287 }, -- Improved Thunder Clap (Rank 3)
-- Incapacitating Shout
[18328] = { "Приголомшливий клич", "Зменшує швидкість руху навколишніх ворогів на {1}% протягом {2} хв.#by {1}% for {2} min", "Швидкість руху зменшено на {1}%.#by {1}%" }, -- Incapacitating Shout
-- Intercept
...
-- Intercept Stun
[20253] = { "Приголомшення від перехоплення", nil, "Приголомшено." }, -- Intercept Stun (Rank 1)
[20614] = { ref=20253 }, -- Intercept Stun (Rank 2)
[20615] = { ref=20253 }, -- Intercept Stun (Rank 3)
-- Intimidating Roar
[16508] = { "Жахаючий рик", "Ричить на ворога, змушуючи його тремтіти від страху протягом {1} с та змушуючи їнших ворогів довкола цілі втікати від страху.#for {1} sec", "Нажахано." }, -- Intimidating Roar
-- Intimidating Shout
[5246] = { "Жахаючий клич", "Воїн кричить, змушуючи свою ціль тремтіти від страху. До {1} ворогів поблизу втікати від страху. Триває {2} с.#to {1} total#Lasts {2} sec", "Нажахано." }, -- Intimidating Shout
[20511] = { "Жахаючий клич", nil, "Тремтить від страху." }, -- Intimidating Shout
[19134] = { "Жахаючий клич", "Кричить на ворога, змушуючи його тремтіти від страху протягом {1} с та змушує всіх інших навколишніх ворогів втікати від страху.#for {1} sec", "Нажахано." }, -- Intimidating Shout
[29544] = { ref=20511 }, -- Intimidating Shout
-- Iron Will
[12300] = { "Залізна воля", "Збільшує ймовірність протистояти ефектам приголомшення та причарування на {1}%.#by an additional {1}%" }, -- Iron Will (Rank 1)
...
-- Last Stand
[12975] = { "Бій на смерть", "При активації тимчасово збільшує ваш максимальний запас здоров'я на {1}% протягом {2} с. Після закінчення ефекту додане здоров'я втрачається.#grants you {1}#for {2} sec" }, -- Last Stand
[12976] = { "Бій на смерть", nil, "Максимальний запас здоров'я збільшено на {1}%.#increased by {1}%" }, -- Last Stand
-- Mace Specialization
[12284] = { "Спеціалізація на булавах", "З ймовірністю {1}% ви приголомшите ціль на {2} с при ударі булавою.# a {1}% chance#for {2} sec" }, -- Mace Specialization (Rank 1)
...
-- Mocking Blow
[694] = { "Глумливий удар", "Глумлива атака, що завдає {1} шкоди, спричиняє помірний рівень загрози та змушує ціль атакувати вас протягом {2} с.#causes {1} damage#for {2} sec", "Спровоковано." }, -- Mocking Blow (Rank 1)
...
-- Mortal Strike
[12294] = { "Смертельний удар", "Жорстокий удар, що завдає шкоди від зброї плюс {1} і ранить ціль, зменшуючи ефективність будь-якого зцілення на {2}% протягом {3} с.#damage plus {1}#healing by {2}% for {3} sec", "Ефективність зцілення зменшено на {1}%.#reduced by {1}%" }, -- Mortal Strike (Rank 1)
[21551] = { ref=12294 }, -- Mortal Strike (Rank 2)
[21552] = { ref=12294 }, -- Mortal Strike (Rank 3)
[21553] = { ref=12294 }, -- Mortal Strike (Rank 4)
[27580] = { ref=12294 }, -- Mortal Strike (Rank 4)
-- One-Handed Weapon Specialization
[16538] = { "Спеціалізація на одноручній зброї", "Збільшує шкоду одноручної зброї ближнього бою на {1}%.#weapons by {1}%" }, -- One-Handed Weapon Specialization (Rank 1)
...
-- Piercing Howl
[12323] = { "Пронизливе виття", "Паморочить всіх ворогів навколо, зменшуючи їхню швидкість руху на {1}% протягом {2} с.#by {1}% for {2} sec", "Швидкість руху зменшено на {1}%.#reduced by {1}%" }, -- Piercing Howl
[23600] = { "Пронизливе виття", "Паморочить всіх ворогів навколо воїна на {1} с.#for {1} sec", "Запаморочення." }, -- Piercing Howl
-- Piercing Shriek
[26379] = { "Пронизливий вереск", "Паморочить всіх ворогів навколо на {1} с.#for {1} sec", "Запаморочення." }, -- Piercing Shriek
-- Polearm Specialization
[12165] = { "Спеціалізація на держаковій зброї", "Збільшує ймовірність завдання критичного удару держаковою зброєю на {1}%.#Polearms by {1}%" }, -- Polearm Specialization (Rank 1)
...
-- Retaliation
[20230] = { "Відплата", "Миттєво контратакує будь-якого ворога, що завдає вам удару в ближньому бою протягом {1} с. Атаки ближнього бою зі спини неможливо контратакувати. Ця здібність спричинить не більше {2} контратак.#for {1} sec#{2} attacks", "Контратакує всі атаки ближнього бою." }, -- Retaliation
-- Revenge
[6572] = { "Помста", "Миттєва контратака, що завдає від {1} до {2} шкоди та значно збільшує рівень загрози. Помста повинна слідувати за блокуванням, ухиленням або парируванням.#for {1} to {2} damage" }, -- Revenge (Rank 1)
...
-- Shield Block
[2565] = { "Блок щитом", "Збільшує ймовірність блокування щитом на {1}% протягом {2} с, але блокує лише [{1} атаку#block {1} attack.][{1} атаки#block {1} attacks.].#block by {1}% for {2} sec", "Ймовірність блокування збільшено на {1}% для наступної атаки.#increased by {1}%" }, -- Shield Block
-- Shield Slam
[23922] = { "Трощення щитом", "Трощить ціль щитом, завдаючи від {1} до {2} шкоди, залежно від вашого показника блоку щитом, та з ймовірністю {3}% розвіює 1 магічний ефект на цілі. Також спричиняє великий рівень загрози.[\n\nУраження цілі \"Трощенням щитом\" також збільшує вашу силу атаки на {1} за кожну одиницю вашої навички захисту понад {2}. Триває {3} секунд.#grants you {1} Attack Power for each point of your defense skill beyond {2}. Lasts {3} sec]#causing {1} to {2} damage#a {3}% chance" }, -- Shield Slam (Rank 1)
[23923] = { ref=23922 }, -- Shield Slam (Rank 2)
[23924] = { ref=23922 }, -- Shield Slam (Rank 3)
[23925] = { ref=23922 }, -- Shield Slam (Rank 4)
-- Shield Specialization
[12298] = { "Спеціалізація на щитах", "Збільшує ймовірність блокуваня атак щитом на {1}% і з ймовірністю {2}% додає {3} люті при блокуванні.#shield by {1}% and has a {2}% chance to generate {3} rage" }, -- Shield Specialization (Rank 1)
...
-- Shield Wall
[871] = { "Стіна щитів", "Зменшує отриману шкоду від атак ближнього бою, дальнього бою та заклять на {1}% протягом {2} с.#by {1}% for {2} sec", "Отриману шкоду зменшено на {1}%.#reduced by {1}%" }, -- Shield Wall
-- Slam
...
-- Sunder Armor
[7386] = { "Розкол броні", "Розколює броню цілі, зменшуючи її на {1} за кожен ефект \"Розколу броні\", та спричиняє високий рівень загрози. Ефект накопичується до {2} разів. Триває {3} с.#reducing it by {1} per#up to {2} times#Lasts {3} sec", "Броню зменшено на {1}.#decreased by {1}" }, -- Sunder Armor (Rank 1)
...
-- Sweeping Strikes
[12292] = { "Розлогі удари", "Наступні {1} атак ближнього бою вражають ще одного ворога неподалік.#next {1} melee", "Наступні {1} атак ближнього бою вражають ще одного ворога неподалік.#next {1} melee" }, -- Sweeping Strikes
-- Sword Specialization
[12281] = { "Спеціалізація на мечах", "З ймовірністю {1}% ви проведете додаткову атаку по тій самій цілі після завдання шкоди мечем.#a {1}% chance" }, -- Sword Specialization (Rank 1)
...
-- Taunt
[355] = { "Провокація", "Провокує ціль атакувати вас, але не діє, якщо ціль вже атакує вас." }, -- Taunt
-- Thunder Clap
[6343] = { "Громовий удар", "Вражає ворогів неподалік, збільшуючи інтервал між їхніми атаками на {1}% протягом {2} с та завдаючи їм {3} шкоди. Подіє не більше ніж на {4} цілі.#attacks by {1}% for {2} sec and doing {3} damage#up to {4} targets", "Інтервал між атаками збільшено на {1}%.#increased by {1}%" }, -- Thunder Clap (Rank 1)
[8198] = { "Громовий удар", "Вражає ворогів неподалік, збільшуючи інтервал між їхніми атаками на {1}% протягом {2} с та завдаючи їм {3} шкоди. Подіє не більше ніж на {4} цілі.#attacks by {1}% for {2} sec and doing {3} damage#up to {4} targets", "Інтервал між атаками збільшено на {1}%.#increased by {1}%" }, -- Thunder Clap (Rank 2)
[8204] = { ref=8198 }, -- Thunder Clap (Rank 3)
[8205] = { ref=8198 }, -- Thunder Clap (Rank 4)
[11580] = { ref=8198 }, -- Thunder Clap (Rank 5)
[11581] = { ref=8198 }, -- Thunder Clap (Rank 6)
[13532] = { nil, "Вражає ворогів поруч громом, збільшуючи інтервал між їхніми атаками на {1}% на {2} с та завдаючи їм {3} шкоди від природи. Подіє не більше ніж на {4} цілі.#attacks by {1}% for {2} sec and doing {3} Nature damage#up to {4} targets", ref=6343 }, -- Thunder Clap (Rank 1)
-- Toughness
...
[12163] = { "Спеціалізація на дворучній зброї", "Збільшує шкоду дворучної зброї ближнього бою на {1}%.#weapons by {1}%" }, -- Two-Handed Weapon Specialization (Rank 1)
...
-- Unbridled Wrath
[12322] = { "Нестримний гнів", "З ймовірністю {1}% ви отримаєте додаткову одиницю люті при завданні шкоди зброєю ближнього бою.#a {1}% chance" }, -- Unbridled Wrath (Rank 1)
...
-- Whirlwind
[1680] = { "Вихор", "Ви атакуєте до {1} ворогів в межах {2} м сталевим вихром, завдаючи шкоди зброєю кожному ворогу.#up to {1} enemies within {2} yards" }, -- Whirlwind
...
[2458] = { "Стійка берсерка", "Агресивна стійка. Збільшує ймовірність завдання критичного удару на {1}%, а всю отриману шкоду на {2}%.#chance is increased by {1}#taken is increased by {2}" }, -- Berserker Stance
[71] = { "Захисна стійка", "Захисна стійка. Зменшує отриману шкоду на {1}%, а заподіяну на {2}%. Збільшує загрозу.#taken by {1}#caused by {2}" }, -- Defensive Stance
