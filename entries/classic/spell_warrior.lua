...
-- Battle Shout
[5242] = { "Бойовий клич", "Воїн кричить, збільшуючи силу атаки ближнього бою всіх учасників групи в межах {1} м на {2}. Триває {3} хв.#within {1} yards by {2}#Lasts {3} min", "Збільшує силу атаки ближнього бою на {1}.#power by {1}", en="Battle Shout" },
[6192] = { ref=5242 }, -- Battle Shout
[6673] = { ref=5242 }, -- Battle Shout
[11549] = { ref=5242 }, -- Battle Shout
[11550] = { ref=5242 }, -- Battle Shout
[11551] = { ref=5242 }, -- Battle Shout
[25289] = { ref=5242 }, -- Battle Shout
-- Berserk
...
-- Blood Craze
[16487] = { "Манія крові", "Відновлює {1}% здоров'я протягом {2} с після отримання критичного удару.#Regenerates {1}#over {2} sec", en="Blood Craze" },
[16488] = { "Манія крові", nil, "Відновлює {1}% здоров'я протягом {2} с.#Regenerates {1}%#over {2} sec", en="Blood Craze" },
...
[23885] = { "Кровожерливість", nil, "Успішні атаки ближнього бою відновлюють {1} здоров'я.#restore {1} health", en="Bloodthirst" },
...
-- Cleave
[845] = { "Розсічення", "Розмашиста атака, що завдає шкоди зброєю плюс {1} по цілі та по найближчому до неї ворогу.#damage plus {1} to", en="Cleave" },
[7369] = { ref=845 }, -- Cleave
...
-- Deep Wound
[12721] = { "Глибокі рани", nil, "Стікає кров'ю.", en="Deep Wound" },
-- Deep Wounds
[12162] = { "Глибокі рани", en="Deep Wounds" },
...
-- Demoralizing Roar
[10968] = { "Деморалізуючий рев", "Зменшує силу атаки ближнього бою навколишніх ворогів на {1} протягом {2} с.#enemies by {1} for {2} sec", "Силу атаки ближнього бою зменшено на {1}.#by {1}", en="Demoralizing Roar" },
...
[13730] = { "Деморалізуючий клич", "Зменшує силу атаки ближнього бою ворогів поблизу на {1} протягом {2} с.#enemies by {1} for {2} sec", "Силу атаки ближнього бою зменшено на {1}.#by {1}", en="Demoralizing Shout" },
[16244] = { ref=13730 }, -- Demoralizing Shout
...
-- Execute
[5283] = { "Страта", en="Execute" },
[5308] = { "Страта", "Спроба добити пораненого ворога, завдаючи {1} шкоди і додатково {2} шкоди за кожну надлишкову одиницю люті. Можна використати лише проти ворогів, що мають не більше {3}% здоров'я.#causing {1} damage#into {2} additional#have {3}% or less", en="Execute" },
...
-- Hamstring
[1715] = { "Нівечення", "Калічить ворога, завдаючи {1} шкоди та зменшуючи швидкість руху на {2}% протягом {3} с.#causing {1} damage#movement by {2}% for {3} sec", "Швидкість руху зменшено на {1}%.#by {1}%", en="Hamstring" },
[7372] = { ref=1715 }, -- Hamstring
[7373] = { ref=1715 }, -- Hamstring
[27584] = { ref=1715 }, -- Hamstring
-- Heroic Strike
[78] = { "Героїчний удар", "Сильна атака, що збільшує шкоду ближнього бою на {1} і спричиняє високий рівень загрози.#damage by {1}", en="Heroic Strike" },
...
-- Impale
[16493] = { "Пронизування", "Збільшує додаткову шкоду від критичних ударів ваших здібностей на {1}% у бойовій, оборонній та стійці берсерка.#stance by {1}%", en="Impale" },
...
-- Improved Bloodrage
[12301] = { "Покращена кривава лють", "Збільшує обсяг люті, що надається при активації \"Кривавої люті\" на {1}.#ability by {1}", en="Improved Bloodrage" },
...
-- Improved Revenge
[12797] = { "Покращена помста", "\"Помста\" з ймовірністю {1}% приголомшить ціль на {2} с.#{1}% chance#for {2} sec", en="Improved Revenge" },
...
[20497] = { ref=12330 }, -- Improved Slam
[20498] = { ref=12330 }, -- Improved Slam
[20499] = { ref=12330 }, -- Improved Slam
...
[6554] = { "Луснути", "Лупить ціль, завдаючи {1} шкоди. Перериває вимову закляття та унеможливлює вимову заклять тієї ж школи протягом {2} с.#for {1} damage#for {2} sec", en="Pummel" },
-- Recklessness
[1719] = { "Навіженість", "[Воїн буде завдавати критичних ударів більшістю своїх атак та#cause critical hits with most attacks][Ймовірність критичного удару збільшиться на {1}%, а воїн#will gain {1}% increased critical strike chance] отримає невразливість до ефектів страху протягом {1} с, але отримана шкода збільшиться на {2}%.#next {1} sec#increased by {2}", "Невразливість до ефектів страху, більшість атак завдають критичних ударів[, але отриману шкоду збільшено на {1}%#damage taken is increased by {1}%].", en="Recklessness" },
...
[18498] = { "Удар щитом - Знемовлення", nil, "Знемовлено.", en="Shield Bash - Silenced" },
-- Shield Block
...
[11605] = { ref=1464 }, -- Slam
-- Spell Reflection
[23920] = { "Відбиття заклинань", "Підняти щит, щоб відбити наступне закляття, вимовлене проти вас. Триває {1} с.#Lasts {1} sec", "Відбиває наступне направлене на вас закляття.", en="Spell Reflection" },
-- Sunder Armor
...
[13532] = { "Громовий удар", "Вражає ворогів неподалік, збільшуючи інтервал між їхніми атаками на {1}% на {2} с та завдаючи їм {3} шкоди від природи. Подіє не більше ніж на {4} цілі.#attacks by {1}% for {2} sec and doing {3} Nature damage#up to {4} targets", "Інтервал між атаками збільшено на {1}%.#increased by {1}%", ref=6343, en="Thunder Clap" },
-- Toughness
...
-- Item sets
[22738] = { "Зменшення часу відновлення Перехоплення", "Зменшує час відновлення \"Перехоплення\" на {1} с.#Intercept ability by {1} sec", en="Intercept Cooldown Reduction" },
