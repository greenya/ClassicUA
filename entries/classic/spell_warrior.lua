...
[16488] = { "Манія крові", nil, "Відновлює {1}% загального здоров'я протягом {2} с.#Regenerates {1}#over {2} sec" }, -- Blood Craze
...
-- Challenging Shout
[1161] = { "Провокуючий клич", "Змушує всіх ворогів навколо атакувати вас впродовж {1} с.#for {1} sec", "Підбурено." }, -- Challenging Shout
-- Charge
...
[23584] = { "Спеціалізація на бою з двох рук", "Збільшує пошкодження, заподіяне вашою зброєю в лівій руці, на {1}%.#weapon by {1}" }, -- Dual Wield Specialization (Rank 1)
...
[12880] = { "Сказ", nil, "Пошкодження в ближньому бою збільшено на {1}%.#increased by {1}" }, -- Enrage (Rank 1)
...
[12976] = { "Останній бій", nil, "Здоров'я збільшено на {1}% від максимального значення.#increased by {1}" }, -- Last Stand
-- Mace Specialization
