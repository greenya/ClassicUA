...
-- Mocking Blow
[694] = { "Глумливий удар", "Глумлива атака, що завдає {1} шкоди, спричиняє помірний рівень загрози та змушує ціль атакувати вас протягом {2} с.#causes {1} damage#for {2} sec", "Підбурено." }, -- Mocking Blow (Rank 1)
...
-- Piercing Howl
[12323] = { "Пронизливе виття", "Паморочить всіх ворогів навколо, зменшуючи їхню швидкість руху на {1}% протягом {2} с.#by {1}% for {2} sec", "Рух сповільнено на {1}%.#reduced by {1}%" }, -- Piercing Howl
...
-- Sunder Armor
[7386] = { "Розкол броні", "Розколює броню цілі, зменшуючи її на {1} за кожен ефект \"Розколу броні\", та спричиняє високий рівень загрози. Ефект накопичується до {2} разів. Триває {3} с.#reducing it by {1}#up to {2} times#Lasts {3} sec", "Броню зменшено на {1}.#decreased by {1}" }, -- Sunder Armor (Rank 1)
