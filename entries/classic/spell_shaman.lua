...
-- Elemental Warding
[28996] = { "Оберіг стихій", "Зменшує пошкодження від ефектів вогню, криги та природи на {1}%.#by {1}" }, -- Elemental Warding (Rank 1)
...
[16261] = { "Покращений блискавичний щит", "Збільшує пошкодження від кульових блискавок вашого закляття \"Блискавичний щит\" на {1}%.#by {1}" }, -- Improved Lightning Shield (Rank 1)
