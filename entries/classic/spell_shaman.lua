...
-- Clearcasting
[16246] = { "Ясномова", nil, "Ваше наступне стихійне закляття пошкодження має зменшені витрати мани на {1}%.#by {1}" }, -- Clearcasting
-- Concussion
...
[16257] = { "Шквал", nil, "Швидкість атаки підвищено на {1}%.#by {1}" }, -- Flurry (Rank 1)
...
-- Stoneskin
[8072] = { "Кам'яна шкіра", nil, "Знижує отримуване пошкодження в ближньому бою на {1}.#by {1}" }, -- Stoneskin (Rank 1)
...
-- Stormstrike
[17364] = { "Штормовий удар", "Дає вам додаткову атаку. Окрім цього, наступні два джерела пошкодження природою по цілі посилені на {1}%. Триває {2} с.#increased by {1}#{2} sec", "Отримане пошкодження природою збільшене на {1}%.#by {1}" }, -- Stormstrike (Rank 1)
-- Strength of Earth
