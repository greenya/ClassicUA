...
-- Stormstrike
[17364] = { "Штормовий удар", "Дає вам додаткову атаку.[ Окрім того, наступні два ураження цілі шкодою від природи посилені на {1}%.#next 2 sources of Nature damage dealt to the target are increased by {1}%.][ Триває {1} с.#Lasts {1} sec][ Окрім того, ціль отримуватиме на {1}% більше шкоди від природи протягом {2} с.#Nature damage dealt to the target is increased by {1}% for {2} sec]", "Отриману шкоду від природи збільшено на {1}%.#by {1}%", en="Stormstrike" },
-- Strength of Earth
