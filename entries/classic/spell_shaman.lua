...
-- Stormstrike
[17364] = { "Штормовий удар", "Дає вам додаткову атаку. Окрім цього, наступні два джерела пошкодження природою по цілі посилені на {1}%. Триває {2} с.#increased by {1}#{2} sec", "Отримане пошкодження природою збільшене на {1}%.#by {1}" }, -- Stormstrike
