...
-- Ancestral Fortitude
[16177] = { "Стійкість пращурів", nil, "Збільшує броню від предметів на {1}%.#by {1}%" }, -- Ancestral Fortitude (Rank 1)
[16236] = { ref=16177 }, -- Ancestral Fortitude (Rank 2)
[16237] = { ref=16177 }, -- Ancestral Fortitude (Rank 3)
-- Ancestral Healing
[16176] = { "Зцілення пращурів", "Збільшує броню вашої цілі на {1}% протягом {2} с після отримання критичного ефекту ваших цілющих заклять.#by {1}% for {2} sec" }, -- Ancestral Healing (Rank 1)
[16235] = { ref=16176 }, -- Ancestral Healing (Rank 2)
[16240] = { ref=16176 }, -- Ancestral Healing (Rank 3)
-- Ancestral Knowledge
[17485] = { "Знання пращурів", "Збільшує ваш максимальний запас мани на {1}%.#by {1}%" }, -- Ancestral Knowledge (Rank 1)
...
-- Ancestral Spirit
[2008] = { "Дух пращурів", "Повертає дух до тіла, відроджуючи ціль з {1} здоров'я та {2} мани. Не можна використовувати в бою.#{1} health and {2} mana" }, -- Ancestral Spirit (Rank 1)
...
-- Anticipation
[16254] = { "Передчуття", "Збільшує вашу ймовірність ухилення на {1}%.#additional {1}%" }, -- Anticipation (Rank 1)
...
-- Call of Thunder
[16041] = { "Поклик грому", "Збільшує ймовірність критичного удару заклять \"Блискавка\" та \"Ланцюгова блискавка\" на {1}%.#additional {1}%" }, -- Call of Thunder (Rank 1)
...
-- Clearcasting
[16246] = { "Ясномова", nil, "Ваше наступне стихійне бойове закляття витратить на {1}% менше мани.#by {1}%" }, -- Clearcasting
-- Concussion
...
-- Convection
[16039] = { "Конвекція", "Зменшує витрати мани заклять \"Блискавка\", \"Ланцюгова блискавка\" та заклять-шоків на {1}%.#by {1}%" }, -- Convection (Rank 1)
...
[8170] = { "Тотем очищення хвороб", "Викликає тотем очищення хвороб із {1} здоров'я біля заклинача. Тотем буде намагатися зняти {2} ефект хвороби з учасників групи в межах {3} м кожні {4} с. Триває {5} хв.#with {1} health#remove {2}#within {3} yards every {4} sec#Lasts {5} min" }, -- Disease Cleansing Totem
-- Dual Wield
[30798] = { "Бій з двох рук", "Дозволяє брати в ліву руку зброю для однієї руки або зброю для лівої руки." }, -- Dual Wield
-- Earth Shock
[8042] = { "Земний шок", "Миттєво вражає ціль ударною хвилею, завдаючи від {1} до {2} шкоди від природи. Також перериває вимову закляття та унеможливлює вимову будь-яких інших заклять тієї ж школи магії протягом {3} с. Спричиняє високий рівень загрози.#causing {1} to {2}#for {3} sec" }, -- Earth Shock (Rank 1)
...
[30160] = { "Стихійне спустошення", "Критичні удари ваших бойових заклять збільшують ймовірність завдання критичного удару атаками ближнього бою на {1}% протягом {2} с.#by {1}% for {2} sec" }, -- Elemental Devastation (Rank 1)
[30165] = { "Стихійне спустошення", nil, "Збільшує ймовірність завдати критичного удару атаками ближнього бою на {1}%.#by {1}%" }, -- Elemental Devastation (Rank 1)
-- Elemental Focus
[16164] = { "Стихійна зосередженість", "Після вимови будь-якого бойового закляття вогню, криги чи природи ви з ймовірністю {1}% отримаєте ефект \"Ясномова\". \"Ясномова\" зменшує витрати мани вашого наступного бойового закляття на {2}%.#a {1}% chance#spell by {2}%" }, -- Elemental Focus
-- Elemental Fury
...
-- Elemental Warding
[28996] = { "Оберіг стихій", "Зменшує отриману шкоду від ефектів вогню, криги та природи на {1}%.#by {1}%" }, -- Elemental Warding (Rank 1)
[28997] = { ref=28996 }, -- Elemental Warding (Rank 2)
[28998] = { ref=28996 }, -- Elemental Warding (Rank 3)
-- Elemental Weapons
[16266] = { "Зброя стихій", "Збільшує бонус сили атаки ближнього бою від \"Зброї каменолома\" на {1}%, ефект \"Зброї буревію\" на {2}% та шкоду \"Зброї язика полум'я\" та \"Зброї крижаного тавра\" на {3}%.#Rockbiter Weapon by {1}#effect by {2}#Frostbrand Weapon by {3}" }, -- Elemental Weapons (Rank 1)
[29079] = { ref=16266 }, -- Elemental Weapons (Rank 2)
[29080] = { ref=16266 }, -- Elemental Weapons (Rank 3)
-- Enhancing Totems
[16259] = { "Покращення тотемів", "Посилює ефекти ваших тотемів сили землі та поваби вітру на {1}%.#by {1}%" }, -- Enhancing Totems (Rank 1)
[16295] = { ref=16259 }, -- Enhancing Totems (Rank 2)
-- Eye of the Storm
[29062] = { "Око бурі", "Після отримання критичного удару в ближньому чи дальньому бою ви з ймовірністю {1}% отримаєте ефект \"Зосередженої вимови\" на {2} с. \"Зосереджена вимова\" оберігає вас від затримки вимови заклять при отриманні шкоди.#a {1}% chance#for {2} sec" }, -- Eye of the Storm (Rank 1)
...
-- Fire Nova Totem
[1535] = { "Тотем вогненного спалаху", "Викликає тотем вогненного спалаху з {1} здоров'я на {2} с. Якщо тотем не буде знищено за {3} с, він завдасть від {4} до {5} шкоди вогнем усім ворогам в межах {6} м.#has {1} health and lasts {2} sec#within {3} sec#inflicts {4} to {5}#within {6} y" }, -- Fire Nova Totem (Rank 1)
...
-- Frost Shock
[8056] = { "Крижаний шок", "Миттєво вражає ціль кригою, завдаючи від {1} до {2} шкоди кригою та сповільнюючи рух на {3}%. Триває {4} с.#causing {1} to {2}#speed by {3}%#Lasts {4} sec", "Рух сповільнено на {1}%.#by {1}%" }, -- Frost Shock (Rank 1)
...
-- Grace of Air Totem
[8835] = { "Тотем поваби вітру", "Викликає тотем поваби вітру з {1} здоров'я біля заклинача. Тотем збільшує спритність учасників групи в межах {2} м на {3}. Триває {4} хв.#with {1} health#within {2} yards by {3}#Lasts {4} min" }, -- Grace of Air Totem (Rank 1)
[10627] = { ref=8835 }, -- Grace of Air Totem (Rank 2)
[25359] = { ref=8835 }, -- Grace of Air Totem (Rank 3)
-- Grounding Totem
[8177] = { "Тотем заземлення", "Викликає тотем заземлення з {1} здоров'я біля заклинача, який перенаправлятиме на себе одне вороже бойове закляття, ціллю якого є учасник групи неподалік раз на {2} с. Не перенаправляє закляття з ураженням по області. Триває {3} с.#with {1} health#every {2} sec#Lasts {3} sec" }, -- Grounding Totem
-- Grounding Totem Effect
[8178] = { "Ефект тотему заземлення", nil, "Перенаправить одне вороже бойове закляття на тотем заземлення." }, -- Grounding Totem Effect (Rank 1)
-- Guardian Totems
[16258] = { "Вартові тотеми", "Посилює ефекти зменшення шкоди від ваших тотемів кам'яної шкіри та стіни вітру на {1}%, а також зменшує час відновлення вашого тотема заземлення на {2} с.#Windwall Totem by {1}%#Grounding Totem by {2} sec" }, -- Guardian Totems (Rank 1)
[16293] = { ref=16258 }, -- Guardian Totems (Rank 2)
-- Healing Focus
[16181] = { "Зосередженість на зціленні", "З ймовірністю {1}% ви уникнете затримки вимови цілющих заклять при отриманні шкоди.#a {1}% chance" }, -- Healing Focus (Rank 1)
...
-- Healing Wave
[331] = { "Хвиля зцілення", "Зцілює дружній цілі від {1} до {2} здоров'я.#for {1} to {2}" }, -- Healing Wave (Rank 1)
...
-- Improved Ghost Wolf
[16262] = { "Покращений примарний вовк", "Зменшує час вимови закляття \"Примарний вовк\" на {1} с.#by {1} sec" }, -- Improved Ghost Wolf (Rank 1)
[16287] = { ref=16262 }, -- Improved Ghost Wolf (Rank 2)
-- Improved Healing Wave
[16182] = { "Покращена хвиля зцілення", "Зменшує час вимови закляття \"Хвиля зцілення\" на {1} с.#by {1} sec" }, -- Improved Healing Wave (Rank 1)
...
-- Lesser Healing Wave
[8004] = { "Мала хвиля зцілення", "Зцілює дружній цілі від {1} до {2} здоров'я.#for {1} to {2}" }, -- Lesser Healing Wave (Rank 1)
...
-- Lightning Mastery
[16578] = { "Опанування блискавки", "Зменшує час вимови заклять \"Блискавка\" та \"Ланцюгова блискавка\" на {1} с.#by {1} sec" }, -- Lightning Mastery (Rank 1)
...
-- Lightning Shield
[26364] = { "Блискавковий щит", "Кидає в ціль блискавку, що завдає {1} шкоди від природи.#for {1} Nature" }, -- Lightning Shield (Rank 1)
[26365] = { ref=26363 }, -- Lightning Shield (Rank 2)
[26366] = { ref=26363 }, -- Lightning Shield (Rank 3)
[26367] = { ref=26363 }, -- Lightning Shield (Rank 4)
[26369] = { ref=26363 }, -- Lightning Shield (Rank 5)
[26370] = { ref=26363 }, -- Lightning Shield (Rank 6)
...
-- Magma Totem
[8190] = { "Тотем магми", "Викликає тотем магми з {1} здоров'я біля заклинача на {2} с, який завдає {3} шкоди вогнем усім істотам в межах {4} м кожні {5} с.#with {1} health#for {2} sec#causes {3}#within {4} yards every {5} sec" }, -- Magma Totem (Rank 1)
...
-- Nature's Guidance
[16180] = { "Сприяння природи", "Збільшує вашу ймовірність завдати удару в ближньому бою та закляттями на {1}%.#by {1}%" }, -- Nature's Guidance (Rank 1)
[16196] = { ref=16180 }, -- Nature's Guidance (Rank 2)
[16198] = { ref=16180 }, -- Nature's Guidance (Rank 3)
-- Nature's Swiftness
[16188] = { "Стрімкість природи", "При активації ваше наступне закляття природи з тривалістю вимови менше {1} с буде миттєвим.#than {1} sec", "Ваше наступне закляття природи з тривалістю вимови менше {1} с буде миттєвим.#than {1} sec" }, -- Nature's Swiftness
-- Parry
[16268] = { ref=3127 }, -- Parry
[18848] = { ref=3127 }, -- Parry (Passive)
-- Poison Cleansing Totem
[8166] = { "Тотем очищення отрут", "Викликає тотем очищення отрут із {1} здоров'я біля заклинача. Тотем буде намагатися зняти {2} ефект отрути з учасників групи в межах {3} м кожні {4} с. Триває {5} хв.#with {1} health#remove {2}#within {3} yards every {4} sec#Lasts {5} min" }, -- Poison Cleansing Totem
-- Purge
...
-- Purification
[16178] = { "Очищення", "Збільшує ефективність ваших заклять зцілення на {1}%.[ Додатково збільшує ефективність зцілення \"Бистрини\" та \"Щита землі\" на {1}%.#Earth Shield by an additional {1}%]#healing spells by {1}%" }, -- Purification (Rank 1)
...
-- Reincarnation
[20608] = { "Реінкарнація", "Дозволяє вам після смерті повернутися до життя з {1}% здоров'я та мани.#with {1}%" }, -- Reincarnation (Passive)
-- Restorative Totems
[16187] = { "Відновлювальні тотеми", "Посилює ефекти ваших тотемів джерела мани та цілющого потоку на {1}%.#by {1}%" }, -- Restorative Totems (Rank 1)
...
-- Reverberation
[16040] = { "Відлуння", "Зменшує час відновлення ваших заклять-шоків на {1} с.#by {1} sec" }, -- Reverberation (Rank 1)
...
-- Stoneskin
[8072] = { "Кам'яна шкіра", nil, "Зменшує отриману шкоду в ближньому бою на {1}.#by {1}" }, -- Stoneskin (Rank 1)
...
-- Stoneskin Totem
[8071] = { "Тотем кам'яної шкіри", "Викликає тотем кам'яної шкіри з {1} здоров'я біля заклинача. Тотем захищає учасників групи в межах {2} м, зменшуючи отриману шкоду в ближньому бою на {3}. Триває {4} хв.#with {1} health#within {2} y#taken by {3}#Lasts {4} min" }, -- Stoneskin Totem (Rank 1)
...
-- Storm Reach
[28999] = { "Досяжність бурі", "Збільшує дальність дії ваших заклять \"Блискавка\" та \"Ланцюгова блискавка\" на {1} м.#by {1} y" }, -- Storm Reach (Rank 1)
...
[8075] = { "Тотем сили землі", "Викликає тотем сили землі з {1} здоров'я біля заклинача. Тотем збільшує силу учасників групи в межах {2} м на {3}. Триває {4} хв.#with {1} health#within {2} yards by {3}#Lasts {4} min" }, -- Strength of Earth Totem (Rank 1)
...
-- Thundering Strikes
[16255] = { "Громові удари", "Збільшує ймовірність завдання критичного удару атаками зброєю на {1}%.#by {1}%" }, -- Thundering Strikes (Rank 1)
...
-- Tidal Focus
[16179] = { "Припливна зосередженість", "Зменшує витрати мани ваших заклять зцілення на {1}%.#by {1}%" }, -- Tidal Focus (Rank 1)
...
-- Tidal Mastery
[16194] = { "Опанування припливів", "Збільшує ймовірність критичного ефекту ваших заклять зцілення та блискавки на {1}%.#by {1}%" }, -- Tidal Mastery (Rank 1)
...
-- Totemic Mastery
[16189] = { "Опанування тотемів", "Радіус дії ваших тотемів, які діють на дружні цілі, збільшено до {1} м.#increased to {1} y" }, -- Totemic Mastery
-- Toughness
[16252] = { "Міць", "Збільшує броню від предметів на {1}%.#items by {1}%" }, -- Toughness (Rank 1)
...
-- Tremor Totem
[8143] = { "Тотем тремтіння", "Викликає тотем тремтіння з {1} здоров'я біля заклинача. Тотем здригає землю навколо, знімаючи ефекти страху, причарування та сну з учасників групи в межах {2} м. Триває {3} хв.#with {1} health#within {2} y#Lasts {3} min" }, -- Tremor Totem
...
-- Water Breathing
[131] = { "Водне дихання", "Дозволяє цілі дихати під водою протягом {1} хв.#for {1} min", "Водне дихання." }, -- Water Breathing
-- Water Walking
...
-- Weapon Mastery
[29082] = { "Опанування зброї", "Збільшує шкоду зброї на {1}%.#by {1}%" }, -- Weapon Mastery (Rank 1)
...
-- Windfury Weapon
[8232] = { "Зброя буревію", "Підсилює зброю шамана вітром. Кожен удар з ймовірністю {1}% спричиняє {2} додаткові атаки зі збільшеною на {3} силою атаки ближнього бою. Триває {4} хв.#{1}% chance#{2} extra attacks with {3}#Lasts for {4} min" }, -- Windfury Weapon (Rank 1)
