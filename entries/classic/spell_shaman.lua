...
-- Anticipation
[16254] = { "Передчуття", "Збільшує ваш шанс ухилення на додаткові {1}%.#additional {1}" }, -- Anticipation (Rank 1)
...
[29206] = { "Шлях зцілення", "Ваше закляття \"Хвиля зцілення\" з імовірністю {1}% підсилить повторний ефект цього ж закляття на ту саму ціль на {2}% на {3} с. Ефект накопичується до {4} разів.#{1}% chance#by {2}% for {3} sec#up to {4} times" }, -- Healing Way (Rank 1)
...
-- Lightning Shield
[26364] = { "Блискавичний щит", "Кидає в ціль блискавку, що завдає {1} шкоди від природи.#for {1} Nature" }, -- Lightning Shield (Rank 1)
