...
-- Chain Heal
[1064] = { "Ланцюгове зцілення", "Зцілює дружній цілі від {1} до {2} здоров'я та перестрибує на інші цілі неподалік. Якщо закляття було націлене на учасника групи, подальші стрибки переходитимуть лише на інших її учасників. Кожен наступний стрибок зцілює на {3}% менше здоров'я. Зцілює до {4} цілей.#for {1} to {2}#{3}% as effective#Heals {4} total", en="Chain Heal" },
[10622] = { ref=1064 }, -- Chain Heal
[10623] = { ref=1064 }, -- Chain Heal
-- Chain Lightning
[421] = { "Ланцюгова блискавка", "Кидає в ціль блискавку, що завдає від {1} до {2} шкоди від природи та перестрибує на інших ворогів неподалік. Кожен стрибок завдає на {3}% менше шкоди. Вражає до {4} цілей.#dealing {1} to {2}#damage by {3}#{4} total targets.", en="Chain Lightning" },
...
-- Corrupted Totems
[23424] = { "Осквернені тотеми", en="Corrupted Totems" },
...
-- Cure Poison
[526] = { "Лікування отрути", "Виліковує {1} ефект отрути з цілі.#Cures {1} poison", en="Cure Poison" },
-- Disease Cleansing Totem
[8170] = { "Тотем очищення хвороб", "Викликає тотем очищення хвороб із {1} здоров'я. Тотем буде намагатися зняти {2} ефект хвороби з учасників групи в межах {3} м кожні {4} с. Триває {5} хв.#with {1} health#remove {2}#within {3} yards every {4} sec#Lasts {5} min", en="Disease Cleansing Totem" },
-- Dual Wield
[30798] = { "Бій з двох рук", "Дозволяє брати в ліву руку одноручну зброю або зброю для лівої руки.", en="Dual Wield" },
-- Earth Shock
...
-- Earthbind Totem
[2484] = { "Тотем земного зв'язування", "Викликає тотем земного зв'язування з {1} здоров'я на {2} с. Тотем сповільнює рух ворогів в межах {3} м.#with {1} health#for {2} sec#within {3} y", en="Earthbind Totem" },
-- Elemental Devastation
[29177] = { "Стихійне спустошення", nil, "Збільшує ймовірність завдати критичного удару атаками ближнього бою на {1}%.#by {1}%", en="Elemental Devastation" },
[29178] = { ref=29177 }, -- Elemental Devastation
[29179] = { "Стихійне спустошення", "Критичні удари ваших бойових заклять збільшують ймовірність завдання критичного удару атаками ближнього бою на {1}% протягом {2} с.#by {1}% for {2} sec", en="Elemental Devastation" },
...
[8184] = { "Тотем опору вогню", "Викликає тотем опору вогню з {1} здоров'я на {2} хв, який збільшує опір вогню учасників групи в межах {3} м на {4}.#with {1} health#for {2} min#within {3} yards by {4}", en="Fire Resistance Totem" },
...
-- Focused Mind
[30864] = { "Зосереджений розум", "Збільшує ймовірність опору ефектам знемовлення та переривання на {1}%.#by an additional {1}%", en="Focused Mind" },
...
[8181] = { "Тотем опору кризі", "Викликає тотем опору кризі з {1} здоров'я на {2} хв, який збільшує опір кризі учасників групи в межах {4} м на {3}.#with {1} health#for {2} min#resistance by {3}#within {4} y", en="Frost Resistance Totem" },
...
-- Ghost Wolf
[2645] = { "Примарний вовк", "Перетворює шамана на примарного вовка, збільшуючи швидкість руху на {1}%. Можна використовувати лише просто неба.#speed by {1}%", "Збільшує швидкість руху на {1}%.#by {1}%", en="Ghost Wolf" },
-- Grace of Air
...
-- Grace of Air Totem
[8835] = { "Тотем поваби вітру", "Викликає тотем поваби вітру з {1} здоров'я. Тотем збільшує спритність учасників групи в межах {2} м на {3}. Триває {4} хв.#with {1} health#within {2} yards by {3}#Lasts {4} min", en="Grace of Air Totem" },
[10627] = { ref=8835 }, -- Grace of Air Totem
[25359] = { ref=8835 }, -- Grace of Air Totem
-- Grounding Totem
[8177] = { "Тотем заземлення", "Викликає тотем заземлення з {1} здоров'я, який спрямовує на себе одне вороже бойове закляття, застосоване на учасника групи неподалік, раз на {2} с. Не перенаправляє закляття з ураженням по області. Триває {3} с.#with {1} health#every {2} sec#Lasts {3} sec", en="Grounding Totem" },
-- Grounding Totem Effect
[8178] = { "Ефект тотему заземлення", nil, "Спрямує одне вороже бойове закляття на тотем заземлення.", en="Grounding Totem Effect" },
-- Guardian Totems
...
[5394] = { "Тотем цілющого потоку", "Викликає тотем цілющого потоку з {1} здоров'я на {2} хв. Тотем зцілює учасникам групи в межах {3} м {4} здоров'я кожні {5} с.#with {1} health#for {2} min#within {3} yards for {4} every {5} sec", en="Healing Stream Totem" },
...
-- Healing Way
[29202] = { "Шлях зцілення", "Закляття \"Хвиля зцілення\" з імовірністю {1}% підсилить повторні ефекти цього закляття на ту саму ціль на {2}% протягом {3} с. Ефект накопичується до {4} разів.#a {1}% chance#by {2}% for {3} sec#up to {4} times", en="Healing Way" },
...
[26363] = { "Блискавковий щит", "Кидає в ціль блискавку, що завдає {1} шкоди від природи.#for {1} Nature", en="Lightning Shield" },
[26364] = { ref=26363 }, -- Lightning Shield
...
-- Mana Spring Totem
[5675] = { "Тотем джерела мани", "Викликає тотем джерела мани з {1} здоров'я на {2} хв. Тотем відновлює {3} мани кожні {4} с учасникам групи в межах {5} м.#with {1} health#for {2} min#{3} mana every {4} sec#within {5} y", en="Mana Spring Totem" },
...
-- Mana Tide Totem
[16190] = { "Тотем припливу мани", "Викликає тотем припливу мани з {1} здоров'я на {2} с. Тотем відновлює {3} мани кожні {4} с учасникам групи в межах {5} м.#with {1} health#for {2} sec#restores {3} mana every {4} sec#within {5} y", en="Mana Tide Totem" },
[17354] = { ref=16190 }, -- Mana Tide Totem
[17359] = { ref=16190 }, -- Mana Tide Totem
-- Mental Quickness
[30812] = { "Швидке мислення", "Зменшує витрати мани на миттєві закляття на {1}%.#by {1}%", en="Mental Quickness" },
...
[10595] = { "Тотем опору природі", "Викликає тотем опору природі з {1} здоров'я на {2} хв, який збільшує опір природі учасників групи в межах {3} м на {4}.#with {1} health#for {2} min#within {3} yards by {4}", en="Nature Resistance Totem" },
[10600] = { ref=10595 }, -- Nature Resistance Totem
[10601] = { ref=10595 }, -- Nature Resistance Totem
-- Nature's Blessing
[30867] = { "Благословення природи", "Збільшує шкоду та зцілення ваших заклять на {1}% від інтелекту.#equal to {1}% of your Intellect", en="Nature's Blessing" },
...
[8166] = { "Тотем очищення отрут", "Викликає тотем очищення отрут із {1} здоров'я. Тотем буде намагатися зняти {2} ефект отрути з учасників групи в межах {3} м кожні {4} с. Триває {5} хв.#with {1} health#remove {2}#within {3} yards every {4} sec#Lasts {5} min", en="Poison Cleansing Totem" },
-- Purge
...
-- Reverberation
[16040] = { "Відлуння", "Зменшує час відновлення заклять-шоків на {1} с.#by {1} sec", en="Reverberation" },
...
-- Searing Totem
[3599] = { "Тотем обпалення", "Викликає тотем обпалення з {1} здоров'я на {2} с. Тотем періодично атакує ворогів у радіусі {3} м, завдаючи від {4} до {5} шкоди вогнем.#with {1} health#for {2} sec#within {3} yards for {4} to {5} Fire", en="Searing Totem" },
...
-- Stoneclaw Totem
[5730] = { "Тотем кам'яного пазура", "Викликає тотем кам'яного пазура з {1} здоров'я на {2} с. Тотем провокує істот в межах {3} м атакувати його.#with {1} health#for {2} sec#within {3} y", en="Stoneclaw Totem" },
...
-- Stoneskin Totem
[8071] = { "Тотем кам'яної шкіри", "Викликає тотем кам'яної шкіри з {1} здоров'я. Тотем захищає учасників групи в межах {2} м, зменшуючи отриману шкоду в ближньому бою на {3}. Триває {4} хв.#with {1} health#within {2} y#taken by {3}#Lasts {4} min", en="Stoneskin Totem" },
...
-- Stormstrike
[17364] = { "Штормовий удар", "Дає вам додаткову атаку.[ Окрім того, наступні {1} ураження цілі шкодою від природи посилені на {2}%.#next {1} sources of Nature damage dealt to the target are increased by {2}%.][ Триває {1} с.#Lasts {1} sec][ Окрім того, ціль отримуватиме на {1}% більше шкоди від природи протягом {2} с.#Nature damage dealt to the target is increased by {1}% for {2} sec]", "Отриману шкоду від природи збільшено на {1}%.#by {1}%", en="Stormstrike" },
-- Strength of Earth
...
[8075] = { "Тотем сили землі", "Викликає тотем сили землі з {1} здоров'я. Тотем збільшує силу учасників групи в межах {2} м на {3}. Триває {4} хв.#with {1} health#within {2} yards by {3}#Lasts {4} min", en="Strength of Earth Totem" },
...
-- Tranquil Air Totem
[25908] = { "Тотем затишшя", "Викликає тотем затишшя з {1} здоров'я. Тотем зменшує загрозу всіх учасників групи в межах {2} м на {3}%. Триває {4} хв.#with {1} health#within {2} yards by {3}#Lasts {4} min", en="Tranquil Air Totem" },
-- Tremor Totem
[8143] = { "Тотем тремтіння", "Викликає тотем тремтіння з {1} здоров'я. Тотем здригає землю навколо, знімаючи ефекти страху, причарування та сну з учасників групи в межах {2} м. Триває {3} хв.#with {1} health#within {2} y#Lasts {3} min", en="Tremor Totem" },
...
-- Unleashed Rage
[30802] = { "Нестримна лють", "Ваші критичні удари в ближньому бою збільшують силу атаки учасників групи в межах {2} м від шамана на {1}%. Триває {3} с.#attack power by {1}% if within {2} y#Lasts {3} sec", en="Unleashed Rage" },
[30803] = { "Нестримна лють", nil, "Силу атаки збільшено на {1}%.#by {1}%", en="Unleashed Rage" },
...
-- Windwall Totem
[15107] = { "Тотем стіни вітру", "Викликає тотем стіни вітру з {1} здоров'я. Тотем захищає учасників групи в межах {2} м, зменшуючи отриману шкоду в дальньому бою на {3}. Триває {4} хв.#with {1} health#within {2} y#taken by {3}#Lasts {4} min", en="Windwall Totem" },
...
-- Item effects
[23734] = { "Природний баланс", "Єднає шамана з природою, збільшуючи шкоду заклять на {1}%, збільшуючи ефективність зцілення на {2}% та збільшуючи витрати мани на закляття на {3}% протягом {4} с.#spell damage by {1}%#heal effects by {2}%#cost of spells by {3}% for {4} sec", "Шкоду заклять збільшено на {1}%.\nЕфективність зцілення збільшено на {2}%.\nВитрати мани збільшено на {3}%.#damage increased by {1}%#effects increased by {2}%#cost increased by {3}%", en="Nature Aligned" },

-- Set bonuses
[23573] = { "Ланцюгова хвиля зцілення", "Ваша \"Хвиля зцілення\" також перестрибує на цілі неподалік, з кожним стрибком зцілюючи на {1}% менше. Максимум до двох стрибків.#jump reduces the effectiveness of the heal by {1}%", en="Chain Healing Wave" },
