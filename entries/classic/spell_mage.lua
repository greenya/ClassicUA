...
[12355] = { "Зіткнення", nil, "Приголомшений." }, -- Impact (Rank 1)
...
-- Mana Shield
[1463] = { "Щит мани", "Поглинає {1} фізичної шкоди за рахунок мани. Висушує {2} мани за кожну одиницю поглинутої шкоди. Триває {3} хв.#Absorbs {1}#Drains {2}#Lasts {3} min", "Поглинає фізичну шкоду за рахунок мани." }, -- Mana Shield (Rank 1)
...
[28271] = { ref=118 }, -- Polymorph (Turtle)
[28272] = { ref=118 }, -- Polymorph (Pig)
-- Portal: Darnassus
