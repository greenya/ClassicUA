...
-- Blast Wave
[11113] = { "Вибухова хвиля", "Заклинач збурює полум'яну хвилю навколо себе, яка прямує від нього та завдає від {1} до {2} шкоди вогнем усім ворогам у радіусі дії, а також паморочить їх на {3} с.#blast for {1} to {2}#dazing them for {3} sec", "Запаморочений." }, -- Blast Wave (Rank 1)
