...
-- Frostbolt
[116] = { "Крижана стріла", "Запускає у ворога крижану стрілу, що завдає від {1} до {2} шкоди кригою та сповільнює швидкість руху на {3}% на {4} с.#causing {1} to {2} Frost#by {3}% for {4} sec", "Швидкість руху зменшено на {1}%.#by {1}%" }, -- Frostbolt (Rank 1)
...
-- Improved Scorch
[11095] = { "Покращений опік", "Ваші закляття \"Опік\" мають {1}% ймовірності зробити вашу ціль вразливою до шкоди вогнем. Ця вразливість збільшує отриману ціллю шкоду вогнем на {2}% та триває {3} с. Ефект накопичується до {4} разів.#have a {1}% chance#target by {2}% and lasts {3} sec#up to {4} times" }, -- Improved Scorch (Rank 1)
...
-- Winter's Chill
[11180] = { "Зимова холоднеча", "Надає вашим закляттям криги {1}% ймовірності спричинити ефект \"Зимової холоднечі\", що збільшує ймовірність заклять криги завдати критичного удару цілі на {2}% на {3} с. Ефект накопичується до {4} разів.#{1}% chance#by {2}% for {3} sec#up to {4} times" }, -- Winter's Chill (Rank 1)
