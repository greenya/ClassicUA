...
-- Clearcasting
[12536] = { "Ясномова", nil, "Витрати мани вашого наступного закляття пошкодження зменшено на {1}%.#reduced by {1}" }, -- Clearcasting
-- Cold Snap
...
-- Flamestrike
[2120] = { "Полум'яний удар", "Прикликає на землю вогняний стовп, що палить усіх ворогів у зоні ураження, завдаючи від {1} до {2} шкоди вогнем і додатково {3} шкоди вогнем протягом {4} с.#for {1} to {2}#additional {3}#over {4} sec", "{1} шкоди вогнем кожні {2} секунди.#{1} Fire damage every {2} sec" }, -- Flamestrike (Rank 1)
...
-- Frostbolt
[116] = { "Крижана стріла", "Запускає у ворога крижану стрілу, що завдає від {1} до {2} пошкодження кригою та сповільнює швидкість руху на {3}% на {4} с.#{1} to {2}#{3}% for {4} sec", "Швидкість руху зменшено на {1}%.#by {1}%" }, -- Frostbolt (Rank 1)
...
-- Ice Barrier
[11426] = { "Льодяний бар'єр", "Миттєво захищає вас, поглинаючи {1} шкоди. Триває {2} хв. Поки щит тримається, вашу вимову заклять не можна перервати.#absorbing {1}#Lasts {2} min", "Поглинає пошкодження." }, -- Ice Barrier (Rank 1)
...
[12654] = { "Займання", nil, "Завдає пошкодження вогнем кожні {1} с.#every {1} sec" }, -- Ignite
...
-- Pyroblast
[11366] = { "Вогняна брила", "Кидає величезний вогняний валун, що завдає від {1} до {2} пошкодження вогнем і додаткові {3} пошкодження вогнем протягом {4} с.#causes {1} to {2}#additional {3}#over {4} sec", "{1} пошкодження вогнем кожні {2} секунди.#{1} Fire damage every {2} sec" }, -- Pyroblast (Rank 1)
