...
-- Kick - Silenced
[18425] = { "Підніжка - Знемовлений", nil, "Знемовлений." }, -- Kick - Silenced
-- Kidney Shot
...
-- Remorseless
[14143] = { "Безжалісність", nil, "Імовірність критичного удару вашої наступної здібності \"Зловісний удар\", \"Удар у спину\", \"Засідка\" або \"Примарний удар\" збільшено на {1}%.#by {1}" }, -- Remorseless (Rank 1)
[14149] = { ref=14143 }, -- Remorseless (Rank 2)
-- Remorseless Attacks
[14144] = { "Безжалісні атаки", "Вбивство суперника, що дає досвід або честь, збільшує ймовірність критичного удару вашої наступної здібності \"Зловісний удар\", \"Удар у спину\", \"Засідка\" або \"Примарний удар\" на {1}%. Триває {2} с.#{1}% increased#Lasts {2} sec" }, -- Remorseless Attacks (Rank 1)
...
-- Safe Fall
[1860] = { "Безпечне падіння", "Зменшує пошкодження від падіння." }, -- Safe Fall (Passive)
-- Sap
...
-- Stealth
[1784] = { "Непомітність", "Дозволяє пройдисвіту пересуватися непомітно, знижує швидкість руху на {1}%. Триває до скасування.#by {1}", "Непомітний. Рух сповільнено на {1}%.#by {1}" }, -- Stealth (Rank 1)
