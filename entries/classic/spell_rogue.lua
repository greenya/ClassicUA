...
-- Ambush
[8676] = { "Засідка", "Раптовий удар, що завдає цілі {1}% від шкоди зброї плюс {2}. Необхідно перебувати в непомітності та позаду цілі. Працює лише за наявності кинджалу в основній руці. Збільшує довжину комбінації на 1 прийом.#causing {1}% weapon damage plus {2} to" }, -- Ambush (Rank 1)
...
-- Blade Flurry
[13877] = { "Шквал клинків", "Збільшує вашу швидкість атаки на {1}%. Ваші атаки також завдають удару ще одному ворогу неподалік. Триває {2} с.#by {1}%#Lasts {2} sec", "Швидкість атаки збільшено на {1}%. Атаки зброєю завдають удару ще одному ворогу неподалік.#by {1}%" }, -- Blade Flurry
-- Blind
[2094] = { "Засліплення", "Засліплює ціль, змушуючи її блукати протягом {1} с. Будь-яка шкода перериває дію ефекту.#for up to {1} sec", "Дезорієнтовано." }, -- Blind
[21060] = { "Засліплення", "Засліплює ціль, змушуючи її блукати протягом {1} с. Будь-яка шкода перериває дію ефекту.#for up to {1} sec", "Дезорієнтовано." }, -- Blind
-- Blinding Powder
[6510] = { "Сліпучий порошок", "Створити реагент для здібності \"Засліплення\"." }, -- Blinding Powder
-- Camouflage
[13975] = { "Камуфляж", "Збільшує вашу швидкість руху в стані непомітності на {1}% та зменшує час відновлення вашої здібності \"Непомітність\" на {2} с.#by {1}%#by {2} sec" }, -- Camouflage (Rank 1)
...
-- Cheap Shot
[1833] = { "Брудний прийом", "Приголомшує ціль на {1} с. Необхідно перебувати в непомітності. Збільшує довжину комбінації на {2} прийоми.#for {1} sec#{2} combo", "Приголомшено." }, -- Cheap Shot
-- Cold Blood
...
[13706] = { "Спеціалізація на кинджалах", "Збільшує ймовірність завдати критичного удару кинджалами на {1}%.#by {1}%" }, -- Dagger Specialization (Rank 1)
...
-- Dirty Deeds
[14082] = { "Брудні справи", "Знижує витрати енергії здібностей \"Брудний прийом\" та \"Гарота\" на {1}.#abilities by {1}" }, -- Dirty Deeds (Rank 1)
...
-- Distract
[1725] = { "Відволікання", "Метнути приманку, що відволіче увагу всіх ворогів поблизу на {1} с. Не порушує непомітності.#for {1} sec" }, -- Distract
...
-- Evasion
[5277] = { "Уникнення", "Збільшує ймовірність ухилення на {1}% протягом {2} с.#by {1}% for {2} sec", "Збільшує ймовірність ухилення на {1}%.#by {1}%" }, -- Evasion
-- Eviscerate
...
[6768] = { "Фінт", "Виконує оманливий випад, що не завдає шкоди та зменшує вашу загрозу. Це знизить ймовірність того, що ворог атакуватиме саме вас." }, -- Feint (Rank 2)
[8637] = { "Фінт", "Виконує оманливий випад, що не завдає шкоди та значно зменшує вашу загрозу. Це знизить ймовірність того, що ворог атакуватиме саме вас." }, -- Feint (Rank 3)
[11303] = { ref=8637 }, -- Feint (Rank 4)
[25302] = { ref=8637 }, -- Feint (Rank 5)
-- Fist Weapon Specialization
[13707] = { "Спеціалізація на кулачній зброї", "Збільшує ймовірність завдати критичного удару кулачною зброєю на {1}%.#by {1}%" }, -- Fist Weapon Specialization (Rank 1)
...
-- Garrote
[703] = { "Гарота", "Придушити ворога, завдаючи {1} шкоди протягом {2} с, що збільшується від вашої сили атаки. Необхідно перебувати в непомітності та позаду цілі. Збільшує довжину комбінації на {3} прийом.#causing {1} damage over {2} sec#Awards {3} combo", "{1} шкоди кожні {2} с.#{1} damage every {2} sec" }, -- Garrote (Rank 1)
...
-- Ghostly Strike
[14278] = { "Примарний удар", "Удар, що завдає {1}% шкоди зброєю та збільшує вашу ймовірність ухилення на {2}% протягом {3} с. Збільшує довжину комбінації на {4} прийом.#{1}% weapon#by {2}% for {3} sec#{4} combo", "Ймовірність ухилення збільшено на {1}%.#by {1}%" }, -- Ghostly Strike
-- Gouge
[1776] = { "Ошелешення", "Завдає {1} шкоди, робить ворога недієздатним на {2} с. та зупиняє вашу атаку. Ціль має бути повернута до вас. Будь-яка шкода перериває дію ефекту на цілі. Збільшує довжину комбінації на {3} прийом.#Causes {1}#for {2} sec#{3} combo", "Недієздатність." }, -- Gouge (Rank 1)
[1777] = { ref=1776 }, -- Gouge (Rank 2)
[8629] = { ref=1776 }, -- Gouge (Rank 3)
[11285] = { ref=1776 }, -- Gouge (Rank 4)
[11286] = { ref=1776 }, -- Gouge (Rank 5)
-- Heightened Senses
[30894] = { "Загострені відчуття", "Посилює вашу здатність виявлення непомітності та зменшує ймовірність завдати вам удару закляттями та атаками дальнього бою на {1}%.#by {1}%" }, -- Heightened Senses (Rank 1)
[30895] = { "Загострені відчуття", "Посилює вашу здатність виявлення непомітності та зменшує ймовірність завдати вам удару закляттями та атаками дальнього бою на {1}%. Дієвіше за \"Загострені відчуття\" (Ранг {2}).#by {1}#(Rank {2})" }, -- Heightened Senses (Rank 2)
-- Hemorrhage
[16511] = { "Крововилив", "Миттєвий удар, завдає шкоди супернику та спричиняє крововилив, що збільшує отриману фізичну шкоду на {1}. Діє на {2} ударів або протягом {3} с. Збільшує довжину комбінації на {4} прийом.#by up to {1}#Lasts {2} charges or {3} sec#{4} combo", "Збільшує отриману шкоду на {1}.#by {1}" }, -- Hemorrhage (Rank 1)
[17347] = { ref=16511 }, -- Hemorrhage (Rank 2)
[17348] = { ref=16511 }, -- Hemorrhage (Rank 3)
-- Improved Ambush
[14079] = { "Покращена засідка", "Збільшує ймовірність критичного удару здібності \"Засідка\" на {1}%.#by {1}%" }, -- Improved Ambush (Rank 1)
[14080] = { ref=14079 }, -- Improved Ambush (Rank 2)
[14081] = { ref=14079 }, -- Improved Ambush (Rank 3)
-- Improved Backstab
[13733] = { "Покращений удар у спину", "Збільшує ймовірність критичного удару здібності \"Удар у спину\" на {1}%.#by {1}%" }, -- Improved Backstab (Rank 1)
[13865] = { ref=13733 }, -- Improved Backstab (Rank 2)
[13866] = { ref=13733 }, -- Improved Backstab (Rank 3)
-- Improved Eviscerate
[14162] = { "Покращене потрошіння", "Збільшує шкоду здібності \"Потрошіння\" на {1}%.#by {1}%" }, -- Improved Eviscerate (Rank 1)
[14163] = { ref=14162 }, -- Improved Eviscerate (Rank 2)
[14164] = { ref=14162 }, -- Improved Eviscerate (Rank 3)
-- Improved Expose Armor
[14168] = { "Покращене зняття броні", "Посилює ефект зниження броні від здібності \"Зняття броні\" на {1}%.#by {1}%" }, -- Improved Expose Armor (Rank 1)
[14169] = { ref=14168 }, -- Improved Expose Armor (Rank 2)
-- Improved Gouge
[13741] = { "Покращене ошелешення", "Збільшує тривалість ефекту здібності \"Ошелешення\" на {1} с.#by {1} sec" }, -- Improved Gouge (Rank 1)
[13792] = { ref=13741 }, -- Improved Gouge (Rank 3)
[13793] = { ref=13741 }, -- Improved Gouge (Rank 2)
-- Improved Kick
[13754] = { "Покращений копняк", "Здібність \"Копняк\" з ймовірністю {1}% знемовлює ціль на {2} с.#a {1}% chance#for {2} sec" }, -- Improved Kick (Rank 1)
[13867] = { ref=13754 }, -- Improved Kick (Rank 2)
-- Improved Kidney Shot
[14174] = { "Покращений удар по нирках", "Перебуваючи під дією вашої здібності \"Удар по нирках\", ціль додатково отримує {1}% шкоди з усіх джерел.#additional {1}%" }, -- Improved Kidney Shot (Rank 1)
[14175] = { ref=14174 }, -- Improved Kidney Shot (Rank 2)
[14176] = { ref=14174 }, -- Improved Kidney Shot (Rank 3)
-- Improved Poisons
[14113] = { "Покращені отрути", "Збільшує ймовірність отруєння цілі на {1}%.#by {1}%" }, -- Improved Poisons (Rank 1)
...
-- Improved Sap
[14076] = { "Покращене оглушення", "Надає вам {1}% імовірності повернутися у стан непомітності після застосування здібності \"Оглушення\".#a {1}% chance" }, -- Improved Sap (Rank 1)
...
[14165] = { "Покращена м'ясорубка", "Збільшує тривалість дії здібності \"М'ясорубка\" на {1}%.#by {1}%" }, -- Improved Slice and Dice (Rank 1)
[14166] = { ref=14165 }, -- Improved Slice and Dice (Rank 2)
[14167] = { ref=14165 }, -- Improved Slice and Dice (Rank 3)
-- Improved Sprint
[13743] = { "Покращений спринт", "Ви з ймовірністю {1}% знімете всі ефекти обмеження руху при активації здібності \"Спринт\".#a {1}% chance" }, -- Improved Sprint (Rank 1)
[13875] = { ref=13743 }, -- Improved Sprint (Rank 2)
-- Initiative
[13976] = { "Ініціатива", "Надає вам {1}% ймовірності збільшити довжину комбінації на додатковий прийом при використанні здібності \"Засідка\", \"Гарота\" або \"Брудний прийом\".#a {1}% chance" }, -- Initiative (Rank 1)
...
-- Lethality
[14128] = { "Летальність", "Збільшує додаткову шкоду від критичних ударів здібностей \"Підступний удар\", \"Ошелешення\", \"Удар у спину\", \"Примарний удар\" та \"Крововилив\" на {1}%.#by {1}%" }, -- Lethality (Rank 1)
...
-- Lightning Reflexes
[13712] = { "Блискавичні рефлекси", "Збільшує вашу ймовірність ухилення на {1}%.#by {1}%" }, -- Lightning Reflexes (Rank 1)
...
-- Mace Specialization
[13709] = { "Спеціалізація на булавах", "Збільшує ваші навички володіння булавами на {1}. Також надає вам {2}% ймовірності приголомшити ціль на {3} с при ударі булавою.#Maces by {1}#{2}% chance#for {3} sec" }, -- Mace Specialization (Rank 1)
...
-- Master of Deception
[13958] = { "Майстер омани", "Зменшує ймовірність того, що вороги помітять вас під час дії непомітності." }, -- Master of Deception (Rank 1)
[13970] = { "Майстер омани", "Зменшує ймовірність того, що вороги помітять вас під час дії непомітності. Дієвіше за \"Майстер омани\" (Ранг {1}).#(Rank {1})" }, -- Master of Deception (Rank 2)
...
-- Murder
[14158] = { "Вбивство", "Збільшує всю шкоду гуманоїдам, велетням, звірам та драконам на {1}%.#by {1}%" }, -- Murder (Rank 1)
[14159] = { ref=14158 }, -- Murder (Rank 2)
-- Opportunity
[14057] = { "Нагода", "Збільшує шкоду при атаці здібностями \"Удар у спину\", \"Гарота\" та \"Засідка\" зі спини на {1}%.#by {1}%" }, -- Opportunity (Rank 1)
...
-- Paralyze
[23414] = { "Параліч", nil, "Не може рухатися." }, -- Paralyze
-- Pick Lock
[1804] = { "Зламування замків", "Дозволяє відкривати замкнені скрині та двері." }, -- Pick Lock
-- Pick Pocket
...
-- Precision
[13705] = { "Точність", "Збільшує ймовірність завдати удару зброєю ближнього бою на {1}%.#by {1}%" }, -- Precision (Rank 1)
...
[14181] = { "Ефект невідступних ударів" }, -- Relentless Strikes Effect (Rank 1)
-- Remorseless
[14143] = { "Безжалісність", nil, "Ймовірність критичного удару вашої наступної здібності \"Підступний удар\", \"Удар у спину\", \"Засідка\" або \"Примарний удар\" збільшено на {1}%.#by {1}%" }, -- Remorseless (Rank 1)
[14149] = { ref=14143 }, -- Remorseless (Rank 2)
-- Remorseless Attacks
[14144] = { "Безжалісні атаки", "Вбивство суперника, що приносить досвід або честь, збільшує ймовірність критичного удару вашої наступної здібності \"Підступний удар\", \"Удар у спину\", \"Засідка\" або \"Примарний удар\" на {1}%. Триває {2} с.#a {1}% increased#Lasts {2} sec" }, -- Remorseless Attacks (Rank 1)
...
-- Ruthlessness
[14156] = { "Нещадність", "Надає вашим завершальним рухам {1}% імовірності збільшити довжину комбінації по цілі на один прийом.#{1}% chance" }, -- Ruthlessness (Rank 1)
...
-- Sap
[2070] = { "Оглушення", "Робить ціль недієздатною на {1} с. Необхідно перебувати в непомітності. Діє лише проти гуманоїдів, що перебувають поза боєм. Будь-яка шкода знімає ефект з ураженої цілі. Одночасно лише {2} ціль може бути оглушеною.#up to {1} sec#{2} target", "Недієздатність." }, -- Sap (Rank 2)
[6770] = { "Оглушення", ref=2070 }, -- Sap (Rank 1)
[11297] = { ref=2070 }, -- Sap (Rank 3)
-- Seal Fate
[14186] = { "Відбиток долі", "Ваші критичні удари здібностями, які збільшують довжину комбінації, з ймовірністю {1}% збільшать її на ще один прийом.#a {1}% chance" }, -- Seal Fate (Rank 1)
...
-- Setup
[13983] = { "Налаштованість", "Надає вам {1}% імовірності збільшити довжину комбінації по цілі на один прийом після ухилення від атаки чи повного опору закляттю.#{1}% chance" }, -- Setup (Rank 1)
...
-- Sleight of Hand
[30892] = { "Спритність рук", "Зменшує ймовірність отримання критичної шкоди від атак ближнього та дального бою на {1}%. Також посилює на {2}% ефект зниження загрози від здібності \"Фінт\".#attacks by {1}#ability by {2}" }, -- Sleight of Hand (Rank 1)
...
-- Vile Poisons
[16513] = { "Мерзенні отрути", "Збільшує шкоду ваших отрут на {1}% та надає їм додатково {2}% ймовірності протидіяти ефектам розвіювання.#by {1}#{2}% chance" }, -- Vile Poisons (Rank 1)
