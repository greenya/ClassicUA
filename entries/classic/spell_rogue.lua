...
-- Serrated Blades
[14171] = { "Зубчасті леза", "Ваші атаки ігнорують {1} броні цілі, а ваша здібність \"Розрив\" завдає на {2}% більше шкоди. Значення ігнорованої броні зростає з вашим рівнем.#ignore {1}#by {2}" }, -- Serrated Blades (Rank 1)
