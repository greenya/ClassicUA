...
-- Aggression
[18427] = { "Агресивність", "Збільшує пошкодження вашими здібностями \"Підступний удар\" та \"Потрошіння\" на {1}%.#by {1}" }, -- Aggression (Rank 1)
...
-- Lethality
[14128] = { "Летальність", "Збільшує пошкодження критичних ударів ваших здібностей \"Підступний удар\", \"Ошелешити\", \"Удар у спину\", \"Примарний удар\" та \"Крововилив\" на {1}%.#by {1}" }, -- Lethality (Rank 1)
...
-- Riposte
[14251] = { "Відповідь", "Удар, який можливо виконати лише після парирування атаки опонента. Ця атака завдає {1}% пошкодження зброєю та роззброює ціль на {2} с.#deals {1}#for {2} sec", "Роззброєно." }, -- Riposte
-- Rupture
...
-- Sinister Strike
[1752] = { "Підступний удар", "Миттєвий удар, завдає додатково {1} пошкодження до звичайного пошкодження зброєю. Збільшує довжину комбінації на {2} прийом.#causes {1}#{2} combo" }, -- Sinister Strike (Rank 1)
