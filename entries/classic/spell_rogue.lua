...
-- Improved Sprint
[13743] = { "Покращений спринт", "Надає {1}% імовірності позбутися всіх ефектів перешкоди руху при активації вашої здібності \"Спринт\".#a {1}% chance" }, -- Improved Sprint (Rank 1)
...
-- Vanish
[1856] = { "Зникнення", "Дозволяє пройдисвіту зникнути з поля зору ворогів, увійшовши в стан покращеної непомітності на {1} с. Також знімає всі ефекти перешкоди руху.#for {1} sec", "Покращена непомітність." }, -- Vanish (Rank 1)
[1857] = { "Зникнення", "Дозволяє пройдисвіту зникнути з поля зору ворогів, увійшовши в стан покращеної непомітності на {1} с. Також знімає всі ефекти перешкоди руху. Дієвіше за \"Зникнення\" (Ранг {2}).#for {1} sec#(Rank {2})", "Покращена непомітність." }, -- Vanish (Rank 2)
