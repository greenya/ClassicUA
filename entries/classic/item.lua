...
[1720] = { "вузлуватий посох", equip="Збільшує шкоду і зцілення від заклинань і ефектів природи на 14." }, -- Tanglewood Staff, @equip Increases damage done by Nature spells and effects by up to 14.
