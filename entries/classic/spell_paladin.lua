...
[20335] = { "Покращена печатка лицаря", "Збільшує силу атаки ближнього бою від вашої \"Печатки лицаря\" та шкоду священністю від вашого \"Присуду лицаря\" на {1}%.#by {1}" }, -- Improved Seal of the Crusader (Rank 1)
...
[21183] = { "Присуд лицаря", nil, "Збільшує отриману шкоду священністю на {1}.#by up to {1}" }, -- Judgement of the Crusader (Rank 1)
-- Lasting Judgement
...
-- Righteous Fury
[25780] = { "Праведна лють", "Збільшує загрозу ваших атак святості на {1}%. Триває {2} хв.#by {1}#Lasts {2} min", "Збільшує загрозу ваших атак святості на {1}%.#by {1}" }, -- Righteous Fury
-- Sanctity Aura
...
-- Summon Charger
[23214] = { "Виклик скакуна", "Викликає скакуна для верхової їзди. Швидкість збільшено на {1}%.#by {1}%", "Швидкість руху збільшено на {1}%.#by {1}%" }, -- Summon Charger (Summon)
-- Summon Warhorse
[13819] = { "Виклик бойового коня", "Викликає бойового коня для верхової їзди. Швидкість збільшено на {1}%.#by {1}", "Швидкість руху збільшено на {1}%.#by {1}%" }, -- Summon Warhorse (Summon)
-- Toughness
