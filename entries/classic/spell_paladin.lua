...
-- Blessing of Freedom
[1044] = { "Благословення свободи", "Благословляє дружню ціль, надає невразливість до ефектів перешкоди руху на {1} с. Гравці можуть мати лише одне благословення від кожного паладина одночасно.#for {1} sec", "Невразливість до ефектів перешкоди руху." }, -- Blessing of Freedom
-- Blessing of Kings
...
-- Stun
[20170] = { "Приголомшення", nil, "Приголомшений." }, -- Stun (Rank 1)
-- Summon Charger
