...
-- Forbearance
[25771] = { "Терпимість", nil, "Не може отримати невразливість від заклять \"Божественний щит\", \"Божественний захист\" та \"Благословення захисту\"." }, -- Forbearance
...
-- Sanctity Aura
[20218] = { "Аура святості", "Збільшує пошкодження священністю учасників групи в радіусі {1} м на {2}%. Гравці можуть мати на собі лише одну ауру від кожного паладина одночасно.#within {1} yards by {2}", "Збільшує пошкодження священністю на {1}%.#by {1}" }, -- Sanctity Aura
-- Seal of Command
...
[20154] = { "Печатка праведності", "Наповнює паладина святим духом на {1} с, надаючи кожній атаці ближнього бою від {2} до {3} додаткового пошкодження священністю. Повільніша зброя завдає більше пошкодження священністю за удар. Лише одна печатка може бути задіяна на паладинові одночасно.#for {1} sec#additional {2} to {3}", "Атаки ближнього бою завдають від {1} до {2} додаткового пошкодження священністю.#additional {1} to {2}" }, -- Seal of Righteousness (Rank 1)
...
-- Summon Charger
[23214] = { "Виклик громака", "Викликає громака для верхової їзди. Швидкість збільшено на {1}%.#by {1}", "Збільшує швидкість на {1}%.#by {1}" }, -- Summon Charger (Summon)
-- Summon Warhorse
