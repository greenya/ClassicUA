...
[26573] = { "Освячення", "Освячує землю під паладином, завдаючи {1} шкоди святістю протягом {2} с усім ворогам, що на неї ступають.#doing {1} Holy damage over {2} sec", "{1} пошкодження щосекунди.#{1} damage" }, -- Consecration (Rank 1)
-- Conviction
...
[21183] = { "Присуд хрестоносця", nil, "Збільшує отримуване пошкодження священністю на {1}.#by up to {1}" }, -- Judgement of the Crusader (Rank 1)
-- Lasting Judgement
...
-- Repentance
[20066] = { "Спокута", "Вводить ворожу ціль у стан медитації, роблячи її недієздатною на {1} с. Будь-яке пошкодження пробудить ціль. Діє лише на гуманоїдів.#for up to {1} sec", "Недієздатність." }, -- Repentance
-- Retribution Aura
...
-- Sanctity Aura
[20218] = { "Аура святості", "Збільшує пошкодження священністю учасників групи в радіусі {1} м на {2}%. Гравці можуть мати лише одну ауру від кожного паладина одночасно.#within {1} yards by {2}", "Збільшує пошкодження священністю на {1}%.#by {1}" }, -- Sanctity Aura
-- Seal of Command
...
[20154] = { "Печатка праведності", "Наповнює паладина святим духом на {1} с, надаючи кожній атаці ближнього бою від {2} до {3} додаткової шкоди святістю. Повільніша зброя завдає більше шкоди святістю за удар. Лише одна печатка може бути задіяна на паладинові одночасно.#for {1} sec#additional {2} to {3}", "Атаки ближнього бою завдають від {1} до {2} додаткового пошкодження священністю.#additional {1} to {2}" }, -- Seal of Righteousness (Rank 1)
[20287] = { "Печатка праведності", "Наповнює паладина святим духом на {1} с, надаючи кожній атаці ближнього бою від {2} до {3} додаткової шкоди святістю. Повільніша зброя завдає більше шкоди святістю за удар. Лише одна печатка може бути задіяна на паладинові одночасно.\n\nВивільнення енергії цієї печатки завдасть ворогові від {4} до {5} шкоди святістю.#for {1} sec#additional {2} to {3}#cause {4} to {5}", "Атаки ближнього бою завдають від {1} до {2} додаткового пошкодження священністю.#additional {1} to {2}" }, -- Seal of Righteousness (Rank 2)
...
[20050] = { "Помста", nil, "Фізичне пошкодження та пошкодження священністю збільшено на {1}%.#by {1}" }, -- Vengeance
