...
[15269] = { "Затьмарення", nil, "Приголомшений." }, -- Blackout (Rank 1)
...
[15258] = { "Вразливість до тіні", nil, "Отримуване пошкодження тінню збільшено на {1}%.#by {1}" }, -- Shadow Vulnerability (Rank 1)
-- Shadow Weaving
...
[2943] = { "Дотик слабкості", nil, "Фізичне пошкодження зменшене на {1}.#by {1}" }, -- Touch of Weakness (Rank 1)
