...
-- Blessed Recovery
[27811] = { "Благословенне одужання", "Після отримання критичного удару в ближньому чи дальньому бою ви зцілюєтесь на {1}% від отриманої шкоди протягом {2} с .#heal {1}%#over {2} sec" }, -- Blessed Recovery (Rank 1)
...
-- Feedback
[13896] = { "Відгомін", "Жерця оточує антимагічна енергія. Будь-яке успішне закляття проти нього випалить {1} мани нападника та завдасть {2} шкоди тінню за кожну одиницю випаленої мани. Триває {3} с.#burn {1}#causing {2}#Lasts {3} sec", "Антимагічна енергія випалить {1} мани нападника та завдасть {2} шкоди тінню за кожну одиницю випаленої мани.#burn {1}#causing {2}" }, -- Feedback (Rank 1)
...
-- Improved Mana Burn
[14750] = { "Покращене спалювання мани", "Зменшує час вимови закляття \"Спалювання мани\" на {1} с.#by {1} sec" }, -- Improved Mana Burn (Rank 1)
...
-- Mana Burn
[8129] = { "Спалювання мани", "Випалює з цілі від {1} до {2} мани. Кожна одиниця випаленої таким чином мани завдає цілі {3} шкоди тінню.#{1} to {2} mana#takes {3}" }, -- Mana Burn (Rank 1)
...
-- Vampiric Embrace
[15286] = { "Вампірські обійми", "Вражає вашу ціль енергією тіні, яка зцілює усіх учасників групи на {1}% від заподіяної шкоди ввашими закляттями тіні протягом {2} хв.#healed for {1}%#deal for {2} min", "Зцілює групу жерця на {1}% від його шкоди закляттями тіні.#{1}% of Shadow" }, -- Vampiric Embrace
-- Wand Specialization
