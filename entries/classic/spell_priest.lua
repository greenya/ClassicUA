...
-- Shadowform
[15473] = { "Тінеобраз", "Прийняти тінеобраз, збільшуючи вашу шкоду тінню на {1}% і зменшуючи отриману фізичну шкоду на {2}%. Однак, у цьому образі ви не можете вимовляти закляття святості.#damage by {1}%#done to you by {2}%", "Ваша шкода тінню збільшена на {1}%. Отриману фізичну шкоду зменшено на {2}%. Ви не можете вимовляти закляття святості.#increased by {1}%#take reduced by {2}%" }, -- Shadowform
-- Shadowguard
