...
-- Abolish Disease
[552] = { "Усунення хвороби", "Намагається вилікувати 1 хворобу на цілі та ще 1 ефект хвороби кожні {1} с протягом {2} с.#every {1} sec#for {2} sec", "Намагається усунути 1 ефект хвороби кожні {1} с.#every {1} sec" }, -- Abolish Disease
-- Blackout
[15268] = { "Затьмарення", "Ваші бойові закляття тіні з ймовірністю {1}% приголомшують ціль на {2} с.#a {1}% chance#for {2} sec" }, -- Blackout (Rank 1)
...
-- Blessed Recovery
[27811] = { "Благословенне відновлення", "Після отримання критичного удару в ближньому чи дальньому бою ви зцілюєтесь на {1}% від отриманої шкоди протягом {2} с .#heal {1}%#over {2} sec" }, -- Blessed Recovery (Rank 1)
[27815] = { ref=27811 }, -- Blessed Recovery (Rank 2)
[27816] = { ref=27811 }, -- Blessed Recovery (Rank 3)
[27813] = { "Благословенне відновлення", "Зцілює ціль протягом {1} с.#over {1} sec", "Зцілює {1}% від нещодавно отриманого критичного удару протягом {2} с.#Heals {1}% of#over {2} sec" }, -- Blessed Recovery (Rank 1)
[27817] = { ref=27813 }, -- Blessed Recovery (Rank 2)
[27818] = { ref=27813 }, -- Blessed Recovery (Rank 3)
-- Choking Spores
[22802] = { "Задушливі спори", nil, "Завдає від {1} до {2} шкоди від природи щосекунди.#Deals {1} to {2} nature" }, -- Choking Spores
-- Corrupted Healing
[23401] = { "Осквернене зцілення", nil, "Закляття прямого зцілення завдають періодичної шкоди цілям." }, -- Corrupted Healing
...
-- Desperate Prayer
[13908] = { "Відчайдушна молитва", "Миттєво зцілює заклиначеві від {1} до {2} здоров'я.#for {1} to {2}" }, -- Desperate Prayer (Rank 1)
...
-- Dispel Magic
[527] = { "Розвіювання магії", "Розвіює магію з цілі, знімаючи 1 шкідливий ефект з союзника або 1 сприятливий ефект з ворога." }, -- Dispel Magic (Rank 1)
[988] = { "Розвіювання магії", "Розвіює магію з цілі, знімаючи 2 шкідливі ефекти з союзника або 2 сприятливі ефекти з ворога." }, -- Dispel Magic (Rank 2)
-- Divine Fury
...
-- Divine Spirit
[14752] = { "Божественний дух", "Свята сила наповнює ціль, збільшуючи її дух на {1} протягом {2} хв.#by {1} for {2} min", "Збільшує дух на {1}.#by {1}" }, -- Divine Spirit (Rank 1)
...
-- Elune's Grace
[2651] = { "Милість Елуни", "Зменшує отриману шкоду від атак дального бою на {1} і збільшує ймовірність ухилення на {2}% протягом {3} с.#taken by {1}#dodge by {2}% for {3} sec", "Отриману шкоду від атак дального бою зменшено на {1}, а ймовірність ухилення збільшено на {2}%.#reduced by {1}#increased by {2}" }, -- Elune's Grace (Rank 1)
...
-- Eye of Divinity
[23101] = { "Око Божественності", nil, "Ви відчуваєте гармонію зі світом." }, -- Eye of Divinity
-- Fade
[586] = { "Розтанення", "Розтанути у повітрі, зменшуючи всю вашу загрозу протягом {1} с.#for {1} sec", "Рівень загрози зменшено." }, -- Fade (Rank 1)
[9578] = { "Розтанення", "Розтанути у повітрі, зменшуючи всю вашу загрозу протягом {1} с. Дієвіше за \"Розтанення\" (Ранг {2}).#for {1} sec#rank {2}", "Рівень загрози зменшено." }, -- Fade (Rank 2)
[9579] = { ref=9578 }, -- Fade (Rank 3)
[9592] = { ref=9578 }, -- Fade (Rank 4)
[10941] = { ref=9578 }, -- Fade (Rank 5)
[10942] = { ref=9578 }, -- Fade (Rank 6)
-- Fear Ward
[6346] = { "Оберіг від страху", "Оберігає дружню ціль від страху. Наступний ефект страху проти цілі буде нейтралізовано за рахунок оберегу. Триває {1} хв.#Lasts {1} min", "Захищено від страху." }, -- Fear Ward
-- Feedback
...
-- Flash Heal
[2061] = { "Швидке зцілення", "Зцілює дружній цілі від {1} до {2} здоров'я.#target for {1} to {2}" }, -- Flash Heal (Rank 1)
...
-- Focused Casting
[14743] = { "Зосереджена вимова", "При застосуванні ви не зазнаєте затримки вимови заклять при отриманні шкоди. Діє {1} секунд.#Lasts {1} sec", "Не зазнає затримки вимови заклять при отриманні шкоди та має збільшену на {1}% ймовірність протистояти ефектам переривання.#by {1}%" }, -- Focused Casting (Rank 1)
...
[22751] = { "Лють Морозних Вовків", "Поки діє ефект, запас здоров'я збільшується на {1}%.#by {1}%", "Запас здоров'я збільшено на {1}%.#by {1}%" }, -- Fury of the Frostwolf
-- Greater Heal
...
-- Heal
[2054] = { "Зцілення", "Зцілює цілі від {1} до {2} здоров'я.#target for {1} to {2}" }, -- Heal (Rank 1)
[2055] = { ref=2054 }, -- Heal (Rank 2)
[6063] = { ref=2054 }, -- Heal (Rank 3)
[6064] = { ref=2054 }, -- Heal (Rank 4)
-- Healing Focus
[14913] = { "Зосередженість на зціленні", "З ймовірністю {1}% ви уникнете затримки вимови цілющих заклять при отриманні шкоди.#{1}% chance" }, -- Healing Focus (Rank 1)
...
-- Holy Fire
[14914] = { "Священний вогонь", "Ворога охоплює священне полум'я, що завдає від {1} до {2} шкоди святістю та додатково {3} шкоди святістю протягом {4} с.#cause {1} to {2} Holy#additional {3} Holy damage over {4} sec", "{1} шкоди святістю кожні {2} с.#{1} Holy damage every {2} sec" }, -- Holy Fire (Rank 1)
...
[17140] = { "Священний вогонь", "Ворога охоплює полум'я, що обпалює його та завдає додаткової шкоди від вогню кожні {1} с протягом {2} с.#every {1} sec#over {2} sec", "Отримання шкоди від вогню кожні {1} с.#every {1} sec" }, -- Holy Fire
[17141] = { ref=17140 }, -- Holy Fire
[17142] = { ref=17140 }, -- Holy Fire
[18165] = { ref=17140 }, -- Holy Fire
[23860] = { ref=17140 }, -- Holy Fire
-- Holy Nova
[15237] = { "Священний спалах", "Створює вибух священного світла навколо заклинача, завдаючи від {1} до {2} шкоди святістю ворожим цілям в радіусі {3} м і зцілюючи від {5} до {6} здоров'я учасникам групи в межах {4} м. Ці ефекти не спричиняють загрози.#causing {1} to {2} Holy#targets within {3} y#members within {4} yards for {5} to {6}" }, -- Holy Nova (Rank 1)
...
-- Holy Reach
[27789] = { "Досяжність святості", "Збільшує дальність дії ваших заклять \"Кара\" та \"Священний вогонь\", а також радіус дії ваших заклять \"Молитва зцілення\" та \"Священний спалах\" на {1}%.#by {1}%" }, -- Holy Reach (Rank 1)
...
-- Improved Fade
[15274] = { "Покращене розтанення", "Зменшує час відновлення вашого закляття \"Розтанення\" на {1} с.#by {1} sec" }, -- Improved Fade (Rank 1)
[15311] = { ref=15274 }, -- Improved Fade (Rank 2)
-- Improved Healing
[14912] = { "Покращене зцілення", "Знижує витрати мани заклять \"Мале зцілення\", \"Зцілення\" та \"Велике зцілення\" на {1}%.#by {1}%" }, -- Improved Healing (Rank 1)
[15013] = { ref=14912 }, -- Improved Healing (Rank 2)
[15014] = { ref=14912 }, -- Improved Healing (Rank 3)
-- Improved Inner Fire
[14747] = { "Покращений внутрішній вогонь", "Збільшує додаткову броню від закляття \"Внутрішній вогонь\" на {1}%.#by {1}%" }, -- Improved Inner Fire (Rank 1)
[14770] = { ref=14747 }, -- Improved Inner Fire (Rank 2)
[14771] = { ref=14747 }, -- Improved Inner Fire (Rank 3)
-- Improved Mana Burn
[14750] = { "Покращене спалення мани", "Зменшує час вимови закляття \"Спалення мани\" на {1} с.#by {1} sec" }, -- Improved Mana Burn (Rank 1)
...
[14749] = { "Покращене слово сили: Стійкість", "Збільшує ефективність заклять \"Слово сили: Стійкість\" та \"Молитва стійкості\" на {1}%.#by {1}%" }, -- Improved Power Word: Fortitude (Rank 1)
[14767] = { ref=14749 }, -- Improved Power Word: Fortitude (Rank 2)
-- Improved Power Word: Shield
[14748] = { "Покращене слово сили: Щит", "Збільшує обсяг шкоди, яку може поглинути \"Слово сили: Щит\", на {1}%.#by {1}%" }, -- Improved Power Word: Shield (Rank 1)
...
[14911] = { "Покращена молитва зцілення", "Знижує витрати мани закляття \"Молитва зцілення\" на {1}%.#by {1}%" }, -- Improved Prayer of Healing (Rank 1)
[15018] = { ref=14911 }, -- Improved Prayer of Healing (Rank 2)
[15019] = { ref=14911 }, -- Improved Prayer of Healing (Rank 3)
-- Improved Psychic Scream
[15392] = { "Покращений психічний крик", "Зменшує час відновлення закляття \"Психічний крик\" на {1} с.#by {1} sec" }, -- Improved Psychic Scream (Rank 1)
[15448] = { ref=15392 }, -- Improved Psychic Scream (Rank 2)
-- Improved Renew
[14908] = { "Покращене оновлення", "Збільшує зцілення закляттям \"Оновлення\" на {1}%.#by {1}%" }, -- Improved Renew (Rank 1)
[15020] = { ref=14908 }, -- Improved Renew (Rank 2)
[17191] = { ref=14908 }, -- Improved Renew (Rank 3)
-- Improved Shadow Word: Pain
[15275] = { "Покращене слово тіні: Біль", "Збільшує тривалість ефекту закляття \"Слово тіні: Біль\" на {1} с.#by {1} sec" }, -- Improved Shadow Word: Pain (Rank 1)
[15317] = { ref=15275 }, -- Improved Shadow Word: Pain (Rank 2)
-- Improved Vampiric Embrace
[27839] = { "Покращені вампірські обійми", "Збільшує долю зцілення вашого закляття \"Вампірські обійми\" від шкоди ще на {1}%.#additional {1}%" }, -- Improved Vampiric Embrace (Rank 1)
[27840] = { ref=27839 }, -- Improved Vampiric Embrace (Rank 2)
-- Inner Fire
[588] = { "Внутрішній вогонь", "Сплеск священної енергії наповнює заклинача, збільшуючи броню на {1}. Кожна атака ближнього чи дальнього бою проти жерця знімає один заряд ефекту. Триває {2} хв або поки не буде використано {3} зарядів.#armor by {1}#Lasts {2} min or until {3} charges", "Збільшує броню на {1}.#by {1}" }, -- Inner Fire (Rank 1)
...
-- Inner Focus
[14751] = { "Внутрішня зосередженість", "При активації зменшує витрати мани вашого наступного закляття на {1}% та збільшує ймовірність його критичного ефекту на {2}%, якщо такий ефект можливий.#spell by {1}%#chance by {2}%", "Витрати мани на ваше наступне закляття зменшено на {1}%.#reduced by {1}%" }, -- Inner Focus
-- Inspiration
[14892] = { "Натхнення", "Збільшує броню вашої цілі на {1}% протягом {2} с після критичного ефекту [будь-яких ваших заклять зцілення#any of your heals][ваших заклять \"Швидке зцілення\", \"Зцілення\", \"Велике зцілення\" або \"Молитва зцілення\"#your Flash Heal].#armor by {1}% for {2} sec" }, -- Inspiration (Rank 1)
...
-- Lesser Heal
[2050] = { "Мале зцілення", "Зцілює цілі від {1} до {2} здоров'я.#target for {1} to {2}" }, -- Lesser Heal (Rank 1)
...
-- Lightwell
[724] = { "Колодязь світла", "Створює священний колодязь світла біля жерця. Учасники вашої групи чи рейду можуть випити з нього для відновлення {1} здоров'я протягом {2} с. Будь-яка отримана шкода знімає цей ефект. Колодязь існує {3} хв або до {4} застосувань.#restore {1} health over {2} sec#lasts for {3} min or {4} charges" }, -- Lightwell (Rank 1)
...
-- Mana Burn
[8129] = { "Спалення мани", "Спалює цілі від {1} до {2} мани. Кожна одиниця спаленої таким чином мани завдає цілі {3} шкоди тінню.#{1} to {2} mana#takes {3}" }, -- Mana Burn (Rank 1)
...
-- Mental Agility
[14520] = { "Спритність розуму", "Зменшує витрати мани ваших миттєвих заклять на {1}%.#by {1}%" }, -- Mental Agility (Rank 1)
...
-- Mental Strength
[18551] = { "Ментальна сила", "Збільшує ваш максимальний запас мани на {1}%.#by {1}%" }, -- Mental Strength (Rank 1)
...
-- Mind Control
[605] = { "Контроль розуму", "Бере під контроль розум гуманоїда не вище {1} рівня, але збільшує інтервал між його атаками на {2}%. Триває до {3} хв.#up to level {1}#attacks by {2}%#Lasts up to {3} min", "Причаровано. Інтервал між атаками збільшено на {1}%.#by {1}" }, -- Mind Control (Rank 1)
[10911] = { ref=605 }, -- Mind Control (Rank 2)
[10912] = { ref=605 }, -- Mind Control (Rank 3)
-- Mind Flay
[15407] = { "Муки розуму", "Вражає розум цілі енергією тіні, завдаючи {1} шкоди від тіні протягом {2} с та сповільнюючи її рух на {3}%.#causing {1} Shadow#over {2} sec#speed by {3}%", "Швидкість руху зменшено на {1}%.#by {1}%" }, -- Mind Flay (Rank 1)
...
[16568] = { "Муки розуму", "Завдає ворогу шкоди від тіні та зменшує його швидкість руху на {1} с.#for {1} sec", "Завдає шкоди від тіні протягом {1} с.\nШвидкість руху зменшено.#over {1} sec" }, -- Mind Flay
...
[26044] = { nil, nil, "Від {1} до {2} шкоди від тіні щосекунди протягом {2} с.\nШвидкість руху зменшено.\nВтікає зі страху.#{1} to {2} Shadow#for {2} sec", ref=16568 }, -- Mind Flay
[28310] = { nil, nil, "Від {1} до {2} шкоди від тіні щосекунди протягом {2} с.\nШвидкість руху зменшено.#{1} to {2} Shadow#for {2} sec", ref=16568 }, -- Mind Flay
-- Mind Soothe
...
-- Power Infusion
[10060] = { "Приплив сил", "Наповнює ціль силою, збільшуючи її шкоду та зцілення закляттями на {1}%. Триває {2} с.#by {1}#Lasts {2} sec", "Шкоду та зцілення заклять збільшено на {1}%.#by {1}" }, -- Power Infusion
...
[23947] = { nil, "Сила наповнює ціль, збільшуючи її витривалість на {1} протягом {2} год.#by {1} for {2} h", ref=1243 }, -- Power Word: Fortitude (Rank 5)
[23948] = { ref=23947 }, -- Power Word: Fortitude (Rank 6)
-- Power Word: Shield
[17] = { "Слово сили: Щит", "Створює з частинки душі учасника групи щит, що поглинає {1} шкоди. Триває {2} с. Поки щит тримається, отримана шкода не спричинить затримки вимови заклять. Повторно накласти щит можна тільки через {3} с.#absorbing {1}#Lasts {2} sec#again for {3} sec", "Поглинає шкоду." }, -- Power Word: Shield (Rank 1)
...
-- Prayer of Fortitude
[21562] = { "Молитва стійкості", "Сила наповнює учасників групи цілі, збільшуючи їхню витривалість на {1} протягом {2} год.#by {1} for {2} h", "Збільшує витривалість на {1}.#by {1}" }, -- Prayer of Fortitude (Rank 1)
...
[27683] = { "Молитва захисту від тіні", "Сила наповнює учасників групи цілі, збільшуючи їхній опір тіні на {1} протягом {2} хв.#by {1} for {2} min", "Збільшує опір тіні на {1}.#by {1}" }, -- Prayer of Shadow Protection (Rank 1)
-- Prayer of Spirit
[27681] = { "Молитва духу", "Сила наповнює учасників групи цілі, збільшуючи їхній дух на {1} протягом {2} год.#by {1} for {2} h", "Збільшує дух на {1}.#by {1}" }, -- Prayer of Spirit (Rank 1)
-- Psychic Scream
...
-- Renew
[139] = { "Оновлення", "Зцілює {1} здоров'я цілі протягом {2} с.#{1} damage over {2} sec", "Зцілення {1} здоров'я кожні {2} с.#{1} damage every {2} sec" }, -- Renew (Rank 1)
...
-- Resurrection
[2006] = { "Воскресіння", "Повертає мертвого гравця до життя з {1} здоров'я та {2} мани. Не можна використовувати в бою.#{1} health and {2} mana" }, -- Resurrection (Rank 1)
...
-- Searing Light
[14909] = { "Обпалююче світло", "Збільшує шкоду заклять \"Кара\" та \"Священний вогонь\" на {1}%.#by {1}%" }, -- Searing Light (Rank 1)
...
-- Shadow Focus
[15260] = { "Тіньова зосередженість", "Зменшує ймовірність вашої цілі протистояти вашим закляттям тіні на {1}%.#by {1}%" }, -- Shadow Focus (Rank 1)
...
-- Shadow Protection
[976] = { "Захист від тіні", "Збільшує опір цілі до тіні на {1} протягом {2} хв.#by {1} for {2} min", "Опір тіні збільшено на {1}.#by {1}" }, -- Shadow Protection (Rank 1)
...
-- Shadow Weaving
[15257] = { "Сплітання тіні", "Ваші бойові закляття тіні з ймовірністю {1}% зроблять вашу ціль вразливою до тіні. Ця вразливість збільшує отриману ціллю шкоду від тіні на {2}% та триває {3} с. Ефект накопичується до {4} разів.#{1}% chance#by {2}% and lasts {3} sec#up to {4} times" }, -- Shadow Weaving (Rank 1)
...
-- Shadowform
[15473] = { "Тінеобраз", "Прийняти тінеобраз, що збільшує вашу шкоду від тіні на {1}%[, зменшує витрати мани на закляття тіні на {1}%#reducing the mana cost of all Shadow spells by {1}%] та зменшує отриману фізичну шкоду на {2}%. Однак, у цьому образі ви не можете вимовляти закляття святості.#Shadow damage by {1}%#done to you by {2}%", "Ваша шкода від тіні збільшена на {1}%.[ Витрати мани на закляття тіні зменшено на {1}%.#cost of all Shadow spells reduced by {1}%] Отриману фізичну шкоду зменшено на {2}%. Ви не можете вимовляти закляття святості.#increased by {1}%#take reduced by {2}%" }, -- Shadowform
-- Shadowguard
...
-- Silent Resolve
[14523] = { "Мовчазна рішучість", "Зменшує рівень загрози від ваших заклять на {1}%.#by {1}%" }, -- Silent Resolve (Rank 1)
...
-- Smite
[585] = { "Кара", "Карає ворога, завдаючи від {1} до {2} шкоди святістю.#for {1} to {2}" }, -- Smite (Rank 1)
...
-- Spirit Tap
[15270] = { "Витік душі", "Ваш дух з ймовірністю {1}% збільшиться на {2}% після вбивства цілі, що приносить досвід. Під час дї ефекту ваша мана відновлюватиметься під час вимови заклять зі швидкістю {3}% від звичайної. Триває {4} с.#a {1}% chance#a {2}% bonus#at a {3}% rate#Lasts {4} sec" }, -- Spirit Tap (Rank 1)
[15271] = { "Витік душі", nil, "Дух збільшено на {1}%, а мана відновлюється під час вимови заклять зі швидкістю {2}% від звичайної.#{1}% and allows {2}%" }, -- Spirit Tap (Rank 1)
...
[20711] = { "Дух спокути", "Після смерті жрець перетворюється на духа спокути на {1} с. Дух не може рухатися, атакувати та бути ціллю будь-яких атак, заклять чи ефектів. Перебуваючи в такому стані, жрець може вимовляти будь-які цілющі закляття без витрат мани. Після закінчення дії ефекту жрець остаточно вмирає.#for {1} sec" }, -- Spirit of Redemption
[27827] = { "Дух спокути", nil, "Ваша могутність незбагеннна." }, -- Spirit of Redemption
-- Spiritual Guidance
[14901] = { "Духовне покровительство", "Збільшує шкоду та зцілення заклять на {1}% від вашого духу.#by up to {1}% of" }, -- Spiritual Guidance (Rank 1)
...
-- Touch of Weakness
[2652] = { "Дотик слабкості", "Наступна атака ближнього бою проти заклинача завдасть {1} шкоди тінню та зменшить шкоду нападника на {2} протягом {3} хв.#cause {1}#by {2} for {3} min", "Наступна ворожа атака ближнього бою завдасть шкоди нападнику та послабить його." }, -- Touch of Weakness (Rank 1)
...
-- Unbreakable Will
[14522] = { "Незламна воля", "Збільшує ваш шанс протистояти приголомшенню, страху та знемовленню на {1}%.#additional {1}%" }, -- Unbreakable Will (Rank 1)
...
-- Vampiric Embrace
[15286] = { "Вампірські обійми", "Вражає вашу ціль енергією тіні, яка зцілює усіх учасників групи на {1}% від заподіяної шкоди вашими закляттями тіні протягом {2} хв.#healed for {1}%#deal for {2} min", "Зцілює групу жерця на {1}% від його шкоди закляттями тіні.#{1}% of Shadow" }, -- Vampiric Embrace
-- Wand Specialization
...
-- Weakened Soul
[6788] = { "Знесилена душа", nil, "Не можна захистити \"Словом сили: Щит\" повторно." }, -- Weakened Soul

-- Item effects
[23780] = { "Егіда збереження", "Збільшує броню на {1} та зцілює {2} здоров'я щоразу, коли ви отримуєте шкоду в ближньому чи дальньому бою протягом {3} с.#armor by {1}#and heals {2} damage#for {3} sec", "Броню збільшено на {1}.\nЗцілює {2} здоров'я при отриманні шкоди в ближньому чи дальньому бою.#by {1}#Heals {2} damage" }, -- Aegis of Preservation
[23043] = { "Зменшення затримки вимови вибуху розуму", "З ймовірністю {1}% ви уникнете затримки вимови закляття \"Вибух розуму\" при отриманні шкоди.#a {1}% chance to avoid" }, -- Mind Blast Cast Pushback Reduction
