...
-- Devouring Plague
[2944] = { "Ненажерна чума", "Вражає ціль хворобою, що завдає {1} шкоди тінню протягом {2} с. Шкода від \"Ненажерної чуми\" зцілює заклинача.#causes {1}#over {2} sec", "Завдає {1} пошкодження кожні {2} с та лікує заклинача.#{1} damage every {2} sec" }, -- Devouring Plague (Rank 1)
...
-- Renew
[139] = { "Оновлення", "Лікує {1} пошкодження цілі протягом {2} с.#{1} damage over {2} sec", "Лікує {1} пошкодження кожні {2} с.#{1} damage every {2} sec" }, -- Renew (Rank 1)
